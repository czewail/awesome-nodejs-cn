**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2020-03-26 12:04:27）**
...
- [Micro](https://github.com/zeit/micro) - **star:9163**带有异步方法的最小化微服务框架
...
- Query builder
- [Knex](https://github.com/tgriesser/knex) - **star:11729**用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣
- Other
...
- [awesome-cross-platform-nodejs](https://github.com/bcoe/awesome-cross-platform-nodejs) - **star:834**用于编写和测试跨平台代码的资源
