...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2024-06-20 08:30:37）**
...
- [PDFKit](https://github.com/foliojs/pdfkit) - **star:9610** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:8946** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [xlsx](https://github.com/SheetJS/sheetjs) - **star:34680** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
...
- [ESLint](https://github.com/eslint/eslint) - **star:24515** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
...
- [jscpd](https://github.com/kucherenko/jscpd) - **star:4594** 源代码的复制/粘贴检测器 ![star > 2000][Awesome] 
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:18438** 向外界公开本地主机 ![star > 2000][Awesome] 
...
- [themer](https://github.com/themerdev/themer) - **star:5423** 为编辑器、终端、墙纸、Slack等生成主题 ![star > 2000][Awesome] 
...
- [lodash](https://github.com/lodash/lodash) - **star:59149** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/immutable-js/immutable-js) - **star:32891** 不可变数据集合 ![star > 2000][Awesome] 
...
- [RxJS](https://github.com/reactivex/rxjs) - **star:30371** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1868** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:14028** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [undici](https://github.com/nodejs/undici) - **star:5888** 从头编写的高性能HTTP客户端，没有依赖关系。 ![star > 2000][Awesome] 
- [ky-universal](https://github.com/sindresorhus/ky-universal) - **star:669** 基于Fetch的通用HTTP客户端。
- [node-fetch](https://github.com/node-fetch/node-fetch) - **star:8692** node.js 版的 `window.fetch` ![star > 2000][Awesome] 
- [axios](https://github.com/axios/axios) - **star:104462** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
- [superagent](https://github.com/visionmedia/superagent) - **star:16555** HTTP请求库 ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:13515** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:22258** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [consola](https://github.com/unjs/consola) - **star:5767** 控制台记录器。 ![star > 2000][Awesome] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:21568** 终端字符串样式设置 ![star > 2000][Awesome] 
- [meow](https://github.com/sindresorhus/meow) - **star:3516** CLI应用助手 ![star > 2000][Awesome] 
- [yargs](https://github.com/yargs/yargs) - **star:10981** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome] 
- [ora](https://github.com/sindresorhus/ora) - **star:8963** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:26095** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
...
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:19558** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [Bit](https://github.com/teambit/bit) - **star:17675** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
- [gradient-string](https://github.com/bokub/gradient-string) - **star:1016** 终端输出中漂亮的颜色渐变
- [oclif](https://github.com/oclif/oclif) - **star:8897** 包含解析器、自动文档、测试和插件的CLI框架 ![star > 2000][Awesome] 
...
- [zx](https://github.com/google/zx) - **star:42184** 编写shell脚本JavaScript。 ![star > 2000][Awesome] 
...
- [webpack](https://github.com/webpack/webpack) - **star:64304** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:24961** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
...
- [Vite](https://github.com/vitejs/vite) - **star:65677** 前端构建工具，具有热模块替换和静态资产捆绑。 ![star > 2000][Awesome] 
...
- [serialport](https://github.com/serialport/node-serialport) - **star:5737** 访问串行端口进行读写 ![star > 2000][Awesome] 
...
- [marko](https://github.com/marko-js/marko) - **star:13227** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome] 
- [nunjucks](https://github.com/mozilla/nunjucks) - **star:8475** 带有继承、异步控制等功能的模板引擎(受jinja2的启发) ![star > 2000][Awesome] 
- [handlebars.js](https://github.com/handlebars-lang/handlebars.js) - **star:17798** Superset of Mustache 模板的超集，添加了强大的功能，如帮助程序和更高级的块 ![star > 2000][Awesome] 
- [EJS](https://github.com/mde/ejs) - **star:7629** 简单的未绑定模板语言 ![star > 2000][Awesome] 
- [Pug](https://github.com/pugjs/pug) - **star:21565** 高性能模板引擎深受Haml的影响 ![star > 2000][Awesome] 

### Web 框架
*翻译出错了? 试试 [英文版](readme_en.md#Web%20frameworks) 吧~*

- [Fastify](https://github.com/fastify/fastify) - **star:31112** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Next.js](https://github.com/vercel/next.js) - **star:122337** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:52846** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
...
- [Express](https://github.com/expressjs/express) - **star:64188** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
...
- [Meteor](https://github.com/meteor/meteor) - **star:44112** 一个超简单的、无处不在的数据库、在线数据、纯javascript web框架*(你可能会喜欢[awesome-meteor](https://github.com/Urigo/awesome-meteor))* ![star > 2000][Awesome] 
...
- [AdonisJs](https://github.com/adonisjs/core) - **star:16107** 一个真正的Node.js MVC框架，建立在依赖注入和IoC容器的坚实基础上 ![star > 2000][Awesome] 
- [Moleculer](https://github.com/moleculerjs/moleculer) - **star:6063** 快速强大的微服务框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:65290** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
...
- [Ts.ED](https://github.com/tsedio/tsed) - **star:2772** 直观的TypeScript框架，用于在Express.js或Koa.js之上构建服务器端应用。 ![star > 2000][Awesome] 
- [Hono](https://github.com/honojs/hono) - **star:16571** 小而快速的web框架。 ![star > 2000][Awesome] 
...
- [Docusaurus](https://github.com/facebook/docusaurus) - **star:53826** 文档网站生成器，利用React和Markdown，并附带翻译和版本控制功能。 ![star > 2000][Awesome] 
...
- [chokidar](https://github.com/paulmillr/chokidar) - **star:10665** 文件系统监视程序，它稳定来自' fs的事件看”和“fs以及在macOS上使用本地的“fsevents” ![star > 2000][Awesome] 
...
- [fs-extra](https://github.com/jprichardson/node-fs-extra) - **star:9375** ' fs '模块的额外方法 ![star > 2000][Awesome] 
...
- Observables
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:30371** 反应性编程 ![star > 2000][Awesome] 
...
- [Socket.io](https://github.com/socketio/socket.io) - **star:60450** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
- [Faye](https://github.com/faye/faye) - **star:4385** 实时客户端-服务器消息总线，基于Bayeux协议 ![star > 2000][Awesome] 
- [SocketCluster](https://github.com/SocketCluster/socketcluster) - **star:6126** 可伸缩的HTTP + WebSocket引擎，可以运行在多个CPU核心 ![star > 2000][Awesome] 
...
- [MQTT.js](https://github.com/mqttjs/MQTT.js) - **star:8400** 基于MQTT的消息传递协议的客户机，用于TCP/IP之上 ![star > 2000][Awesome] 
...
- [sharp](https://github.com/lovell/sharp) - **star:28284** 用于调整JPEG、PNG、WebP和TIFF图像大小的最快模块 ![star > 2000][Awesome] 
...
- [pica](https://github.com/nodeca/pica) - **star:3679** 高品质和快速调整大小(lanczos3)在纯JS替代画布drawImage()，当不允许像素化时 ![star > 2000][Awesome] 
- [jimp](https://github.com/oliver-moran/jimp) - **star:13579** 图像处理在纯JavaScript ![star > 2000][Awesome] 
- [qrcode](https://github.com/soldair/node-qrcode) - **star:7247** 二维码和条形码发生器 ![star > 2000][Awesome] 
- [ImageScript](https://github.com/matmen/ImageScript) - **star:603** 图像处理的JavaScript，利用WebAssembly的性能。
...
- [i18next](https://github.com/i18next/i18next) - **star:7510** 国际化框架 ![star > 2000][Awesome] 
- [nanoid](https://github.com/ai/nanoid) - **star:23775** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome] 
...
- [Luxon](https://github.com/moment/luxon) - **star:15006** 用于处理日期和时间的库 ![star > 2000][Awesome] 
- [date-fns](https://github.com/date-fns/date-fns) - **star:33981** 现代实用程序 ![star > 2000][Awesome] 
- [Day.js](https://github.com/iamkun/dayjs) - **star:46127** 不可变日期库替代Moment.js ![star > 2000][Awesome] 
...
- [joi](https://github.com/sideway/joi) - **star:20703** 对象模式描述语言和JavaScript对象的验证器 ![star > 2000][Awesome] 
...
- [ajv](https://github.com/ajv-validator/ajv) - **star:13506** 最快的JSON模式验证器支持v5、v6和v7提案 ![star > 2000][Awesome] 
...
- [yup](https://github.com/jquense/yup) - **star:22428** 对象模式验证。 ![star > 2000][Awesome] 
- [zod](https://github.com/colinhacks/zod) - **star:31394** 带静态类型推断的typescript优先模式验证。 ![star > 2000][Awesome] 

### 解析
*翻译出错了? 试试 [英文版](readme_en.md#Parsing) 吧~*

- [remark](https://github.com/remarkjs/remark) - **star:7339** 插件驱动的降价处理器 ![star > 2000][Awesome] 
- [markdown-it](https://github.com/markdown-it/markdown-it) - **star:17477** Markdown解析器具有100%的公共标记支持、扩展和语法插件 ![star > 2000][Awesome] 
- [parse5](https://github.com/inikulin/parse5) - **star:3584** 快速功能齐全的符合规范的HTML解析器 ![star > 2000][Awesome] 
- [@parcel/css](https://github.com/parcel-bundler/parcel-css) - **star:6064** 一个用Rust编写的CSS解析器、转换器和迷你器。 ![star > 2000][Awesome] 
...
- [js-yaml](https://github.com/nodeca/js-yaml) - **star:6210** 非常快的YAML解析器 ![star > 2000][Awesome] 
...
- Drivers
- [PostgreSQL](https://github.com/brianc/node-postgres) - **star:12012** PostgreSQL客户机纯JavaScript和本地libpq绑定 ![star > 2000][Awesome] 
- [Redis](https://github.com/luin/ioredis) - **star:14024** 复述,客户机 ![star > 2000][Awesome] 
- [LevelUP](https://github.com/Level/levelup) - **star:4075** LevelDB ![star > 2000][Awesome] 
- [MySQL](https://github.com/mysqljs/mysql) - **star:18206** MySQL客户端 ![star > 2000][Awesome] 
...
- [MongoDB](https://github.com/mongodb/node-mongodb-native) - **star:9980** MongoDB的司机 ![star > 2000][Awesome] 
- ODM / ORM
- [Sequelize](https://github.com/sequelize/sequelize) - **star:29204** Multi-dialect ORM。支持PostgreSQL, SQLite, MySQL等。 ![star > 2000][Awesome] 
...
- [TypeORM](https://github.com/typeorm/typeorm) - **star:33618** ORM用于PostgreSQL、MariaDB、MySQL、SQLite等 ![star > 2000][Awesome] 
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:7317** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Prisma](https://github.com/prisma/prisma) - **star:37885** 现代数据库访问(ORM替代)。在TypeScript中自动生成和类型安全的查询生成器。支持PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- Query builder
- [Knex](https://github.com/knex/knex) - **star:18924** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:13453** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:21089** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
...
- [nyc](https://github.com/istanbuljs/nyc) - **star:5543** 代码覆盖工具建立在伊斯坦布尔，与子进程一起工作 ![star > 2000][Awesome] 
...
- [Jest](https://github.com/facebook/jest) - **star:43779** 无痛的JavaScript测试 ![star > 2000][Awesome] 
...
- [Puppeteer](https://github.com/puppeteer/puppeteer) - **star:87472** Headless Chrome ![star > 2000][Awesome] 
- [Playwright](https://github.com/microsoft/playwright) - **star:63365** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome] 
- [nve](https://github.com/ehmicky/nve) - **star:694** 在Node.js的多个版本上本地运行任何命令。
- [axe-core](https://github.com/dequelabs/axe-core) - **star:5731** 用于自动化Web UI测试的可访问性引擎。 ![star > 2000][Awesome] 
...
- [rate-limiter-flexible](https://github.com/animir/node-rate-limiter-flexible) - **star:2938** 暴力和DDoS攻击保护 ![star > 2000][Awesome] 
...
- [babel-minify](https://github.com/babel/minify) - **star:4387** 基于Babel工具链的ES2015+感知缩小器 ![star > 2000][Awesome] 
- [UglifyJS2](https://github.com/mishoo/UglifyJS) - **star:12986** JavaScript缩小镜 ![star > 2000][Awesome] 
...
- [Passport](https://github.com/jaredhanson/passport) - **star:22595** 简单、低调的身份验证 ![star > 2000][Awesome] 
...
- [CASL](https://github.com/stalniy/casl) - **star:5710** UI和API的同构授权 ![star > 2000][Awesome] 
- [node-casbin](https://github.com/casbin/node-casbin) - **star:2515** 支持ACL、RBAC和ABAC等访问控制模型的授权库 ![star > 2000][Awesome] 

### 邮件
*翻译出错了? 试试 [英文版](readme_en.md#Email) 吧~*

- [Nodemailer](https://github.com/nodemailer/nodemailer) - **star:16446** 处理电子邮件的最快方式 ![star > 2000][Awesome] 
...
- [MJML](https://github.com/mjmlio/mjml) - **star:16624** 标记语言，旨在减少创建响应电子邮件的痛苦 ![star > 2000][Awesome] 

### 工作队列
*翻译出错了? 试试 [英文版](readme_en.md#Job%20queues) 吧~*

- [bull](https://github.com/OptimalBits/bull) - **star:15212** 持久作业和消息队列 ![star > 2000][Awesome] 
- [agenda](https://github.com/agenda/agenda) - **star:9298** MongoDB-backed工作调度 ![star > 2000][Awesome] 
...
- [bullmq](https://github.com/taskforcesh/bullmq) - **star:5545** 持久作业和消息队列 ![star > 2000][Awesome] 

### Node.js 管理
*翻译出错了? 试试 [英文版](readme_en.md#Node.js%20management) 吧~*

- [n](https://github.com/tj/n) - **star:18621** Node.js 版本管理 ![star > 2000][Awesome] 
...
- [nvm for Windows](https://github.com/coreybutler/nvm-windows) - **star:35609** Windows 版本管理 ![star > 2000][Awesome] 
- [nodenv](https://github.com/nodenv/nodenv) - **star:2188** 类似于Ruby的rbenv的版本管理器它支持自动版本切换 ![star > 2000][Awesome] 
- [fnm](https://github.com/Schniz/fnm) - **star:16205** 跨平台的Node.js版本管理器内置在Rust中。 ![star > 2000][Awesome] 

### 跨平台的集成
*翻译出错了? 试试 [英文版](readme_en.md#Cross-platform%20integration) 吧~*

- [napi-rs](https://github.com/napi-rs/napi-rs) - **star:5629** 通过Node-API在Rust中构建编译后的Node.js插件的框架。 ![star > 2000][Awesome] 
...
- [PM2](https://github.com/Unitech/pm2) - **star:40950** 先进的流程管理 ![star > 2000][Awesome] 
- [nodemon](https://github.com/remy/nodemon) - **star:26087** 监视应用程序中的更改并自动重启服务器 ![star > 2000][Awesome] 
...
- [nut.js](https://github.com/nut-tree/nut.js) - **star:2121** 跨平台的本地GUI自动化/测试框架，具有与Jest集成的图像匹配功能。 ![star > 2000][Awesome] 

### AST
*翻译出错了? 试试 [英文版](readme_en.md#AST) 吧~*

- [Acorn](https://github.com/acornjs/acorn) - **star:10311** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome] 
...
- [docsify](https://github.com/docsifyjs/docsify) - **star:26956** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome] 
...
- [Strapi](https://github.com/strapi/strapi) - **star:61351** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome] 
- [Factor](https://github.com/FactorJS/factor) - **star:1385** Vue.js仪表板框架和无头CMS。
- [AdminBro](https://github.com/SoftwareBrothers/adminjs) - **star:8026** 所有资源的CRUD自动生成管理面板。 ![star > 2000][Awesome] 
...
- [Hexo](https://github.com/hexojs/hexo) - **star:38765** 快速，简单和强大的博客框架 ![star > 2000][Awesome] 
...
- [execa](https://github.com/sindresorhus/execa) - **star:6592** 更好的“child_process” ![star > 2000][Awesome] 
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:27986** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome] 
- [open](https://github.com/sindresorhus/open) - **star:3133** 打开网站、文件、可执行文件等 ![star > 2000][Awesome] 
- [hasha](https://github.com/sindresorhus/hasha) - **star:948** 散列法简单获取缓冲区/字符串/流/文件的散列
- [dot-prop](https://github.com/sindresorhus/dot-prop) - **star:804** 使用点路径从嵌套对象中获取属性
...
- [dotenv](https://github.com/motdotla/dotenv) - **star:18663** 从.env文件中加载环境变量 ![star > 2000][Awesome] 
...
- [husky](https://github.com/typicode/husky) - **star:31861** 创建Git钩子脚本。 ![star > 2000][Awesome] 
- [patch-package](https://github.com/ds300/patch-package) - **star:10101** 修复并保留npm依赖。 ![star > 2000][Awesome] 
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - **star:97045** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome] 
...
- [Amplication](https://github.com/amplication/amplication) - **star:14060** 自动生成功能齐全的应用程序。 ![star > 2000][Awesome] 
