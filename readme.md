...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2020-04-23 07:04:40）**
...
- [webtorrent](https://github.com/feross/webtorrent) - **star:21714** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
...
- [ipfs](https://github.com/ipfs/js-ipfs) - **star:4348** 分布式文件系统，用于将所有计算设备与同一文件系统连接起来 ![star > 2000][Awesome] 
...
- [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) - **star:3828** 干净、可读比特币库 ![star > 2000][Awesome] 
- [Bitcore](https://github.com/bitpay/bitcore) - **star:3597** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/devongovett/pdfkit) - **star:6084** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:5172** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
- [webcat](https://github.com/mafintosh/webcat) - **star:405** 使用 WebRTC 跨 web 的 p2p 管道，它使用 GitHub 私有/公共密钥进行身份验证
- [NodeOS](https://github.com/NodeOS/NodeOS) - **star:6191** 第一个由 npm 驱动的操作系统 ![star > 2000][Awesome] 
- [YodaOS](https://github.com/yodaos-project/yodaos) - **star:1011** 人工智能操作系统
- [Brain.js](https://github.com/BrainJS/brain.js) - **star:10918** 机器学习框架 ![star > 2000][Awesome] 
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:6571** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
...
- [xlsx](https://github.com/sheetjs/js-xlsx) - **star:20687** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
...
- [np](https://github.com/sindresorhus/np) - **star:5142** 更好的 'npm publish' ![star > 2000][Awesome] 
...
- [trash](https://github.com/sindresorhus/trash) - **star:1974** 更安全的 rm 命令替代品
...
- [XO](https://github.com/xojs/xo) - **star:5039** 使用 Javascript happiness style 进行严格编码 ![star > 2000][Awesome] 
- [Standard](https://github.com/feross/standard) - **star:23583** Javascript 标准风格 - 一种风格规范 ![star > 2000][Awesome] 
- [ESLint](https://github.com/eslint/eslint) - **star:16210** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
...
- [http-server](https://github.com/indexzero/http-server) - **star:9366** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome] 
...
- [fkill](https://github.com/sindresorhus/fkill-cli) - **star:6072** 跨平台的进程杀死工具 ![star > 2000][Awesome] 
...
- [jscpd](https://github.com/kucherenko/jscpd) - **star:1624** 源代码的复制/粘贴检测器
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:9780** 向外界公开本地主机 ![star > 2000][Awesome] 
- [svg-term-cli](https://github.com/marionebl/svg-term-cli) - **star:1833** 通过 SVG 共享终端会话
- [gtop](https://github.com/aksakalli/gtop) - **star:8105** 终端系统监控仪表板 ![star > 2000][Awesome] 
- [themer](https://github.com/mjswensen/themer) - **star:3242** 为编辑器、终端、墙纸、Slack等生成主题 ![star > 2000][Awesome] 
- [carbon-now-cli](https://github.com/mixn/carbon-now-cli) - **star:4528** 一款生成代码展示图片的终端工具 ![star > 2000][Awesome] 
- [cash-cli](https://github.com/xxczaki/cash-cli) - **star:140** 转换170种货币
- [taskbook](https://github.com/klauscfhq/taskbook) - **star:7540** 命令行栖息地的任务、板子和注释 ![star > 2000][Awesome] 
- [discharge](https://github.com/brandonweiss/discharge) - **star:437** 轻松地将静态站点部署到Amazon S3
- [npkill](https://github.com/voidcosmos/npkill) - **star:3046** 轻松找到并删除旧的和沉重的node_modules文件夹 ![star > 2000][Awesome] 

### 函数式编程
*翻译出错了? 试试 [英文版](readme_en.md#Functional%20programming) 吧~*

- [lodash](https://github.com/lodash/lodash) - **star:44414** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/facebook/immutable-js) - **star:29543** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:18663** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome] 
- [Folktale](https://github.com/origamitower/folktale) - **star:1775** 用JavaScript编写通用函数式编程的库套件，允许编写优雅的模块化应用程序，减少bug，提高重用性
...
- [RxJS](https://github.com/reactivex/rxjs) - **star:21683** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Lazy.js](https://github.com/dtao/lazy.js) - **star:5891** 类似于 lodash/Underscore 的工具库，但具有延迟计算，这在许多情况下可以转化为优越的性能 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1664** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:7303** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [gh-got](https://github.com/sindresorhus/gh-got) - **star:150** “got”与github api交互的简单封装
- [axios](https://github.com/mzabriskie/axios) - **star:72275** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
- [wreck](https://github.com/hapijs/wreck) - **star:373** HTTP客户端工具
- [download](https://github.com/kevva/download) - **star:958** 轻松下载和解压文件
- [http-proxy](https://github.com/nodejitsu/node-http-proxy) - **star:11082** HTTP代理 ![star > 2000][Awesome] 
- [superagent](https://github.com/visionmedia/superagent) - **star:15028** HTTP请求库 ![star > 2000][Awesome] 
- [node-fetch](https://github.com/bitinn/node-fetch) - **star:4919** node.js 版的 `window.fetch` ![star > 2000][Awesome] 
...
- [ndb](https://github.com/GoogleChromeLabs/ndb) - **star:9960** 通过chrome devtools改进了调试体验 ![star > 2000][Awesome] 
...
- [debug](https://github.com/visionmedia/debug) - **star:8665** 微小的调试工具 ![star > 2000][Awesome] 
...
- [0x](https://github.com/davidmarkclements/0x) - **star:1800** 火焰图分析
...
- [swagger-stats](https://github.com/slanatech/swagger-stats) - **star:423** 跟踪API调用并监视API性能、健康状况和使用指标
- [NiM](https://github.com/june07/nim) - **star:154** 管理DevTools调试工作流程。

### 日志
*翻译出错了? 试试 [英文版](readme_en.md#Logging) 吧~*

- [pino](https://github.com/pinojs/pino) - **star:5340** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:15224** 多通道异步日志库 ![star > 2000][Awesome] 
- [console-log-level](https://github.com/watson/console-log-level) - **star:59** 最简单的日志程序，支持日志级别和自定义前缀
- [storyboard](https://github.com/guigrpa/storyboard) - **star:612** 端到端的、分层的、实时的、丰富多彩的日志和故事
- [signale](https://github.com/klauscfhq/signale) - **star:8076** 控制台记录器。 ![star > 2000][Awesome] 
- [consola](https://github.com/nuxt/consola) - **star:2779** 控制台记录器。 ![star > 2000][Awesome] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:14319** 终端字符串样式设置 ![star > 2000][Awesome] 
- [meow](https://github.com/sindresorhus/meow) - **star:2146** CLI应用助手 ![star > 2000][Awesome] 
- [yargs](https://github.com/yargs/yargs) - **star:7567** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome] 
- [ora](https://github.com/sindresorhus/ora) - **star:5900** 优雅的终端 spinner ![star > 2000][Awesome] 
- [get-stdin](https://github.com/sindresorhus/get-stdin) - **star:249** 简单的 stdin
- [log-update](https://github.com/sindresorhus/log-update) - **star:776** 通过覆盖终端中的前一个输出来记录日志用于绘制进度条、动画等
- [Ink](https://github.com/vadimdemedes/ink) - **star:13090** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
- [listr](https://github.com/samverschueren/listr) - **star:2471** 终端任务列表 ![star > 2000][Awesome] 
...
- [blessed](https://github.com/chjj/blessed) - **star:9143** Curses-like 库 ![star > 2000][Awesome] 
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:12337** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [shelljs](https://github.com/shelljs/shelljs) - **star:10932** 可移植的Unix shell命令 ![star > 2000][Awesome] 
...
- [Bit](https://github.com/teambit/bit) - **star:10749** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
- [gradient-string](https://github.com/bokub/gradient-string) - **star:411** 终端输出中漂亮的颜色渐变
- [oclif](https://github.com/oclif/oclif) - **star:4792** 包含解析器、自动文档、测试和插件的CLI框架 ![star > 2000][Awesome] 
...
- [parcel](https://github.com/parcel-bundler/parcel) - **star:35444** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome] 
- [webpack](https://github.com/webpack/webpack) - **star:53851** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:18003** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
...
- [pkg](https://github.com/zeit/pkg) - **star:15679** 将Node.js项目打包成可执行文件 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:11425** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
- [serialport](https://github.com/voodootikigod/node-serialport) - **star:4366** 访问串行端口进行读写 ![star > 2000][Awesome] 
- [usb](https://github.com/nonolith/node-usb) - **star:923** USB接口库
...
- [marko](https://github.com/marko-js/marko) - **star:9479** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome] 
- [nunjucks](https://github.com/mozilla/nunjucks) - **star:6654** 带有继承、异步控制等功能的模板引擎(受jinja2的启发) ![star > 2000][Awesome] 
- [handlebars.js](https://github.com/wycats/handlebars.js) - **star:15275** Superset of Mustache 模板的超集，添加了强大的功能，如帮助程序和更高级的块 ![star > 2000][Awesome] 
- [EJS](https://github.com/mde/ejs) - **star:4367** 简单的未绑定模板语言 ![star > 2000][Awesome] 
- [Pug](https://github.com/pugjs/pug) - **star:19148** 高性能模板引擎深受Haml的影响 ![star > 2000][Awesome] 

### Web 框架
*翻译出错了? 试试 [英文版](readme_en.md#Web%20frameworks) 吧~*

- [Hapi](https://github.com/hapijs/hapi) - **star:12299** 用于构建应用程序和服务的框架 ![star > 2000][Awesome] 
- [Koa](https://github.com/koajs/koa) - **star:28960** Express背后的团队设计的框架，其目标是为web应用程序和api提供一个更小、更富表现力和更健壮的基础 ![star > 2000][Awesome] 
- [Express](https://github.com/expressjs/express) - **star:48244** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
- [Feathers](https://github.com/feathersjs/feathers) - **star:12363** 基于Express精神构建的微服务框架 ![star > 2000][Awesome] 
- [LoopBack](https://github.com/strongloop/loopback) - **star:13105** 用于创建REST api和轻松连接到后端数据源的强大框架 ![star > 2000][Awesome] 
- [Meteor](https://github.com/meteor/meteor) - **star:41733** 一个超简单的、无处不在的数据库、在线数据、纯javascript web框架*(你可能会喜欢[awesome-meteor](https://github.com/Urigo/awesome-meteor))* ![star > 2000][Awesome] 
...
- [Next.js](https://github.com/zeit/next.js) - **star:47219** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:26629** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
...
- [Micro](https://github.com/zeit/micro) - **star:9236** 带有异步方法的最小化微服务框架 ![star > 2000][Awesome] 
- [Moleculer](https://moleculer.services) - 快速强大的微服务框架
- [Fastify](https://github.com/fastify/fastify) - **star:14172** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:26214** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
- [Zeronode](https://github.com/sfast/zeronode) - **star:106** 可靠和容错的微服务的最小构建块
- [TypeGraphQL](https://github.com/19majkel94/type-graphql) - **star:4217** 基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架 ![star > 2000][Awesome] 
...
- [JSDoc](https://github.com/jsdoc3/jsdoc) - **star:10553** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome] 
