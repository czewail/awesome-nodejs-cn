...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2024-11-15 08:40:10）**
...
- [webtorrent](https://github.com/webtorrent/webtorrent) - **star:29654** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
- [peerflix](https://github.com/mafintosh/peerflix) - **star:6190** 流式 Torrent 客户端 ![star > 2000][Awesome] 
- [ipfs](https://github.com/ipfs/helia) - **star:954** 分布式文件系统，用于将所有计算设备与同一文件系统连接起来
...
- [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) - **star:5700** 干净、可读比特币库 ![star > 2000][Awesome] 
- [Bitcore](https://github.com/bitpay/bitcore) - **star:4870** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/foliojs/pdfkit) - **star:9909** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:9359** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [Brain.js](https://github.com/BrainJS/brain.js) - **star:14400** 机器学习框架 ![star > 2000][Awesome] 
- [Pipcook](https://github.com/alibaba/pipcook) - **star:2543** 前端算法框架创建机器学习流水线。 ![star > 2000][Awesome] 
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:10118** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
- [js-git](https://github.com/creationix/js-git) - **star:3834** Git的 JavaScript 实现 ![star > 2000][Awesome] 
- [xlsx](https://github.com/SheetJS/sheetjs) - **star:35137** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
- [isomorphic-git](https://github.com/isomorphic-git/isomorphic-git) - **star:7502** 纯 JavaScript 实现的 Git ![star > 2000][Awesome] 
...
- [ESLint](https://github.com/eslint/eslint) - **star:25104** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
- [David](https://github.com/alanshaw/david) - **star:969** 告诉你包的 npm 依赖项何时过期
- [http-server](https://github.com/http-party/http-server) - **star:13658** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome] 
- [Live Server](https://github.com/tapio/live-server) - **star:4437** 具有热重载功能的 HTTP-server ![star > 2000][Awesome] 
...
- [fkill](https://github.com/sindresorhus/fkill-cli) - **star:6879** 跨平台的进程杀死工具 ![star > 2000][Awesome] 
...
- [jscpd](https://github.com/kucherenko/jscpd) - **star:4715** 源代码的复制/粘贴检测器 ![star > 2000][Awesome] 
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:19150** 向外界公开本地主机 ![star > 2000][Awesome] 
- [svg-term-cli](https://github.com/marionebl/svg-term-cli) - **star:3551** 通过 SVG 共享终端会话 ![star > 2000][Awesome] 
- [gtop](https://github.com/aksakalli/gtop) - **star:9723** 终端系统监控仪表板 ![star > 2000][Awesome] 
- [themer](https://github.com/themerdev/themer) - **star:5499** 为编辑器、终端、墙纸、Slack等生成主题 ![star > 2000][Awesome] 
...
- [npkill](https://github.com/voidcosmos/npkill) - **star:8309** 轻松找到并删除旧的和沉重的node_modules文件夹 ![star > 2000][Awesome] 

### 函数式编程
*翻译出错了? 试试 [英文版](readme_en.md#Functional%20programming) 吧~*

- [lodash](https://github.com/lodash/lodash) - **star:59872** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/immutable-js/immutable-js) - **star:32951** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:23820** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome] 
- [Mout](https://github.com/mout/mout) - **star:1292** 实用工具库与其他现有解决方案最大的区别在于，您可以选择只加载您需要的模块/函数，而不需要额外的开销
- [RxJS](https://github.com/reactivex/rxjs) - **star:30802** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1874** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:14300** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [undici](https://github.com/nodejs/undici) - **star:6238** 从头编写的高性能HTTP客户端，没有依赖关系。 ![star > 2000][Awesome] 
- [ky-universal](https://github.com/sindresorhus/ky-universal) - **star:671** 基于Fetch的通用HTTP客户端。
- [node-fetch](https://github.com/node-fetch/node-fetch) - **star:8780** node.js 版的 `window.fetch` ![star > 2000][Awesome] 
- [axios](https://github.com/axios/axios) - **star:105783** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
...
- [debug](https://github.com/debug-js/debug) - **star:11145** 微小的调试工具 ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:14316** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:22900** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [consola](https://github.com/unjs/consola) - **star:6116** 控制台记录器。 ![star > 2000][Awesome] 
...
- [ora](https://github.com/sindresorhus/ora) - **star:9158** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:27183** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
- [listr2](https://github.com/listr2/listr2) - **star:524** 终端任务列表
...
- [boxen](https://github.com/sindresorhus/boxen) - **star:1540** 在终端中创建框
...
- [blessed](https://github.com/chjj/blessed) - **star:11326** Curses-like 库 ![star > 2000][Awesome] 
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:20276** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [cfonts](https://github.com/dominikwilkowski/cfonts) - **star:1601** 性感的ASCII字体控制台
...
- [Bit](https://github.com/teambit/bit) - **star:17890** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
...
- [zx](https://github.com/google/zx) - **star:43118** 编写shell脚本JavaScript。 ![star > 2000][Awesome] 

### 构建工具
*翻译出错了? 试试 [英文版](readme_en.md#Build%20tools) 吧~*

- [parcel](https://github.com/parcel-bundler/parcel) - **star:43498** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome] 
- [webpack](https://github.com/webpack/webpack) - **star:64782** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:25372** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
...
- [Vite](https://github.com/vitejs/vite) - **star:68561** 前端构建工具，具有热模块替换和静态资产捆绑。 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:13300** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
...
- [marko](https://github.com/marko-js/marko) - **star:13406** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome] 
- [nunjucks](https://github.com/mozilla/nunjucks) - **star:8587** 带有继承、异步控制等功能的模板引擎(受jinja2的启发) ![star > 2000][Awesome] 
- [handlebars.js](https://github.com/handlebars-lang/handlebars.js) - **star:18018** Superset of Mustache 模板的超集，添加了强大的功能，如帮助程序和更高级的块 ![star > 2000][Awesome] 
- [EJS](https://github.com/mde/ejs) - **star:7773** 简单的未绑定模板语言 ![star > 2000][Awesome] 
- [Pug](https://github.com/pugjs/pug) - **star:21687** 高性能模板引擎深受Haml的影响 ![star > 2000][Awesome] 

### Web 框架
*翻译出错了? 试试 [英文版](readme_en.md#Web%20frameworks) 吧~*

- [Fastify](https://github.com/fastify/fastify) - **star:32401** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Next.js](https://github.com/vercel/next.js) - **star:126994** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:54934** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
...
- [Express](https://github.com/expressjs/express) - **star:65672** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
- [Feathers](https://github.com/feathersjs/feathers) - **star:15076** 基于Express精神构建的微服务框架 ![star > 2000][Awesome] 
- [LoopBack](https://github.com/loopbackio/loopback-next) - **star:4959** 用于创建REST api和轻松连接到后端数据源的强大框架 ![star > 2000][Awesome] 
- [Meteor](https://github.com/meteor/meteor) - **star:44420** 一个超简单的、无处不在的数据库、在线数据、纯javascript web框架*(你可能会喜欢[awesome-meteor](https://github.com/Urigo/awesome-meteor))* ![star > 2000][Awesome] 
...
- [seneca](https://github.com/senecajs/seneca) - **star:3959** 编写微服务的工具包 ![star > 2000][Awesome] 
- [AdonisJs](https://github.com/adonisjs/core) - **star:16961** 一个真正的Node.js MVC框架，建立在依赖注入和IoC容器的坚实基础上 ![star > 2000][Awesome] 
- [Moleculer](https://github.com/moleculerjs/moleculer) - **star:6163** 快速强大的微服务框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:67757** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
- [TypeGraphQL](https://github.com/MichalLytek/type-graphql) - **star:8039** 基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架 ![star > 2000][Awesome] 
- [Tinyhttp](https://github.com/tinyhttp/tinyhttp) - **star:2733** 现代和快速的类似express的web框架。 ![star > 2000][Awesome] 
...
- [Ts.ED](https://github.com/tsedio/tsed) - **star:2858** 直观的TypeScript框架，用于在Express.js或Koa.js之上构建服务器端应用。 ![star > 2000][Awesome] 
- [Hono](https://github.com/honojs/hono) - **star:20330** 小而快速的web框架。 ![star > 2000][Awesome] 
...
- [JSDoc](https://github.com/jsdoc/jsdoc) - **star:15051** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome] 
- [Docusaurus](https://github.com/facebook/docusaurus) - **star:56705** 文档网站生成器，利用React和Markdown，并附带翻译和版本控制功能。 ![star > 2000][Awesome] 
...
- [chokidar](https://github.com/paulmillr/chokidar) - **star:11021** 文件系统监视程序，它稳定来自' fs的事件看”和“fs以及在macOS上使用本地的“fsevents” ![star > 2000][Awesome] 
...
- Promises
- [pify](https://github.com/sindresorhus/pify) - **star:1507** 承诺一个回调样式的函数
...
- Observables
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:30802** 反应性编程 ![star > 2000][Awesome] 
...
- [µWebSockets](https://github.com/uNetworking/uWebSockets) - **star:17417** 高度可伸缩的WebSocket服务器和客户端库 ![star > 2000][Awesome] 
- [Socket.io](https://github.com/socketio/socket.io) - **star:61196** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
...
- [MQTT.js](https://github.com/mqttjs/MQTT.js) - **star:8602** 基于MQTT的消息传递协议的客户机，用于TCP/IP之上 ![star > 2000][Awesome] 
- [rpc-websockets](https://github.com/elpheria/rpc-websockets) - **star:592** 通过WebSockets实现JSON-RPC 2.0
- [Aedes](https://github.com/moscajs/aedes) - **star:1798** 可以在任何流服务器上运行的Barebone MQTT服务器

### 图像
*翻译出错了? 试试 [英文版](readme_en.md#Image) 吧~*

- [sharp](https://github.com/lovell/sharp) - **star:29260** 用于调整JPEG、PNG、WebP和TIFF图像大小的最快模块 ![star > 2000][Awesome] 
...
- [gm](https://github.com/aheckmann/gm) - **star:6956** GraphicsMagick和ImageMagick包装器 ![star > 2000][Awesome] 
- [lwip](https://github.com/EyalAr/lwip) - **star:2365** 轻量级图像处理器，不需要ImageMagick ![star > 2000][Awesome] 
- [pica](https://github.com/nodeca/pica) - **star:3783** 高品质和快速调整大小(lanczos3)在纯JS替代画布drawImage()，当不允许像素化时 ![star > 2000][Awesome] 
- [jimp](https://github.com/oliver-moran/jimp) - **star:14039** 图像处理在纯JavaScript ![star > 2000][Awesome] 
- [qrcode](https://github.com/soldair/node-qrcode) - **star:7531** 二维码和条形码发生器 ![star > 2000][Awesome] 
...
- [i18next](https://github.com/i18next/i18next) - **star:7769** 国际化框架 ![star > 2000][Awesome] 
- [nanoid](https://github.com/ai/nanoid) - **star:24652** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome] 
- [StegCloak](https://github.com/kurolabs/stegcloak) - **star:3313** 把秘密隐藏在琴弦中，在众目睽睽之下。 ![star > 2000][Awesome] 
...
- [mathjs](https://github.com/josdejong/mathjs) - **star:14410** 一个广泛的数学图书馆 ![star > 2000][Awesome] 
...
- [Luxon](https://github.com/moment/luxon) - **star:15420** 用于处理日期和时间的库 ![star > 2000][Awesome] 
- [date-fns](https://github.com/date-fns/date-fns) - **star:34863** 现代实用程序 ![star > 2000][Awesome] 
- [Day.js](https://github.com/iamkun/dayjs) - **star:46992** 不可变日期库替代Moment.js ![star > 2000][Awesome] 
...
- [joi](https://github.com/sideway/joi) - **star:20932** 对象模式描述语言和JavaScript对象的验证器 ![star > 2000][Awesome] 
...
- [ajv](https://github.com/ajv-validator/ajv) - **star:13847** 最快的JSON模式验证器支持v5、v6和v7提案 ![star > 2000][Awesome] 
- [Superstruct](https://github.com/ianstormtaylor/superstruct) - **star:7022** 在JavaScript(和TypeScript)中验证数据的简单而可组合的方法。 ![star > 2000][Awesome] 
- [yup](https://github.com/jquense/yup) - **star:22896** 对象模式验证。 ![star > 2000][Awesome] 
- [zod](https://github.com/colinhacks/zod) - **star:33990** 带静态类型推断的typescript优先模式验证。 ![star > 2000][Awesome] 

### 解析
*翻译出错了? 试试 [英文版](readme_en.md#Parsing) 吧~*

- [remark](https://github.com/remarkjs/remark) - **star:7692** 插件驱动的降价处理器 ![star > 2000][Awesome] 
- [markdown-it](https://github.com/markdown-it/markdown-it) - **star:18306** Markdown解析器具有100%的公共标记支持、扩展和语法插件 ![star > 2000][Awesome] 
- [parse5](https://github.com/inikulin/parse5) - **star:3676** 快速功能齐全的符合规范的HTML解析器 ![star > 2000][Awesome] 
- [@parcel/css](https://github.com/parcel-bundler/parcel-css) - **star:6484** 一个用Rust编写的CSS解析器、转换器和迷你器。 ![star > 2000][Awesome] 
...
- [PEG.js](https://github.com/pegjs/pegjs) - **star:4827** 简单的解析器生成器，生成具有出色错误报告的快速解析器 ![star > 2000][Awesome] 
- [x-ray](https://github.com/matthewmueller/x-ray) - **star:5878** 网页抓取工具 ![star > 2000][Awesome] 
- [nearley](https://github.com/kach/nearley) - **star:3606** 简单、快速、强大的JavaScript解析 ![star > 2000][Awesome] 
...
- [js-yaml](https://github.com/nodeca/js-yaml) - **star:6304** 非常快的YAML解析器 ![star > 2000][Awesome] 
...
- [google-libphonenumber](https://github.com/ruimarinho/google-libphonenumber) - **star:1405** 解析、格式化、存储和验证电话号码
...
- [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) - **star:2578** 验证和解析XML ![star > 2000][Awesome] 

### 人性化
*翻译出错了? 试试 [英文版](readme_en.md#Humanize) 吧~*

- [pretty-bytes](https://github.com/sindresorhus/pretty-bytes) - **star:1112** 将字节转换为人类可读的字符串:' 1337 '→' 1.34 kB '
- [pretty-ms](https://github.com/sindresorhus/pretty-ms) - **star:1076** 将毫秒转换为人类可读的字符串:“1337000000”→“15d 11h 23m 20s”
...
- [Archiver](https://github.com/archiverjs/node-archiver) - **star:2821** 流接口的存档生成，支持ZIP和TAR ![star > 2000][Awesome] 
- [pako](https://github.com/nodeca/pako) - **star:5589** 高速zlib端口到纯js(放气，充气，gzip) ![star > 2000][Awesome] 
...
- Drivers
- [PostgreSQL](https://github.com/brianc/node-postgres) - **star:12328** PostgreSQL客户机纯JavaScript和本地libpq绑定 ![star > 2000][Awesome] 
- [Redis](https://github.com/luin/ioredis) - **star:14397** 复述,客户机 ![star > 2000][Awesome] 
- [LevelUP](https://github.com/Level/levelup) - **star:4087** LevelDB ![star > 2000][Awesome] 
- [MySQL](https://github.com/mysqljs/mysql) - **star:18304** MySQL客户端 ![star > 2000][Awesome] 
...
- [MongoDB](https://github.com/mongodb/node-mongodb-native) - **star:10048** MongoDB的司机 ![star > 2000][Awesome] 
- ODM / ORM
- [Sequelize](https://github.com/sequelize/sequelize) - **star:29576** Multi-dialect ORM。支持PostgreSQL, SQLite, MySQL等。 ![star > 2000][Awesome] 
- [Bookshelf](https://github.com/bookshelf/bookshelf) - **star:6361** ORM用于PostgreSQL、MySQL和SQLite3，风格为Backbone.js ![star > 2000][Awesome] 
- [Mongoose](https://github.com/Automattic/mongoose) - **star:26963** 优雅的MongoDB对象建模 ![star > 2000][Awesome] 
...
- [slonik](https://github.com/gajus/slonik) - **star:4590** 具有严格类型、详细日志记录和断言的PostgreSQL客户机 ![star > 2000][Awesome] 
- [Objection.js](https://github.com/Vincit/objection.js) - **star:7264** 轻量级ORM构建于SQL查询生成器Knex之上 ![star > 2000][Awesome] 
- [TypeORM](https://github.com/typeorm/typeorm) - **star:34242** ORM用于PostgreSQL、MariaDB、MySQL、SQLite等 ![star > 2000][Awesome] 
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:7812** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Prisma](https://github.com/prisma/prisma) - **star:39709** 现代数据库访问(ORM替代)。在TypeScript中自动生成和类型安全的查询生成器。支持PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) - **star:24465** 支持各种数据库，如PostgreSQL的TypeScript ORM。 ![star > 2000][Awesome] 
- Query builder
- [Knex](https://github.com/knex/knex) - **star:19352** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:13501** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:21537** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
- [Keyv](https://github.com/jaredwray/keyv) - **star:2622** 简单的键值存储，支持多个后端 ![star > 2000][Awesome] 
...
- [pg-mem](https://github.com/oguimbal/pg-mem) - **star:2007** 测试的内存PostgreSQL实例。 ![star > 2000][Awesome] 
...
- [Sinon.JS](https://github.com/sinonjs/sinon) - **star:9661** 测试间谍，存根和嘲笑 ![star > 2000][Awesome] 
- [navit](https://github.com/nodeca/navit) - **star:48** PhantomJS / SlimerJS包装器，用于简化浏览器测试脚本
- [Nock](https://github.com/nock/nock) - **star:12740** HTTP模拟和期望 ![star > 2000][Awesome] 
...
- [Nightwatch](https://github.com/nightwatchjs/nightwatch) - **star:11834** 基于Selenium WebDriver的自动化UI测试框架 ![star > 2000][Awesome] 
- [WebdriverIO](https://github.com/webdriverio/webdriverio) - **star:9071** 基于WebDriver协议的自动化测试 ![star > 2000][Awesome] 
- [Jest](https://github.com/facebook/jest) - **star:44274** 无痛的JavaScript测试 ![star > 2000][Awesome] 
...
- [Puppeteer](https://github.com/puppeteer/puppeteer) - **star:88844** Headless Chrome ![star > 2000][Awesome] 
- [Playwright](https://github.com/microsoft/playwright) - **star:66950** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome] 
- [nve](https://github.com/ehmicky/nve) - **star:693** 在Node.js的多个版本上本地运行任何命令。
- [axe-core](https://github.com/dequelabs/axe-core) - **star:6008** 用于自动化Web UI测试的可访问性引擎。 ![star > 2000][Awesome] 
- [testcontainers-node](https://github.com/testcontainers/testcontainers-node) - **star:1921** 提供通用数据库、Selenium web浏览器或任何可以在Docker容器中运行的东西的轻量级、一次性实例。

### 安全
*翻译出错了? 试试 [英文版](readme_en.md#Security) 吧~*

- [upash](https://github.com/simonepri/upash) - **star:540** 统一的API为所有密码哈希算法
- [themis](https://github.com/cossacklabs/themis) - **star:1875** 使典型加密方案易于使用的多语言框架:静态数据、经过身份验证的数据交换、传输保护、身份验证等等
- [GuardRails](https://github.com/apps/guardrails) - 在拉请求中提供安全反馈的GitHub应用程序
- [rate-limiter-flexible](https://github.com/animir/node-rate-limiter-flexible) - **star:3072** 暴力和DDoS攻击保护 ![star > 2000][Awesome] 
...
- [UglifyJS2](https://github.com/mishoo/UglifyJS) - **star:13164** JavaScript缩小镜 ![star > 2000][Awesome] 
...
- [imagemin](https://github.com/imagemin/imagemin) - **star:5576** 图像缩小镜 ![star > 2000][Awesome] 

### 身份验证
*翻译出错了? 试试 [英文版](readme_en.md#Authentication) 吧~*

- [Passport](https://github.com/jaredhanson/passport) - **star:22959** 简单、低调的身份验证 ![star > 2000][Awesome] 
...
- [CASL](https://github.com/stalniy/casl) - **star:6018** UI和API的同构授权 ![star > 2000][Awesome] 
- [node-casbin](https://github.com/casbin/node-casbin) - **star:2611** 支持ACL、RBAC和ABAC等访问控制模型的授权库 ![star > 2000][Awesome] 

### 邮件
*翻译出错了? 试试 [英文版](readme_en.md#Email) 吧~*

- [Nodemailer](https://github.com/nodemailer/nodemailer) - **star:16722** 处理电子邮件的最快方式 ![star > 2000][Awesome] 
...
- [MJML](https://github.com/mjmlio/mjml) - **star:17081** 标记语言，旨在减少创建响应电子邮件的痛苦 ![star > 2000][Awesome] 

### 工作队列
*翻译出错了? 试试 [英文版](readme_en.md#Job%20queues) 吧~*

- [bull](https://github.com/OptimalBits/bull) - **star:15566** 持久作业和消息队列 ![star > 2000][Awesome] 
- [agenda](https://github.com/agenda/agenda) - **star:9400** MongoDB-backed工作调度 ![star > 2000][Awesome] 
...
- [bee-queue](https://github.com/bee-queue/bee-queue) - **star:3826** 高性能redis支持的作业队列 ![star > 2000][Awesome] 
- [RedisSMQ](https://github.com/weyoss/redis-smq) - **star:593** 简单的高性能Redis消息队列与实时监控
...
- [bullmq](https://github.com/taskforcesh/bullmq) - **star:6176** 持久作业和消息队列 ![star > 2000][Awesome] 
- [bree](https://github.com/breejs/bree) - **star:3063** 具有工作线程、cron、日期和人工语法支持的作业任务调度器。 ![star > 2000][Awesome] 

### Node.js 管理
*翻译出错了? 试试 [英文版](readme_en.md#Node.js%20management) 吧~*

- [n](https://github.com/tj/n) - **star:18879** Node.js 版本管理 ![star > 2000][Awesome] 
...
- [nvm for Windows](https://github.com/coreybutler/nvm-windows) - **star:37947** Windows 版本管理 ![star > 2000][Awesome] 
- [nodenv](https://github.com/nodenv/nodenv) - **star:2249** 类似于Ruby的rbenv的版本管理器它支持自动版本切换 ![star > 2000][Awesome] 
- [fnm](https://github.com/Schniz/fnm) - **star:18252** 跨平台的Node.js版本管理器内置在Rust中。 ![star > 2000][Awesome] 

### 跨平台的集成
*翻译出错了? 试试 [英文版](readme_en.md#Cross-platform%20integration) 吧~*

- [napi-rs](https://github.com/napi-rs/napi-rs) - **star:6131** 通过Node-API在Rust中构建编译后的Node.js插件的框架。 ![star > 2000][Awesome] 
- [Neon](https://github.com/neon-bindings/neon) - **star:8060** Rust绑定用于编写安全和快速的本地Node.js模块。 ![star > 2000][Awesome] 
- [Edge.js](https://github.com/agracio/edge-js) - **star:710** 在Windows、macOS和Linux上以相同的进程运行。net和Node.js代码。
...
- [franc](https://github.com/wooorm/franc) - **star:4137** 检测文本的语言 ![star > 2000][Awesome] 
- [leven](https://github.com/sindresorhus/leven) - **star:715** 使用Levenshtein距离算法测量两个字符串之间的差异
- [natural](https://github.com/NaturalNode/natural) - **star:10623** 自然语言工具 ![star > 2000][Awesome] 
- [nlp.js](https://github.com/axa-group/nlp.js) - **star:6282** 构建机器人，具有实体提取、情感分析、自动语言识别等功能 ![star > 2000][Awesome] 

### 流程管理
*翻译出错了? 试试 [英文版](readme_en.md#Process%20management) 吧~*

- [PM2](https://github.com/Unitech/pm2) - **star:41563** 先进的流程管理 ![star > 2000][Awesome] 
- [nodemon](https://github.com/remy/nodemon) - **star:26322** 监视应用程序中的更改并自动重启服务器 ![star > 2000][Awesome] 
...
- [node-windows](https://github.com/coreybutler/node-windows) - **star:2826** 将脚本作为本机Windows服务运行，并记录到事件查看器 ![star > 2000][Awesome] 
...
- [robotjs](https://github.com/octalmage/robotjs) - **star:12383** 桌面自动化:控制鼠标、键盘和阅读屏幕 ![star > 2000][Awesome] 
- [nut.js](https://github.com/nut-tree/nut.js) - **star:2270** 跨平台的本地GUI自动化/测试框架，具有与Jest集成的图像匹配功能。 ![star > 2000][Awesome] 

### AST
*翻译出错了? 试试 [英文版](readme_en.md#AST) 吧~*

- [Acorn](https://github.com/acornjs/acorn) - **star:10604** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome] 
...
- [docsify](https://github.com/docsifyjs/docsify) - **star:27765** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome] 
...
- [KeystoneJS](https://github.com/keystonejs/keystone) - **star:9260** CMS和基于Express和MongoDB的web应用平台 ![star > 2000][Awesome] 
...
- [Strapi](https://github.com/strapi/strapi) - **star:63780** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome] 
- [Factor](https://github.com/FactorJS/factor) - **star:1416** Vue.js仪表板框架和无头CMS。
- [AdminBro](https://github.com/SoftwareBrothers/adminjs) - **star:8248** 所有资源的CRUD自动生成管理面板。 ![star > 2000][Awesome] 
- [Graphweaver](https://github.com/exogee-technology/graphweaver) - **star:490** CMS和无头GraphQL API。

### 论坛
*翻译出错了? 试试 [英文版](readme_en.md#Forum) 吧~*

- [nodeBB](https://github.com/NodeBB/NodeBB) - **star:14224** 现代网络论坛平台 ![star > 2000][Awesome] 

### 写博客
*翻译出错了? 试试 [英文版](readme_en.md#Blogging) 吧~*

- [Ghost](https://github.com/TryGhost/Ghost) - **star:47501** 简单、强大的发布平台 ![star > 2000][Awesome] 
- [Hexo](https://github.com/hexojs/hexo) - **star:39519** 快速，简单和强大的博客框架 ![star > 2000][Awesome] 
...
- [protobuf](https://github.com/protobufjs/protobuf.js) - **star:9928** 协议缓冲区的实现 ![star > 2000][Awesome] 
- [compactr](https://github.com/compactr/compactr.js) - **star:101** 实现Compactr协议

### 杂项
*翻译出错了? 试试 [英文版](readme_en.md#Miscellaneous) 吧~*

- [execa](https://github.com/sindresorhus/execa) - **star:6870** 更好的“child_process” ![star > 2000][Awesome] 
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:28691** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome] 
...
- [mem](https://github.com/sindresorhus/mem) - **star:1087** 记忆函数——一种优化技术，通过缓存具有相同输入的调用的结果来加速连续的函数调用
...
- [ssh2](https://github.com/mscdex/ssh2) - **star:5530** SSH2客户端和服务器模块 ![star > 2000][Awesome] 
...
- [clipboardy](https://github.com/sindresorhus/clipboardy) - **star:1790** 访问系统剪贴板(复制/粘贴)
...
- [dotenv](https://github.com/motdotla/dotenv) - **star:19215** 从.env文件中加载环境变量 ![star > 2000][Awesome] 
- [semver](https://github.com/npm/node-semver) - **star:5100** 语义版本解析器 ![star > 2000][Awesome] 
...
- [jsdom](https://github.com/jsdom/jsdom) - **star:20559** JavaScript实现的HTML和DOM ![star > 2000][Awesome] 
...
- [basic-ftp](https://github.com/patrickjuchli/basic-ftp) - **star:673** FTP / FTP客户端。
...
- [husky](https://github.com/typicode/husky) - **star:32628** 创建Git钩子脚本。 ![star > 2000][Awesome] 
- [patch-package](https://github.com/ds300/patch-package) - **star:10459** 修复并保留npm依赖。 ![star > 2000][Awesome] 
- [editly](https://github.com/mifi/editly) - **star:4791** 声明式视频编辑API。 ![star > 2000][Awesome] 
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - **star:100593** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome] 
...
- [Amplication](https://github.com/amplication/amplication) - **star:15215** 自动生成功能齐全的应用程序。 ![star > 2000][Awesome] 
...
- [awesome-npm](https://github.com/sindresorhus/awesome-npm) - **star:4497** 使用npm的资源和技巧 ![star > 2000][Awesome] 
