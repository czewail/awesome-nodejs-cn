...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2024-06-25 08:30:57）**
...
- [webtorrent](https://github.com/webtorrent/webtorrent) - **star:29184** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
- [peerflix](https://github.com/mafintosh/peerflix) - **star:6171** 流式 Torrent 客户端 ![star > 2000][Awesome] 
- [ipfs](https://github.com/ipfs/helia) - **star:805** 分布式文件系统，用于将所有计算设备与同一文件系统连接起来
...
- [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) - **star:5585** 干净、可读比特币库 ![star > 2000][Awesome] 
- [Bitcore](https://github.com/bitpay/bitcore) - **star:4795** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/foliojs/pdfkit) - **star:9624** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:8968** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [Brain.js](https://github.com/BrainJS/brain.js) - **star:14247** 机器学习框架 ![star > 2000][Awesome] 
- [Pipcook](https://github.com/alibaba/pipcook) - **star:2514** 前端算法框架创建机器学习流水线。 ![star > 2000][Awesome] 
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:9881** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
- [js-git](https://github.com/creationix/js-git) - **star:3829** Git的 JavaScript 实现 ![star > 2000][Awesome] 
- [xlsx](https://github.com/SheetJS/sheetjs) - **star:34697** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
...
- [XO](https://github.com/xojs/xo) - **star:7587** 使用 Javascript happiness style 进行严格编码 ![star > 2000][Awesome] 
- [ESLint](https://github.com/eslint/eslint) - **star:24538** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
- [David](https://github.com/alanshaw/david) - **star:965** 告诉你包的 npm 依赖项何时过期
- [http-server](https://github.com/http-party/http-server) - **star:13417** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome] 
- [Live Server](https://github.com/tapio/live-server) - **star:4358** 具有热重载功能的 HTTP-server ![star > 2000][Awesome] 
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:18461** 向外界公开本地主机 ![star > 2000][Awesome] 
- [svg-term-cli](https://github.com/marionebl/svg-term-cli) - **star:3478** 通过 SVG 共享终端会话 ![star > 2000][Awesome] 
- [gtop](https://github.com/aksakalli/gtop) - **star:9659** 终端系统监控仪表板 ![star > 2000][Awesome] 
...
- [taskbook](https://github.com/klaussinani/taskbook) - **star:8907** 命令行栖息地的任务、板子和注释 ![star > 2000][Awesome] 
- [discharge](https://github.com/brandonweiss/discharge) - **star:599** 轻松地将静态站点部署到Amazon S3
- [npkill](https://github.com/voidcosmos/npkill) - **star:8036** 轻松找到并删除旧的和沉重的node_modules文件夹 ![star > 2000][Awesome] 

### 函数式编程
*翻译出错了? 试试 [英文版](readme_en.md#Functional%20programming) 吧~*

- [lodash](https://github.com/lodash/lodash) - **star:59186** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/immutable-js/immutable-js) - **star:32897** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:23643** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome] 
- [Mout](https://github.com/mout/mout) - **star:1290** 实用工具库与其他现有解决方案最大的区别在于，您可以选择只加载您需要的模块/函数，而不需要额外的开销
- [RxJS](https://github.com/reactivex/rxjs) - **star:30393** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1868** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:14040** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [undici](https://github.com/nodejs/undici) - **star:5900** 从头编写的高性能HTTP客户端，没有依赖关系。 ![star > 2000][Awesome] 
- [ky-universal](https://github.com/sindresorhus/ky-universal) - **star:668** 基于Fetch的通用HTTP客户端。
- [node-fetch](https://github.com/node-fetch/node-fetch) - **star:8697** node.js 版的 `window.fetch` ![star > 2000][Awesome] 
- [axios](https://github.com/axios/axios) - **star:104500** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
...
- [debug](https://github.com/debug-js/debug) - **star:11033** 微小的调试工具 ![star > 2000][Awesome] 
- [why-is-node-running](https://github.com/mafintosh/why-is-node-running) - **star:1665** js正在运行，但你不知道为什么?
...
- [0x](https://github.com/davidmarkclements/0x) - **star:3144** 火焰图分析 ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:13552** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:22279** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [consola](https://github.com/unjs/consola) - **star:5775** 控制台记录器。 ![star > 2000][Awesome] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:21582** 终端字符串样式设置 ![star > 2000][Awesome] 
...
- [ora](https://github.com/sindresorhus/ora) - **star:8971** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:26125** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
- [listr2](https://github.com/listr2/listr2) - **star:476** 终端任务列表
...
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:19576** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [cfonts](https://github.com/dominikwilkowski/cfonts) - **star:1554** 性感的ASCII字体控制台
...
- [cross-env](https://github.com/kentcdodds/cross-env) - **star:6285** 设置跨平台的环境变量 ![star > 2000][Awesome]  ![项目已归档][Archived] 
- [shelljs](https://github.com/shelljs/shelljs) - **star:14178** 可移植的Unix shell命令 ![star > 2000][Awesome] 
...
- [Bit](https://github.com/teambit/bit) - **star:17683** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
...
- [zx](https://github.com/google/zx) - **star:42224** 编写shell脚本JavaScript。 ![star > 2000][Awesome] 

### 构建工具
*翻译出错了? 试试 [英文版](readme_en.md#Build%20tools) 吧~*

- [parcel](https://github.com/parcel-bundler/parcel) - **star:43245** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome] 
- [webpack](https://github.com/webpack/webpack) - **star:64312** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:24985** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
...
- [pkg](https://github.com/vercel/pkg) - **star:24232** 将Node.js项目打包成可执行文件 ![star > 2000][Awesome]  ![项目已归档][Archived] 
- [Vite](https://github.com/vitejs/vite) - **star:65758** 前端构建工具，具有热模块替换和静态资产捆绑。 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:13235** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
- [serialport](https://github.com/serialport/node-serialport) - **star:5741** 访问串行端口进行读写 ![star > 2000][Awesome] 
...
- [modbus-serial](https://github.com/yaacov/node-modbus-serial) - **star:605** MODBUS-RTU(串行和TCP)的纯JavaScript实现。

### 模板
*翻译出错了? 试试 [英文版](readme_en.md#Templating) 吧~*

- [marko](https://github.com/marko-js/marko) - **star:13229** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome] 
- [nunjucks](https://github.com/mozilla/nunjucks) - **star:8474** 带有继承、异步控制等功能的模板引擎(受jinja2的启发) ![star > 2000][Awesome] 
- [handlebars.js](https://github.com/handlebars-lang/handlebars.js) - **star:17804** Superset of Mustache 模板的超集，添加了强大的功能，如帮助程序和更高级的块 ![star > 2000][Awesome] 
- [EJS](https://github.com/mde/ejs) - **star:7632** 简单的未绑定模板语言 ![star > 2000][Awesome] 
- [Pug](https://github.com/pugjs/pug) - **star:21565** 高性能模板引擎深受Haml的影响 ![star > 2000][Awesome] 

### Web 框架
*翻译出错了? 试试 [英文版](readme_en.md#Web%20frameworks) 吧~*

- [Fastify](https://github.com/fastify/fastify) - **star:31154** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Next.js](https://github.com/vercel/next.js) - **star:122449** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:52914** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
...
- [Koa](https://github.com/koajs/koa) - **star:34977** Express背后的团队设计的框架，其目标是为web应用程序和api提供一个更小、更富表现力和更健壮的基础 ![star > 2000][Awesome] 
- [Express](https://github.com/expressjs/express) - **star:64238** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
- [Feathers](https://github.com/feathersjs/feathers) - **star:14962** 基于Express精神构建的微服务框架 ![star > 2000][Awesome] 
- [LoopBack](https://github.com/loopbackio/loopback-next) - **star:4877** 用于创建REST api和轻松连接到后端数据源的强大框架 ![star > 2000][Awesome] 
- [Meteor](https://github.com/meteor/meteor) - **star:44118** 一个超简单的、无处不在的数据库、在线数据、纯javascript web框架*(你可能会喜欢[awesome-meteor](https://github.com/Urigo/awesome-meteor))* ![star > 2000][Awesome] 
...
- [AdonisJs](https://github.com/adonisjs/core) - **star:16191** 一个真正的Node.js MVC框架，建立在依赖注入和IoC容器的坚实基础上 ![star > 2000][Awesome] 
- [Moleculer](https://github.com/moleculerjs/moleculer) - **star:6067** 快速强大的微服务框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:65395** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
- [TypeGraphQL](https://github.com/MichalLytek/type-graphql) - **star:7973** 基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架 ![star > 2000][Awesome] 
...
- [Lad](https://github.com/ladjs/lad) - **star:2269** 由前Express TC和Koa成员制作的框架，捆绑了web、API、作业和代理服务器。 ![star > 2000][Awesome] 
- [Ts.ED](https://github.com/tsedio/tsed) - **star:2776** 直观的TypeScript框架，用于在Express.js或Koa.js之上构建服务器端应用。 ![star > 2000][Awesome] 
- [Hono](https://github.com/honojs/hono) - **star:16666** 小而快速的web框架。 ![star > 2000][Awesome] 
...
- [JSDoc](https://github.com/jsdoc/jsdoc) - **star:14859** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome] 
- [Docusaurus](https://github.com/facebook/docusaurus) - **star:53897** 文档网站生成器，利用React和Markdown，并附带翻译和版本控制功能。 ![star > 2000][Awesome] 
...
- [chokidar](https://github.com/paulmillr/chokidar) - **star:10670** 文件系统监视程序，它稳定来自' fs的事件看”和“fs以及在macOS上使用本地的“fsevents” ![star > 2000][Awesome] 
...
- [fs-extra](https://github.com/jprichardson/node-fs-extra) - **star:9379** ' fs '模块的额外方法 ![star > 2000][Awesome] 
...
- Observables
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:30393** 反应性编程 ![star > 2000][Awesome] 
...
- [readable-stream](https://github.com/nodejs/readable-stream) - **star:1024** 核心中Streams2和Streams3实现的镜像
- [through2-concurrent](https://github.com/almost/through2-concurrent) - **star:74** 同时转换对象流

### 实时
*翻译出错了? 试试 [英文版](readme_en.md#Real-time) 吧~*

- [µWebSockets](https://github.com/uNetworking/uWebSockets) - **star:16965** 高度可伸缩的WebSocket服务器和客户端库 ![star > 2000][Awesome] 
- [Socket.io](https://github.com/socketio/socket.io) - **star:60483** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
...
- [MQTT.js](https://github.com/mqttjs/MQTT.js) - **star:8411** 基于MQTT的消息传递协议的客户机，用于TCP/IP之上 ![star > 2000][Awesome] 
- [rpc-websockets](https://github.com/elpheria/rpc-websockets) - **star:577** 通过WebSockets实现JSON-RPC 2.0
- [Aedes](https://github.com/moscajs/aedes) - **star:1745** 可以在任何流服务器上运行的Barebone MQTT服务器

### 图像
*翻译出错了? 试试 [英文版](readme_en.md#Image) 吧~*

- [sharp](https://github.com/lovell/sharp) - **star:28323** 用于调整JPEG、PNG、WebP和TIFF图像大小的最快模块 ![star > 2000][Awesome] 
- [image-type](https://github.com/sindresorhus/image-type) - **star:366** 检测图像的类型。
- [image-dimensions](https://github.com/sindresorhus/image-dimensions) - **star:419** 获取图像的尺寸。
...
- [jimp](https://github.com/oliver-moran/jimp) - **star:13581** 图像处理在纯JavaScript ![star > 2000][Awesome] 
- [qrcode](https://github.com/soldair/node-qrcode) - **star:7262** 二维码和条形码发生器 ![star > 2000][Awesome] 
...
- [i18next](https://github.com/i18next/i18next) - **star:7518** 国际化框架 ![star > 2000][Awesome] 
- [nanoid](https://github.com/ai/nanoid) - **star:23801** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome] 
- [StegCloak](https://github.com/kurolabs/stegcloak) - **star:3208** 把秘密隐藏在琴弦中，在众目睽睽之下。 ![star > 2000][Awesome] 
...
- [mathjs](https://github.com/josdejong/mathjs) - **star:14171** 一个广泛的数学图书馆 ![star > 2000][Awesome] 
...
- [Luxon](https://github.com/moment/luxon) - **star:15016** 用于处理日期和时间的库 ![star > 2000][Awesome] 
- [date-fns](https://github.com/date-fns/date-fns) - **star:34034** 现代实用程序 ![star > 2000][Awesome] 
- [Day.js](https://github.com/iamkun/dayjs) - **star:46150** 不可变日期库替代Moment.js ![star > 2000][Awesome] 
...
- [joi](https://github.com/sideway/joi) - **star:20716** 对象模式描述语言和JavaScript对象的验证器 ![star > 2000][Awesome] 
...
- [ajv](https://github.com/ajv-validator/ajv) - **star:13513** 最快的JSON模式验证器支持v5、v6和v7提案 ![star > 2000][Awesome] 
- [Superstruct](https://github.com/ianstormtaylor/superstruct) - **star:6874** 在JavaScript(和TypeScript)中验证数据的简单而可组合的方法。 ![star > 2000][Awesome] 
- [yup](https://github.com/jquense/yup) - **star:22444** 对象模式验证。 ![star > 2000][Awesome] 
- [zod](https://github.com/colinhacks/zod) - **star:31488** 带静态类型推断的typescript优先模式验证。 ![star > 2000][Awesome] 

### 解析
*翻译出错了? 试试 [英文版](readme_en.md#Parsing) 吧~*

- [remark](https://github.com/remarkjs/remark) - **star:7350** 插件驱动的降价处理器 ![star > 2000][Awesome] 
- [markdown-it](https://github.com/markdown-it/markdown-it) - **star:17501** Markdown解析器具有100%的公共标记支持、扩展和语法插件 ![star > 2000][Awesome] 
- [parse5](https://github.com/inikulin/parse5) - **star:3586** 快速功能齐全的符合规范的HTML解析器 ![star > 2000][Awesome] 
- [@parcel/css](https://github.com/parcel-bundler/parcel-css) - **star:6081** 一个用Rust编写的CSS解析器、转换器和迷你器。 ![star > 2000][Awesome] 
...
- [xlsx-populate](https://github.com/dtjohnson/xlsx-populate) - **star:937** 读/写Excel XLSX
- [Chevrotain](https://github.com/Chevrotain/chevrotain) - **star:2429** 非常快，功能丰富的JavaScript解析器构建工具包 ![star > 2000][Awesome] 
- [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) - **star:2416** 验证和解析XML ![star > 2000][Awesome] 
...
- [pako](https://github.com/nodeca/pako) - **star:5400** 高速zlib端口到纯js(放气，充气，gzip) ![star > 2000][Awesome] 
...
- Drivers
- [PostgreSQL](https://github.com/brianc/node-postgres) - **star:12022** PostgreSQL客户机纯JavaScript和本地libpq绑定 ![star > 2000][Awesome] 
- [Redis](https://github.com/luin/ioredis) - **star:14033** 复述,客户机 ![star > 2000][Awesome] 
...
- ODM / ORM
- [Sequelize](https://github.com/sequelize/sequelize) - **star:29211** Multi-dialect ORM。支持PostgreSQL, SQLite, MySQL等。 ![star > 2000][Awesome] 
- [Bookshelf](https://github.com/bookshelf/bookshelf) - **star:6341** ORM用于PostgreSQL、MySQL和SQLite3，风格为Backbone.js ![star > 2000][Awesome] 
- [Mongoose](https://github.com/Automattic/mongoose) - **star:26746** 优雅的MongoDB对象建模 ![star > 2000][Awesome] 
...
- [Objection.js](https://github.com/Vincit/objection.js) - **star:7221** 轻量级ORM构建于SQL查询生成器Knex之上 ![star > 2000][Awesome] 
- [TypeORM](https://github.com/typeorm/typeorm) - **star:33635** ORM用于PostgreSQL、MariaDB、MySQL、SQLite等 ![star > 2000][Awesome] 
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:7324** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Prisma](https://github.com/prisma/prisma) - **star:37925** 现代数据库访问(ORM替代)。在TypeScript中自动生成和类型安全的查询生成器。支持PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) - **star:21335** 支持各种数据库，如PostgreSQL的TypeScript ORM。 ![star > 2000][Awesome] 
- Query builder
- [Knex](https://github.com/knex/knex) - **star:18933** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:13455** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:21107** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
...
- [pg-mem](https://github.com/oguimbal/pg-mem) - **star:1858** 测试的内存PostgreSQL实例。

### 测试
*翻译出错了? 试试 [英文版](readme_en.md#Testing) 吧~*

- [AVA](https://github.com/avajs/ava) - **star:20661** 未来的测试运行器 ![star > 2000][Awesome] 
...
- [Sinon.JS](https://github.com/sinonjs/sinon) - **star:9588** 测试间谍，存根和嘲笑 ![star > 2000][Awesome] 
- [navit](https://github.com/nodeca/navit) - **star:48** PhantomJS / SlimerJS包装器，用于简化浏览器测试脚本
- [Nock](https://github.com/nock/nock) - **star:12601** HTTP模拟和期望 ![star > 2000][Awesome] 
...
- [Nightwatch](https://github.com/nightwatchjs/nightwatch) - **star:11743** 基于Selenium WebDriver的自动化UI测试框架 ![star > 2000][Awesome] 
- [WebdriverIO](https://github.com/webdriverio/webdriverio) - **star:8858** 基于WebDriver协议的自动化测试 ![star > 2000][Awesome] 
- [Jest](https://github.com/facebook/jest) - **star:43800** 无痛的JavaScript测试 ![star > 2000][Awesome] 
...
- [Puppeteer](https://github.com/puppeteer/puppeteer) - **star:87536** Headless Chrome ![star > 2000][Awesome] 
- [Playwright](https://github.com/microsoft/playwright) - **star:63505** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome] 
- [nve](https://github.com/ehmicky/nve) - **star:694** 在Node.js的多个版本上本地运行任何命令。
- [axe-core](https://github.com/dequelabs/axe-core) - **star:5745** 用于自动化Web UI测试的可访问性引擎。 ![star > 2000][Awesome] 
- [testcontainers-node](https://github.com/testcontainers/testcontainers-node) - **star:1770** 提供通用数据库、Selenium web浏览器或任何可以在Docker容器中运行的东西的轻量级、一次性实例。
...
- [rate-limiter-flexible](https://github.com/animir/node-rate-limiter-flexible) - **star:2943** 暴力和DDoS攻击保护 ![star > 2000][Awesome] 
...
- [UglifyJS2](https://github.com/mishoo/UglifyJS) - **star:12995** JavaScript缩小镜 ![star > 2000][Awesome] 
...
- [Passport](https://github.com/jaredhanson/passport) - **star:22612** 简单、低调的身份验证 ![star > 2000][Awesome] 
...
- [node-casbin](https://github.com/casbin/node-casbin) - **star:2519** 支持ACL、RBAC和ABAC等访问控制模型的授权库 ![star > 2000][Awesome] 

### 邮件
*翻译出错了? 试试 [英文版](readme_en.md#Email) 吧~*

- [Nodemailer](https://github.com/nodemailer/nodemailer) - **star:16449** 处理电子邮件的最快方式 ![star > 2000][Awesome] 
...
- [MJML](https://github.com/mjmlio/mjml) - **star:16634** 标记语言，旨在减少创建响应电子邮件的痛苦 ![star > 2000][Awesome] 

### 工作队列
*翻译出错了? 试试 [英文版](readme_en.md#Job%20queues) 吧~*

- [bull](https://github.com/OptimalBits/bull) - **star:15224** 持久作业和消息队列 ![star > 2000][Awesome] 
- [agenda](https://github.com/agenda/agenda) - **star:9301** MongoDB-backed工作调度 ![star > 2000][Awesome] 
- [idoit](https://github.com/nodeca/idoit) - **star:73** 具有高级作业控制的redis支持的作业队列引擎
- [node-resque](https://github.com/actionhero/node-resque) - **star:1344** Redis-backed工作队列
- [rsmq](https://github.com/smrchy/rsmq) - **star:1745** Redis-backed消息队列
- [bee-queue](https://github.com/bee-queue/bee-queue) - **star:3683** 高性能redis支持的作业队列 ![star > 2000][Awesome] 
...
- [bullmq](https://github.com/taskforcesh/bullmq) - **star:5571** 持久作业和消息队列 ![star > 2000][Awesome] 
- [bree](https://github.com/breejs/bree) - **star:2935** 具有工作线程、cron、日期和人工语法支持的作业任务调度器。 ![star > 2000][Awesome] 

### Node.js 管理
*翻译出错了? 试试 [英文版](readme_en.md#Node.js%20management) 吧~*

- [n](https://github.com/tj/n) - **star:18630** Node.js 版本管理 ![star > 2000][Awesome] 
...
- [nvm for Windows](https://github.com/coreybutler/nvm-windows) - **star:35680** Windows 版本管理 ![star > 2000][Awesome] 
- [nodenv](https://github.com/nodenv/nodenv) - **star:2190** 类似于Ruby的rbenv的版本管理器它支持自动版本切换 ![star > 2000][Awesome] 
- [fnm](https://github.com/Schniz/fnm) - **star:16276** 跨平台的Node.js版本管理器内置在Rust中。 ![star > 2000][Awesome] 

### 跨平台的集成
*翻译出错了? 试试 [英文版](readme_en.md#Cross-platform%20integration) 吧~*

- [napi-rs](https://github.com/napi-rs/napi-rs) - **star:5645** 通过Node-API在Rust中构建编译后的Node.js插件的框架。 ![star > 2000][Awesome] 
- [Neon](https://github.com/neon-bindings/neon) - **star:7838** Rust绑定用于编写安全和快速的本地Node.js模块。 ![star > 2000][Awesome] 
...
- [natural](https://github.com/NaturalNode/natural) - **star:10522** 自然语言工具 ![star > 2000][Awesome] 
- [nlp.js](https://github.com/axa-group/nlp.js) - **star:6143** 构建机器人，具有实体提取、情感分析、自动语言识别等功能 ![star > 2000][Awesome] 

### 流程管理
*翻译出错了? 试试 [英文版](readme_en.md#Process%20management) 吧~*

- [PM2](https://github.com/Unitech/pm2) - **star:40973** 先进的流程管理 ![star > 2000][Awesome] 
- [nodemon](https://github.com/remy/nodemon) - **star:26094** 监视应用程序中的更改并自动重启服务器 ![star > 2000][Awesome] 
...
- [robotjs](https://github.com/octalmage/robotjs) - **star:12192** 桌面自动化:控制鼠标、键盘和阅读屏幕 ![star > 2000][Awesome] 
...
- [Acorn](https://github.com/acornjs/acorn) - **star:10319** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome] 
...
- [docsify](https://github.com/docsifyjs/docsify) - **star:26982** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome] 
...
- [KeystoneJS](https://github.com/keystonejs/keystone) - **star:8964** CMS和基于Express和MongoDB的web应用平台 ![star > 2000][Awesome] 
...
- [Strapi](https://github.com/strapi/strapi) - **star:61426** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome] 
- [Factor](https://github.com/FactorJS/factor) - **star:1386** Vue.js仪表板框架和无头CMS。
- [AdminBro](https://github.com/SoftwareBrothers/adminjs) - **star:8037** 所有资源的CRUD自动生成管理面板。 ![star > 2000][Awesome] 
...
- [Ghost](https://github.com/TryGhost/Ghost) - **star:46137** 简单、强大的发布平台 ![star > 2000][Awesome] 
- [Hexo](https://github.com/hexojs/hexo) - **star:38806** 快速，简单和强大的博客框架 ![star > 2000][Awesome] 
...
- [protobuf](https://github.com/protobufjs/protobuf.js) - **star:9715** 协议缓冲区的实现 ![star > 2000][Awesome] 
- [compactr](https://github.com/compactr/compactr.js) - **star:101** 实现Compactr协议

### 杂项
*翻译出错了? 试试 [英文版](readme_en.md#Miscellaneous) 吧~*

- [execa](https://github.com/sindresorhus/execa) - **star:6601** 更好的“child_process” ![star > 2000][Awesome] 
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:27994** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome] 
- [open](https://github.com/sindresorhus/open) - **star:3138** 打开网站、文件、可执行文件等 ![star > 2000][Awesome] 
...
- [clipboardy](https://github.com/sindresorhus/clipboardy) - **star:1749** 访问系统剪贴板(复制/粘贴)
...
- [dotenv](https://github.com/motdotla/dotenv) - **star:18677** 从.env文件中加载环境变量 ![star > 2000][Awesome] 
- [semver](https://github.com/npm/node-semver) - **star:5002** 语义版本解析器 ![star > 2000][Awesome] 
...
- [husky](https://github.com/typicode/husky) - **star:31898** 创建Git钩子脚本。 ![star > 2000][Awesome] 
- [patch-package](https://github.com/ds300/patch-package) - **star:10111** 修复并保留npm依赖。 ![star > 2000][Awesome] 
- [editly](https://github.com/mifi/editly) - **star:4625** 声明式视频编辑API。 ![star > 2000][Awesome] 
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - **star:97090** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome] 
...
- [Amplication](https://github.com/amplication/amplication) - **star:14544** 自动生成功能齐全的应用程序。 ![star > 2000][Awesome] 
...
- [awesome-npm](https://github.com/sindresorhus/awesome-npm) - **star:4428** 使用npm的资源和技巧 ![star > 2000][Awesome] 
