...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2024-06-17 08:32:52）**
...
- [webtorrent](https://github.com/webtorrent/webtorrent) - **star:29160** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
...
- [PDFKit](https://github.com/foliojs/pdfkit) - **star:9606** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:8925** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [Brain.js](https://github.com/BrainJS/brain.js) - **star:14239** 机器学习框架 ![star > 2000][Awesome] 
- [Pipcook](https://github.com/alibaba/pipcook) - **star:2512** 前端算法框架创建机器学习流水线。 ![star > 2000][Awesome] 
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:9869** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
- [js-git](https://github.com/creationix/js-git) - **star:3830** Git的 JavaScript 实现 ![star > 2000][Awesome] 
- [xlsx](https://github.com/SheetJS/sheetjs) - **star:34676** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
- [isomorphic-git](https://github.com/isomorphic-git/isomorphic-git) - **star:7337** 纯 JavaScript 实现的 Git ![star > 2000][Awesome] 
...
- [XO](https://github.com/xojs/xo) - **star:7579** 使用 Javascript happiness style 进行严格编码 ![star > 2000][Awesome] 
- [ESLint](https://github.com/eslint/eslint) - **star:24499** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
- [David](https://github.com/alanshaw/david) - **star:965** 告诉你包的 npm 依赖项何时过期
- [http-server](https://github.com/http-party/http-server) - **star:13407** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome] 
...
- [license-checker](https://github.com/davglass/license-checker) - **star:1578** 检查应用程序依赖项的许可
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:18415** 向外界公开本地主机 ![star > 2000][Awesome] 
...
- [themer](https://github.com/themerdev/themer) - **star:5418** 为编辑器、终端、墙纸、Slack等生成主题 ![star > 2000][Awesome] 
...
- [taskbook](https://github.com/klaussinani/taskbook) - **star:8903** 命令行栖息地的任务、板子和注释 ![star > 2000][Awesome] 
- [discharge](https://github.com/brandonweiss/discharge) - **star:599** 轻松地将静态站点部署到Amazon S3
- [npkill](https://github.com/voidcosmos/npkill) - **star:8027** 轻松找到并删除旧的和沉重的node_modules文件夹 ![star > 2000][Awesome] 

### 函数式编程
*翻译出错了? 试试 [英文版](readme_en.md#Functional%20programming) 吧~*

- [lodash](https://github.com/lodash/lodash) - **star:59137** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/immutable-js/immutable-js) - **star:32884** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:23634** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome] 
- [Mout](https://github.com/mout/mout) - **star:1290** 实用工具库与其他现有解决方案最大的区别在于，您可以选择只加载您需要的模块/函数，而不需要额外的开销
- [RxJS](https://github.com/reactivex/rxjs) - **star:30358** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1868** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:14024** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [undici](https://github.com/nodejs/undici) - **star:5879** 从头编写的高性能HTTP客户端，没有依赖关系。 ![star > 2000][Awesome] 
- [ky-universal](https://github.com/sindresorhus/ky-universal) - **star:669** 基于Fetch的通用HTTP客户端。
- [node-fetch](https://github.com/node-fetch/node-fetch) - **star:8688** node.js 版的 `window.fetch` ![star > 2000][Awesome] 
- [axios](https://github.com/axios/axios) - **star:104437** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
- [superagent](https://github.com/visionmedia/superagent) - **star:16551** HTTP请求库 ![star > 2000][Awesome] 
...
- [global-agent](https://github.com/gajus/global-agent) - **star:351** 可使用环境变量配置的全局HTTP/HTTPS代理代理。
...
- [debug](https://github.com/debug-js/debug) - **star:11028** 微小的调试工具 ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:13501** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:22241** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [consola](https://github.com/unjs/consola) - **star:5760** 控制台记录器。 ![star > 2000][Awesome] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:21553** 终端字符串样式设置 ![star > 2000][Awesome] 
- [meow](https://github.com/sindresorhus/meow) - **star:3513** CLI应用助手 ![star > 2000][Awesome] 
- [yargs](https://github.com/yargs/yargs) - **star:10976** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome] 
- [ora](https://github.com/sindresorhus/ora) - **star:8960** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:26070** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
- [listr2](https://github.com/listr2/listr2) - **star:473** 终端任务列表
...
- [blessed](https://github.com/chjj/blessed) - **star:11182** Curses-like 库 ![star > 2000][Awesome] 
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:19552** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [cfonts](https://github.com/dominikwilkowski/cfonts) - **star:1552** 性感的ASCII字体控制台
...
- [cross-env](https://github.com/kentcdodds/cross-env) - **star:6281** 设置跨平台的环境变量 ![star > 2000][Awesome]  ![项目已归档][Archived] 
...
- [Bit](https://github.com/teambit/bit) - **star:17667** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
- [gradient-string](https://github.com/bokub/gradient-string) - **star:1015** 终端输出中漂亮的颜色渐变
- [oclif](https://github.com/oclif/oclif) - **star:8895** 包含解析器、自动文档、测试和插件的CLI框架 ![star > 2000][Awesome] 
...
- [zx](https://github.com/google/zx) - **star:42171** 编写shell脚本JavaScript。 ![star > 2000][Awesome] 

### 构建工具
*翻译出错了? 试试 [英文版](readme_en.md#Build%20tools) 吧~*

- [parcel](https://github.com/parcel-bundler/parcel) - **star:43231** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome] 
- [webpack](https://github.com/webpack/webpack) - **star:64303** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:24952** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
- [gulp](https://github.com/gulpjs/gulp) - **star:32938** 流式和快速构建系统，更喜欢代码而不是配置 ![star > 2000][Awesome] 
...
- [Vite](https://github.com/vitejs/vite) - **star:65620** 前端构建工具，具有热模块替换和静态资产捆绑。 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:13229** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
...
- [pigpio](https://github.com/fivdi/pigpio) - **star:942** 快速GPIO, PWM，伺服控制，状态变化通知，中断处理对树莓派
...
- [marko](https://github.com/marko-js/marko) - **star:13223** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome] 
...
- [EJS](https://github.com/mde/ejs) - **star:7624** 简单的未绑定模板语言 ![star > 2000][Awesome] 
- [Pug](https://github.com/pugjs/pug) - **star:21562** 高性能模板引擎深受Haml的影响 ![star > 2000][Awesome] 

### Web 框架
*翻译出错了? 试试 [英文版](readme_en.md#Web%20frameworks) 吧~*

- [Fastify](https://github.com/fastify/fastify) - **star:31075** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Next.js](https://github.com/vercel/next.js) - **star:122257** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:52794** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
- [Hapi](https://github.com/hapijs/hapi) - **star:14530** 用于构建应用程序和服务的框架 ![star > 2000][Awesome] 
- [Micro](https://github.com/vercel/micro) - **star:10546** 带有异步方法的最小化微服务框架 ![star > 2000][Awesome] 
- [Koa](https://github.com/koajs/koa) - **star:34954** Express背后的团队设计的框架，其目标是为web应用程序和api提供一个更小、更富表现力和更健壮的基础 ![star > 2000][Awesome] 
- [Express](https://github.com/expressjs/express) - **star:64170** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
- [Feathers](https://github.com/feathersjs/feathers) - **star:14960** 基于Express精神构建的微服务框架 ![star > 2000][Awesome] 
- [LoopBack](https://github.com/loopbackio/loopback-next) - **star:4876** 用于创建REST api和轻松连接到后端数据源的强大框架 ![star > 2000][Awesome] 
- [Meteor](https://github.com/meteor/meteor) - **star:44108** 一个超简单的、无处不在的数据库、在线数据、纯javascript web框架*(你可能会喜欢[awesome-meteor](https://github.com/Urigo/awesome-meteor))* ![star > 2000][Awesome] 
...
- [AdonisJs](https://github.com/adonisjs/core) - **star:16070** 一个真正的Node.js MVC框架，建立在依赖注入和IoC容器的坚实基础上 ![star > 2000][Awesome] 
- [Moleculer](https://github.com/moleculerjs/moleculer) - **star:6060** 快速强大的微服务框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:65232** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
- [TypeGraphQL](https://github.com/MichalLytek/type-graphql) - **star:7969** 基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架 ![star > 2000][Awesome] 
...
- [Ts.ED](https://github.com/tsedio/tsed) - **star:2763** 直观的TypeScript框架，用于在Express.js或Koa.js之上构建服务器端应用。 ![star > 2000][Awesome] 
- [Hono](https://github.com/honojs/hono) - **star:16499** 小而快速的web框架。 ![star > 2000][Awesome] 
...
- [JSDoc](https://github.com/jsdoc/jsdoc) - **star:14853** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome] 
- [Docusaurus](https://github.com/facebook/docusaurus) - **star:53765** 文档网站生成器，利用React和Markdown，并附带翻译和版本控制功能。 ![star > 2000][Awesome] 
...
- [chokidar](https://github.com/paulmillr/chokidar) - **star:10654** 文件系统监视程序，它稳定来自' fs的事件看”和“fs以及在macOS上使用本地的“fsevents” ![star > 2000][Awesome] 
...
- Observables
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:30358** 反应性编程 ![star > 2000][Awesome] 
...
- [µWebSockets](https://github.com/uNetworking/uWebSockets) - **star:16953** 高度可伸缩的WebSocket服务器和客户端库 ![star > 2000][Awesome] 
- [Socket.io](https://github.com/socketio/socket.io) - **star:60435** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
...
- [MQTT.js](https://github.com/mqttjs/MQTT.js) - **star:8398** 基于MQTT的消息传递协议的客户机，用于TCP/IP之上 ![star > 2000][Awesome] 
- [rpc-websockets](https://github.com/elpheria/rpc-websockets) - **star:575** 通过WebSockets实现JSON-RPC 2.0
- [Aedes](https://github.com/moscajs/aedes) - **star:1745** 可以在任何流服务器上运行的Barebone MQTT服务器

### 图像
*翻译出错了? 试试 [英文版](readme_en.md#Image) 吧~*

- [sharp](https://github.com/lovell/sharp) - **star:28261** 用于调整JPEG、PNG、WebP和TIFF图像大小的最快模块 ![star > 2000][Awesome] 
...
- [pica](https://github.com/nodeca/pica) - **star:3673** 高品质和快速调整大小(lanczos3)在纯JS替代画布drawImage()，当不允许像素化时 ![star > 2000][Awesome] 
- [jimp](https://github.com/oliver-moran/jimp) - **star:13574** 图像处理在纯JavaScript ![star > 2000][Awesome] 
- [qrcode](https://github.com/soldair/node-qrcode) - **star:7240** 二维码和条形码发生器 ![star > 2000][Awesome] 
...
- [i18next](https://github.com/i18next/i18next) - **star:7502** 国际化框架 ![star > 2000][Awesome] 
- [nanoid](https://github.com/ai/nanoid) - **star:23751** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome] 
- [StegCloak](https://github.com/kurolabs/stegcloak) - **star:3205** 把秘密隐藏在琴弦中，在众目睽睽之下。 ![star > 2000][Awesome] 
...
- [ndarray](https://github.com/scijs/ndarray) - **star:1197** 多维数组
- [mathjs](https://github.com/josdejong/mathjs) - **star:14160** 一个广泛的数学图书馆 ![star > 2000][Awesome] 
...
- [Luxon](https://github.com/moment/luxon) - **star:14997** 用于处理日期和时间的库 ![star > 2000][Awesome] 
- [date-fns](https://github.com/date-fns/date-fns) - **star:33968** 现代实用程序 ![star > 2000][Awesome] 
- [Day.js](https://github.com/iamkun/dayjs) - **star:46109** 不可变日期库替代Moment.js ![star > 2000][Awesome] 
...
- [joi](https://github.com/sideway/joi) - **star:20699** 对象模式描述语言和JavaScript对象的验证器 ![star > 2000][Awesome] 
...
- [ajv](https://github.com/ajv-validator/ajv) - **star:13499** 最快的JSON模式验证器支持v5、v6和v7提案 ![star > 2000][Awesome] 
- [Superstruct](https://github.com/ianstormtaylor/superstruct) - **star:6870** 在JavaScript(和TypeScript)中验证数据的简单而可组合的方法。 ![star > 2000][Awesome] 
- [yup](https://github.com/jquense/yup) - **star:22415** 对象模式验证。 ![star > 2000][Awesome] 
- [zod](https://github.com/colinhacks/zod) - **star:31328** 带静态类型推断的typescript优先模式验证。 ![star > 2000][Awesome] 

### 解析
*翻译出错了? 试试 [英文版](readme_en.md#Parsing) 吧~*

- [remark](https://github.com/remarkjs/remark) - **star:7334** 插件驱动的降价处理器 ![star > 2000][Awesome] 
- [markdown-it](https://github.com/markdown-it/markdown-it) - **star:17463** Markdown解析器具有100%的公共标记支持、扩展和语法插件 ![star > 2000][Awesome] 
- [parse5](https://github.com/inikulin/parse5) - **star:3580** 快速功能齐全的符合规范的HTML解析器 ![star > 2000][Awesome] 
- [@parcel/css](https://github.com/parcel-bundler/parcel-css) - **star:6056** 一个用Rust编写的CSS解析器、转换器和迷你器。 ![star > 2000][Awesome] 
...
- [js-yaml](https://github.com/nodeca/js-yaml) - **star:6207** 非常快的YAML解析器 ![star > 2000][Awesome] 
...
- [google-libphonenumber](https://github.com/ruimarinho/google-libphonenumber) - **star:1359** 解析、格式化、存储和验证电话号码
...
- [Chevrotain](https://github.com/Chevrotain/chevrotain) - **star:2426** 非常快，功能丰富的JavaScript解析器构建工具包 ![star > 2000][Awesome] 
- [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) - **star:2409** 验证和解析XML ![star > 2000][Awesome] 
...
- [ms](https://github.com/vercel/ms) - **star:5014** 微小的毫秒转换实用程序 ![star > 2000][Awesome] 
...
- [pako](https://github.com/nodeca/pako) - **star:5392** 高速zlib端口到纯js(放气，充气，gzip) ![star > 2000][Awesome] 
...
- [Redis](https://github.com/luin/ioredis) - **star:14019** 复述,客户机 ![star > 2000][Awesome] 
- [LevelUP](https://github.com/Level/levelup) - **star:4075** LevelDB ![star > 2000][Awesome] 
- [MySQL](https://github.com/mysqljs/mysql) - **star:18201** MySQL客户端 ![star > 2000][Awesome] 
...
- [MongoDB](https://github.com/mongodb/node-mongodb-native) - **star:9978** MongoDB的司机 ![star > 2000][Awesome] 
- ODM / ORM
- [Sequelize](https://github.com/sequelize/sequelize) - **star:29192** Multi-dialect ORM。支持PostgreSQL, SQLite, MySQL等。 ![star > 2000][Awesome] 
...
- [slonik](https://github.com/gajus/slonik) - **star:4435** 具有严格类型、详细日志记录和断言的PostgreSQL客户机 ![star > 2000][Awesome] 
- [Objection.js](https://github.com/Vincit/objection.js) - **star:7219** 轻量级ORM构建于SQL查询生成器Knex之上 ![star > 2000][Awesome] 
- [TypeORM](https://github.com/typeorm/typeorm) - **star:33601** ORM用于PostgreSQL、MariaDB、MySQL、SQLite等 ![star > 2000][Awesome] 
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:7306** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Prisma](https://github.com/prisma/prisma) - **star:37854** 现代数据库访问(ORM替代)。在TypeScript中自动生成和类型安全的查询生成器。支持PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- Query builder
- [Knex](https://github.com/knex/knex) - **star:18918** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:13453** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:21074** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
- [Keyv](https://github.com/jaredwray/keyv) - **star:2507** 简单的键值存储，支持多个后端 ![star > 2000][Awesome] 
...
- [Mocha](https://github.com/mochajs/mocha) - **star:22497** 功能丰富的测试框架，使异步测试简单而有趣 ![star > 2000][Awesome] 
...
- [loadtest](https://github.com/alexfernandez/loadtest) - **star:2545** 使用用于自动化的API为web应用程序运行负载测试 ![star > 2000][Awesome] 
- [Sinon.JS](https://github.com/sinonjs/sinon) - **star:9583** 测试间谍，存根和嘲笑 ![star > 2000][Awesome] 
- [navit](https://github.com/nodeca/navit) - **star:48** PhantomJS / SlimerJS包装器，用于简化浏览器测试脚本
- [Nock](https://github.com/nock/nock) - **star:12596** HTTP模拟和期望 ![star > 2000][Awesome] 
...
- [WebdriverIO](https://github.com/webdriverio/webdriverio) - **star:8859** 基于WebDriver协议的自动化测试 ![star > 2000][Awesome] 
- [Jest](https://github.com/facebook/jest) - **star:43761** 无痛的JavaScript测试 ![star > 2000][Awesome] 
...
- [Puppeteer](https://github.com/puppeteer/puppeteer) - **star:87426** Headless Chrome ![star > 2000][Awesome] 
- [Playwright](https://github.com/microsoft/playwright) - **star:63280** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome] 
- [nve](https://github.com/ehmicky/nve) - **star:694** 在Node.js的多个版本上本地运行任何命令。
- [axe-core](https://github.com/dequelabs/axe-core) - **star:5721** 用于自动化Web UI测试的可访问性引擎。 ![star > 2000][Awesome] 
- [testcontainers-node](https://github.com/testcontainers/testcontainers-node) - **star:1756** 提供通用数据库、Selenium web浏览器或任何可以在Docker容器中运行的东西的轻量级、一次性实例。
...
- [rate-limiter-flexible](https://github.com/animir/node-rate-limiter-flexible) - **star:2936** 暴力和DDoS攻击保护 ![star > 2000][Awesome] 
...
- [babel-minify](https://github.com/babel/minify) - **star:4385** 基于Babel工具链的ES2015+感知缩小器 ![star > 2000][Awesome] 
- [UglifyJS2](https://github.com/mishoo/UglifyJS) - **star:12985** JavaScript缩小镜 ![star > 2000][Awesome] 
...
- [Passport](https://github.com/jaredhanson/passport) - **star:22585** 简单、低调的身份验证 ![star > 2000][Awesome] 
...
- [CASL](https://github.com/stalniy/casl) - **star:5697** UI和API的同构授权 ![star > 2000][Awesome] 
...
- [Nodemailer](https://github.com/nodemailer/nodemailer) - **star:16440** 处理电子邮件的最快方式 ![star > 2000][Awesome] 
...
- [MJML](https://github.com/mjmlio/mjml) - **star:16617** 标记语言，旨在减少创建响应电子邮件的痛苦 ![star > 2000][Awesome] 

### 工作队列
*翻译出错了? 试试 [英文版](readme_en.md#Job%20queues) 吧~*

- [bull](https://github.com/OptimalBits/bull) - **star:15192** 持久作业和消息队列 ![star > 2000][Awesome] 
- [agenda](https://github.com/agenda/agenda) - **star:9294** MongoDB-backed工作调度 ![star > 2000][Awesome] 
...
- [bee-queue](https://github.com/bee-queue/bee-queue) - **star:3681** 高性能redis支持的作业队列 ![star > 2000][Awesome] 
...
- [bullmq](https://github.com/taskforcesh/bullmq) - **star:5525** 持久作业和消息队列 ![star > 2000][Awesome] 

### Node.js 管理
*翻译出错了? 试试 [英文版](readme_en.md#Node.js%20management) 吧~*

- [n](https://github.com/tj/n) - **star:18611** Node.js 版本管理 ![star > 2000][Awesome] 
- [nave](https://github.com/isaacs/nave) - **star:1594** Node.js 的虚拟环境
- [nodeenv](https://github.com/ekalinin/nodeenv) - **star:1679** js虚拟环境兼容Python的 virtualenv
- [nvm for Windows](https://github.com/coreybutler/nvm-windows) - **star:35557** Windows 版本管理 ![star > 2000][Awesome] 
- [nodenv](https://github.com/nodenv/nodenv) - **star:2187** 类似于Ruby的rbenv的版本管理器它支持自动版本切换 ![star > 2000][Awesome] 
- [fnm](https://github.com/Schniz/fnm) - **star:16139** 跨平台的Node.js版本管理器内置在Rust中。 ![star > 2000][Awesome] 

### 跨平台的集成
*翻译出错了? 试试 [英文版](readme_en.md#Cross-platform%20integration) 吧~*

- [napi-rs](https://github.com/napi-rs/napi-rs) - **star:5626** 通过Node-API在Rust中构建编译后的Node.js插件的框架。 ![star > 2000][Awesome] 
...
- [DotNetJS](https://github.com/Elringus/DotNetJS) - **star:652** 使用。net互操作性层在Node.js中使用。net库。
...
- [franc](https://github.com/wooorm/franc) - **star:4058** 检测文本的语言 ![star > 2000][Awesome] 
- [leven](https://github.com/sindresorhus/leven) - **star:710** 使用Levenshtein距离算法测量两个字符串之间的差异
- [natural](https://github.com/NaturalNode/natural) - **star:10516** 自然语言工具 ![star > 2000][Awesome] 
- [nlp.js](https://github.com/axa-group/nlp.js) - **star:6130** 构建机器人，具有实体提取、情感分析、自动语言识别等功能 ![star > 2000][Awesome] 

### 流程管理
*翻译出错了? 试试 [英文版](readme_en.md#Process%20management) 吧~*

- [PM2](https://github.com/Unitech/pm2) - **star:40936** 先进的流程管理 ![star > 2000][Awesome] 
- [nodemon](https://github.com/remy/nodemon) - **star:26084** 监视应用程序中的更改并自动重启服务器 ![star > 2000][Awesome] 
...
- [robotjs](https://github.com/octalmage/robotjs) - **star:12181** 桌面自动化:控制鼠标、键盘和阅读屏幕 ![star > 2000][Awesome] 
- [nut.js](https://github.com/nut-tree/nut.js) - **star:2113** 跨平台的本地GUI自动化/测试框架，具有与Jest集成的图像匹配功能。 ![star > 2000][Awesome] 

### AST
*翻译出错了? 试试 [英文版](readme_en.md#AST) 吧~*

- [Acorn](https://github.com/acornjs/acorn) - **star:10303** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome] 
...
- [docsify](https://github.com/docsifyjs/docsify) - **star:26918** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome] 
...
- [KeystoneJS](https://github.com/keystonejs/keystone) - **star:8945** CMS和基于Express和MongoDB的web应用平台 ![star > 2000][Awesome] 
...
- [Strapi](https://github.com/strapi/strapi) - **star:61294** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome] 
- [Factor](https://github.com/FactorJS/factor) - **star:1385** Vue.js仪表板框架和无头CMS。
- [AdminBro](https://github.com/SoftwareBrothers/adminjs) - **star:8020** 所有资源的CRUD自动生成管理面板。 ![star > 2000][Awesome] 
- [Graphweaver](https://github.com/exogee-technology/graphweaver) - **star:450** CMS和无头GraphQL API。

### 论坛
*翻译出错了? 试试 [英文版](readme_en.md#Forum) 吧~*

- [nodeBB](https://github.com/NodeBB/NodeBB) - **star:13987** 现代网络论坛平台 ![star > 2000][Awesome] 

### 写博客
*翻译出错了? 试试 [英文版](readme_en.md#Blogging) 吧~*

- [Ghost](https://github.com/TryGhost/Ghost) - **star:46096** 简单、强大的发布平台 ![star > 2000][Awesome] 
- [Hexo](https://github.com/hexojs/hexo) - **star:38750** 快速，简单和强大的博客框架 ![star > 2000][Awesome] 
...
- [protobuf](https://github.com/protobufjs/protobuf.js) - **star:9704** 协议缓冲区的实现 ![star > 2000][Awesome] 
- [compactr](https://github.com/compactr/compactr.js) - **star:101** 实现Compactr协议

### 杂项
*翻译出错了? 试试 [英文版](readme_en.md#Miscellaneous) 吧~*

- [execa](https://github.com/sindresorhus/execa) - **star:6588** 更好的“child_process” ![star > 2000][Awesome] 
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:27975** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome] 
- [open](https://github.com/sindresorhus/open) - **star:3132** 打开网站、文件、可执行文件等 ![star > 2000][Awesome] 
...
- [file-type](https://github.com/sindresorhus/file-type) - **star:3503** 检测缓冲区的文件类型 ![star > 2000][Awesome] 
- [Bottleneck](https://github.com/SGrondin/bottleneck) - **star:1769** 使节流容易的速率限制器
...
- [dotenv](https://github.com/motdotla/dotenv) - **star:18650** 从.env文件中加载环境变量 ![star > 2000][Awesome] 
- [semver](https://github.com/npm/node-semver) - **star:4996** 语义版本解析器 ![star > 2000][Awesome] 
...
- [jsdom](https://github.com/jsdom/jsdom) - **star:20125** JavaScript实现的HTML和DOM ![star > 2000][Awesome] 
...
- [husky](https://github.com/typicode/husky) - **star:31835** 创建Git钩子脚本。 ![star > 2000][Awesome] 
- [patch-package](https://github.com/ds300/patch-package) - **star:10089** 修复并保留npm依赖。 ![star > 2000][Awesome] 
- [editly](https://github.com/mifi/editly) - **star:4613** 声明式视频编辑API。 ![star > 2000][Awesome] 
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - **star:97010** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome] 
...
- [Amplication](https://github.com/amplication/amplication) - **star:13585** 自动生成功能齐全的应用程序。 ![star > 2000][Awesome] 
...
- [node-module-boilerplate](https://github.com/sindresorhus/node-module-boilerplate) - **star:724** 开始创建节点模块的样板文件
...
- [awesome-npm](https://github.com/sindresorhus/awesome-npm) - **star:4421** 使用npm的资源和技巧 ![star > 2000][Awesome] 
- [awesome-cross-platform-nodejs](https://github.com/bcoe/awesome-cross-platform-nodejs) - **star:1130** 用于编写和测试跨平台代码的资源
