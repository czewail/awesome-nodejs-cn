...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2020-03-26 18:03:17）**
...
- [webtorrent](https://github.com/feross/webtorrent) - **star:21520** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [peerflix](https://github.com/mafintosh/peerflix) - **star:5382** 流式 Torrent 客户端 ![star > 2000][Awesome] 
- [dat](https://github.com/datproject/dat-node) - **star:492** 数据集的实时复制和版本控制 ![最近一周有更新][Green] 
- [ipfs](https://github.com/ipfs/js-ipfs) - **star:4291** 分布式文件系统，用于将所有计算设备与同一文件系统连接起来 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [stackgl](https://github.com/stackgl) - 基于 browserify 和 npm 的 WebGL 开放软件生态系统
- [peerwiki](https://github.com/mafintosh/peerwiki) - **star:298** 建立在在 BitTorrent 上的维基百科 ![最近一年没有更新][Yellow] 
- [peercast](https://github.com/mafintosh/peercast) - **star:450** 将种子视频流式传输到 Chromecast ![最近一年没有更新][Yellow] 
- [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) - **star:3800** 干净、可读比特币库 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Bitcore](https://github.com/bitpay/bitcore) - **star:3571** 纯净、强大的比特币库 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [PDFKit](https://github.com/devongovett/pdfkit) - **star:6006** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:5106** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [webcat](https://github.com/mafintosh/webcat) - **star:403** 使用 WebRTC 跨 web 的 p2p 管道，它使用 GitHub 私有/公共密钥进行身份验证 ![最近一年没有更新][Yellow] 
- [NodeOS](https://github.com/NodeOS/NodeOS) - **star:6168** 第一个由 npm 驱动的操作系统 ![star > 2000][Awesome] 
...
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:6469** 图论(又称网络)建模与分析 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Kadence](https://gitlab.com/deadcanaries/kadence) - Kademlia 分布式哈希表
- [seedshot](https://github.com/twobucks/seedshot) - **star:178** 从浏览器共享临时 P2P 截图 ![最近一年没有更新][Yellow]  ![项目已归档][Archived] 
...
- [xlsx](https://github.com/sheetjs/js-xlsx) - **star:20300** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [isomorphic-git](https://github.com/isomorphic-git/isomorphic-git) - **star:4619** 纯 JavaScript 实现的 Git ![star > 2000][Awesome]  ![最近一周有更新][Green] 

### 命令行程序
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20apps) 吧~*

- [np](https://github.com/sindresorhus/np) - **star:5065** 更好的 'npm publish' ![star > 2000][Awesome] 
...
- [pageres](https://github.com/sindresorhus/pageres) - **star:8983** 捕获网站截图 ![star > 2000][Awesome] 
- [cpy](https://github.com/sindresorhus/cpy) - **star:260** 复制文件
- [vtop](https://github.com/MrRio/vtop) - **star:3538** 带图表的 top 命令 ![star > 2000][Awesome] 
...
- [is-online](https://github.com/sindresorhus/is-online) - **star:821** 检查网络连接是否正常 ![最近一周有更新][Green] 
- [public-ip](https://github.com/sindresorhus/public-ip) - **star:543** 获取你的公共IP地址 ![最近一周有更新][Green] 
- [clipboard-cli](https://github.com/sindresorhus/clipboard-cli) - **star:352** 在终端上复制粘贴
- [XO](https://github.com/xojs/xo) - **star:4984** 使用 Javascript happiness style 进行严格编码 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Standard](https://github.com/feross/standard) - **star:23407** Javascript 标准风格 - 一种风格规范 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [ESLint](https://github.com/eslint/eslint) - **star:16062** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [dev-time](https://github.com/samverschueren/dev-time-cli) - **star:168** 获取 GitHub 用户当前的本地时间 ![最近一年没有更新][Yellow] 
- [David](https://github.com/alanshaw/david) - **star:916** 告诉你包的 npm 依赖项何时过期
- [http-server](https://github.com/indexzero/http-server) - **star:9275** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Live Server](https://github.com/tapio/live-server) - **star:3090** 具有热重载功能的 HTTP-server ![star > 2000][Awesome] 
- [bcat](https://github.com/kessler/node-bcat) - **star:299** 管道命令输出到 web 浏览器
- [normit](https://github.com/pawurb/normit) - **star:206** 谷歌翻译与语音合成的终端工具 ![最近一年没有更新][Yellow] 
- [fkill](https://github.com/sindresorhus/fkill-cli) - **star:6055** 跨平台的进程杀死工具 ![star > 2000][Awesome] 
- [pjs](https://github.com/danielstjules/pjs) - **star:373** Pipeable JavaScript从终端快速筛选、映射和缩减 ![最近一年没有更新][Yellow] 
...
- [tmpin](https://github.com/sindresorhus/tmpin) - **star:112** 将stdin支持添加到任何接受文件输入的CLI应用程序 ![最近一年没有更新][Yellow] 
- [wifi-password](https://github.com/kevva/wifi-password-cli) - **star:212** 获取当前wifi密码 ![最近一年没有更新][Yellow] 
- [wallpaper](https://github.com/sindresorhus/wallpaper) - **star:685** 更换桌面壁纸
- [brightness](https://github.com/kevva/brightness-cli) - **star:171** 改变屏幕亮度 ![最近一年没有更新][Yellow] 
...
- [alex](https://github.com/wooorm/alex) - **star:3435** 捕获不敏感、不体谅他人的编写 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [pen](https://github.com/noraesae/pen) - **star:300** 从喜爱的编辑器在浏览器中实时预览 Markdown
- [subdownloader](https://github.com/beatfreaker/subdownloader) - **star:125** 电影和电视剧的字幕下载程序 ![最近一年没有更新][Yellow] 
- [dark-mode](https://github.com/sindresorhus/dark-mode) - **star:476** 切换 macOS 黑暗模式
- [iponmap](https://github.com/nogizhopaboroda/iponmap) - **star:234** IP 定位程序 ![最近一年没有更新][Yellow] 
- [Jsome](https://github.com/Javascipt/Jsome) - **star:169** 漂亮的打印json，带有可配置的颜色和缩进
- [itunes-remote](https://github.com/mischah/itunes-remote) - **star:392** 可交互的方式控制 iTunes ![最近一年没有更新][Yellow] 
- [mobicon](https://github.com/samverschueren/mobicon-cli) - **star:77** 移动应用图标生成器
- [mobisplash](https://github.com/samverschueren/mobisplash-cli) - **star:43** 移动应用程序启动屏幕生成器 ![最近一年没有更新][Yellow] 
...
- [trymodule](https://github.com/VictorBjelkholm/trymodule) - **star:1110** 在终端试用npm包 ![最近一年没有更新][Yellow] 
- [jscpd](https://github.com/kucherenko/jscpd) - **star:1574** 源代码的复制/粘贴检测器 ![最近一周有更新][Green] 
- [atmo](https://github.com/Raathigesh/Atmo) - **star:790** 服务器端 api 模拟工具 ![最近一年没有更新][Yellow] 
- [auto-install](https://github.com/siddharthkp/auto-install) - **star:1067** 在编写代码时自动安装依赖项 ![最近一周有更新][Green] 
...
- [cash-cli](https://github.com/xxczaki/cash-cli) - **star:137** 转换170种货币 ![最近一周有更新][Green] 
- [taskbook](https://github.com/klauscfhq/taskbook) - **star:7496** 命令行栖息地的任务、板子和注释 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [discharge](https://github.com/brandonweiss/discharge) - **star:431** 轻松地将静态站点部署到Amazon S3 ![最近一周有更新][Green] 
- [npkill](https://github.com/voidcosmos/npkill) - **star:2607** 轻松找到并删除旧的和沉重的node_modules文件夹 ![star > 2000][Awesome] 

### 函数式编程
*翻译出错了? 试试 [英文版](readme_en.md#Functional%20programming) 吧~*

- [lodash](https://github.com/lodash/lodash) - **star:44000** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [immutable](https://github.com/facebook/immutable-js) - **star:29380** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:18469** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [RxJS](https://github.com/reactivex/rxjs) - **star:21415** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [got](https://github.com/sindresorhus/got) - **star:7037** 更好的内置“http”模块接口 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [gh-got](https://github.com/sindresorhus/gh-got) - **star:147** “got”与github api交互的简单封装
- [axios](https://github.com/mzabriskie/axios) - **star:71017** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [wreck](https://github.com/hapijs/wreck) - **star:373** HTTP客户端工具
- [download](https://github.com/kevva/download) - **star:954** 轻松下载和解压文件
- [http-proxy](https://github.com/nodejitsu/node-http-proxy) - **star:11014** HTTP代理 ![star > 2000][Awesome] 
- [superagent](https://github.com/visionmedia/superagent) - **star:14964** HTTP请求库 ![star > 2000][Awesome] 
- [node-fetch](https://github.com/bitinn/node-fetch) - **star:4777** node.js 版的 `window.fetch` ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [flashheart](https://github.com/bbc/flashheart) - **star:110** REST 客户端
- [http-fake-backend](https://github.com/micromata/http-fake-backend) - **star:225** 通过可配置路由提供JSON文件或JavaScript对象的内容，构建一个伪后端 ![最近一年没有更新][Yellow] 
...
- [ndb](https://github.com/GoogleChromeLabs/ndb) - **star:9907** 通过chrome devtools改进了调试体验 ![star > 2000][Awesome] 
- [ironNode](https://github.com/s-a/iron-node) - **star:2369** 开箱即用的js调试器，支持ES2015 ![star > 2000][Awesome] 
- [node-inspector](https://github.com/node-inspector/node-inspector) - **star:12494** 基于Blink开发工具的调试器 ![star > 2000][Awesome]  ![最近一年没有更新][Yellow] 
- [debug](https://github.com/visionmedia/debug) - **star:8581** 微小的调试工具 ![star > 2000][Awesome] 
...
- [vstream](https://github.com/joyent/node-vstream) - **star:57** 用于检测管道流 ![最近一年没有更新][Yellow] 
...
- [0x](https://github.com/davidmarkclements/0x) - **star:1780** 火焰图分析 ![最近一周有更新][Green] 
...
- [llnode](https://github.com/nodejs/llnode) - **star:825** 后期分析工具，允许检查对象，并从崩溃的Node.js进程中获取细节 ![最近一周有更新][Green] 
...
- [NiM](https://github.com/june07/nim) - **star:153** 管理DevTools调试工作流程。 ![最近一周有更新][Green] 

### 日志
*翻译出错了? 试试 [英文版](readme_en.md#Logging) 吧~*

- [pino](https://github.com/pinojs/pino) - **star:5196** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [winston](https://github.com/winstonjs/winston) - **star:15072** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [signale](https://github.com/klauscfhq/signale) - **star:8059** 控制台记录器。 ![star > 2000][Awesome] 
- [consola](https://github.com/nuxt/consola) - **star:2754** 控制台记录器。 ![star > 2000][Awesome]  ![最近一周有更新][Green] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:14144** 终端字符串样式设置 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [meow](https://github.com/sindresorhus/meow) - **star:2102** CLI应用助手 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [yargs](https://github.com/yargs/yargs) - **star:7441** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [ora](https://github.com/sindresorhus/ora) - **star:5750** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [terminal-image](https://github.com/sindresorhus/terminal-image) - **star:482** 在终端显示图像 ![最近一周有更新][Green] 
...
- [blessed](https://github.com/chjj/blessed) - **star:9084** Curses-like 库 ![star > 2000][Awesome] 
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:12151** 交互式命令行提示符 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [yn](https://github.com/sindresorhus/yn) - **star:185** 解析yes/no 类似的值
- [cli-table3](https://github.com/cli-table/cli-table3) - **star:139** 漂亮的unicode表 ![最近一周有更新][Green] 
...
- [ascii-charts](https://github.com/jstrace/chart) - **star:224** 终端中的ASCII条形图 ![最近一年没有更新][Yellow] 
- [progress](https://github.com/tj/node-progress) - **star:2389** 灵活的ascii进度条 ![star > 2000][Awesome] 
...
- [cross-env](https://github.com/kentcdodds/cross-env) - **star:4592** 设置跨平台的环境变量 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [shelljs](https://github.com/shelljs/shelljs) - **star:10855** 可移植的Unix shell命令 ![star > 2000][Awesome] 
...
- [Bit](https://github.com/teambit/bit) - **star:10519** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [gradient-string](https://github.com/bokub/gradient-string) - **star:410** 终端输出中漂亮的颜色渐变 ![最近一年没有更新][Yellow] 
- [oclif](https://github.com/oclif/oclif) - **star:4681** 包含解析器、自动文档、测试和插件的CLI框架 ![star > 2000][Awesome] 
...
- [parcel](https://github.com/parcel-bundler/parcel) - **star:35197** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [webpack](https://github.com/webpack/webpack) - **star:53454** 为浏览器打包模块和资源 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [rollup](https://github.com/rollup/rollup) - **star:17816** 下一代ES2015模块打包工具 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [gulp](https://github.com/gulpjs/gulp) - **star:31672** 流式和快速构建系统，更喜欢代码而不是配置 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [ygor](https://github.com/shannonmoeller/ygor) - **star:69** 当“npm运行”是不够的，其他的都太多的时候，有前途的任务运行器 ![最近一年没有更新][Yellow] 
- [FuseBox](https://github.com/fuse-box/fuse-box) - **star:3955** 快速构建系统，结合了webpack、JSPM和SystemJS的强大功能，并提供一流的TypeScript支持 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [pkg](https://github.com/zeit/pkg) - **star:15492** 将Node.js项目打包成可执行文件 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:11372** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
- [serialport](https://github.com/voodootikigod/node-serialport) - **star:4326** 访问串行端口进行读写 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [marko](https://github.com/marko-js/marko) - **star:9446** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [Hapi](https://github.com/hapijs/hapi) - **star:12217** 用于构建应用程序和服务的框架 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Koa](https://github.com/koajs/koa) - **star:28751** Express背后的团队设计的框架，其目标是为web应用程序和api提供一个更小、更富表现力和更健壮的基础 ![star > 2000][Awesome] 
- [Express](https://github.com/expressjs/express) - **star:47847** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Feathers](https://github.com/feathersjs/feathers) - **star:12263** 基于Express精神构建的微服务框架 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [LoopBack](https://github.com/strongloop/loopback) - **star:13080** 用于创建REST api和轻松连接到后端数据源的强大框架 ![star > 2000][Awesome] 
- [Meteor](https://github.com/meteor/meteor) - **star:41674** 一个超简单的、无处不在的数据库、在线数据、纯javascript web框架*(你可能会喜欢[awesome-meteor](https://github.com/Urigo/awesome-meteor))* ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Restify](https://github.com/restify/node-restify) - **star:9713** 使您能够构建正确的REST web服务 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [ThinkJS](https://github.com/thinkjs/thinkjs) - **star:5082** 框架与ES2015+支持，WebSockets, REST API ![star > 2000][Awesome] 
- [ActionHero](https://github.com/actionhero/actionhero) - **star:2080** 为TCP套接字、WebSockets和HTTP客户机创建可重用和可伸缩api的框架 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Next.js](https://github.com/zeit/next.js) - **star:46223** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:26113** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [seneca](https://github.com/senecajs/seneca) - **star:3642** 编写微服务的工具包 ![star > 2000][Awesome] 
...
- [Micro](https://github.com/zeit/micro) - **star:9164** 带有异步方法的最小化微服务框架 ![star > 2000][Awesome] 
- [Moleculer](https://moleculer.services) - 快速强大的微服务框架
- [Fastify](https://github.com/fastify/fastify) - **star:13914** 高速、地开销的 Web 框架 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Nest](https://github.com/nestjs/nest) - **star:25405** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Zeronode](https://github.com/sfast/zeronode) - **star:105** 可靠和容错的微服务的最小构建块
- [TypeGraphQL](https://github.com/19majkel94/type-graphql) - **star:4004** 基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架 ![star > 2000][Awesome]  ![最近一周有更新][Green] 

### 文档
*翻译出错了? 试试 [英文版](readme_en.md#Documentation) 吧~*

- [documentation.js](https://github.com/documentationjs/documentation) - **star:4983** 支持ES2015+和 flow 注释的 API 文档生成器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [ESDoc](https://github.com/esdoc/esdoc) - **star:2572** 以ES2015为目标的文档生成器，附加测试代码并测量文档覆盖率 ![star > 2000][Awesome] 
- [Docco](https://github.com/jashkenas/docco) - **star:3424** 文档生成器，它生成HTML文档，显示与代码混合的注释 ![star > 2000][Awesome] 
- [JSDoc](https://github.com/jsdoc3/jsdoc) - **star:10460** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [lnfs](https://github.com/kevva/lnfs) - **star:10** 强制创建符号链接，如' ln -fs ' ![最近一年没有更新][Yellow] 
...
- [fs-extra](https://github.com/jprichardson/node-fs-extra) - **star:6689** ' fs '模块的额外方法 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- Promises
- [Bluebird](https://github.com/petkaantonov/bluebird) - **star:18992** 承诺库专注于创新功能和性能 ![star > 2000][Awesome] 
...
- [promise-memoize](https://github.com/nodeca/promise-memoize) - **star:44** 使用过期和预取来记忆承诺返回函数 ![最近一年没有更新][Yellow] 
...
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:21415** 反应性编程 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- Callbacks
- [each-async](https://github.com/sindresorhus/each-async) - **star:107** 异步并发迭代器，如forEach ![最近一年没有更新][Yellow] 
- [async](https://github.com/caolan/async) - **star:26422** 为处理异步性提供了直接、强大的函数 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- Channels
- [js-csp](https://github.com/ubolonton/js-csp) - **star:2265** 为JavaScript通信顺序进程(如Clojurescript core)异步,或者去) ![star > 2000][Awesome] 
...
- [peek-stream](https://github.com/mafintosh/peek-stream) - **star:45** 转换流，它允许您在决定如何解析第一行之前先查看第一行 ![最近一年没有更新][Yellow] 
- [binary-split](https://github.com/maxogden/binary-split) - **star:72** 换行(或任何分隔符)拆分器流 ![最近一年没有更新][Yellow] 
...
- [pad-stream](https://github.com/sindresorhus/pad-stream) - **star:5** 将每一行填充到一个流中 ![最近一年没有更新][Yellow] 
- [multistream](https://github.com/feross/multistream) - **star:206** 将多个流合并到一个流中
- [stream-combiner2](https://github.com/substack/stream-combiner2) - **star:74** 将管道转换为单个流 ![最近一年没有更新][Yellow] 
...
- [µWebSockets](https://github.com/uWebSockets/uWebSockets) - **star:11344** 高度可伸缩的WebSocket服务器和客户端库 ![star > 2000][Awesome] 
- [Socket.io](https://github.com/socketio/socket.io) - **star:49068** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
...
- [Primus](https://github.com/primus/primus) - **star:4081** 实时框架的抽象层，以防止模块锁定 ![star > 2000][Awesome] 
...
- [MQTT.js](https://github.com/mqttjs/MQTT.js) - **star:5287** 基于MQTT的消息传递协议的客户机，用于TCP/IP之上 ![star > 2000][Awesome] 
...
- [pica](https://github.com/nodeca/pica) - **star:1929** 高品质和快速调整大小(lanczos3)在纯JS替代画布drawImage()，当不允许像素化时 ![最近一周有更新][Green] 
- [jimp](https://github.com/oliver-moran/jimp) - **star:9857** 图像处理在纯JavaScript ![star > 2000][Awesome] 
- [probe-image-size](https://github.com/nodeca/probe-image-size) - **star:333** 获得大多数图像格式的大小，而不完全下载
- [qrcode](https://github.com/soldair/node-qrcode) - **star:3854** 二维码和条形码发生器 ![star > 2000][Awesome] 
...
- [splice-string](https://github.com/sindresorhus/splice-string) - **star:14** 删除或替换字符串的一部分，如' Array#splice ' ![最近一年没有更新][Yellow] 
...
- [he](https://github.com/mathiasbynens/he) - **star:2429** HTML实体编码器/解码器 ![star > 2000][Awesome]  ![最近一年没有更新][Yellow] 
- [i18n-node](https://github.com/mashpie/i18n-node) - **star:2536** 简单的翻译模块与动态JSON存储 ![star > 2000][Awesome] 
- [babelfish](https://github.com/nodeca/babelfish) - **star:211** i18n非常简单的复数语法 ![最近一年没有更新][Yellow] 
...
- [i18next](https://github.com/i18next/i18next) - **star:4813** 国际化框架 ![star > 2000][Awesome] 
- [nanoid](https://github.com/ai/nanoid) - **star:8682** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [mathjs](https://github.com/josdejong/mathjs) - **star:9622** 一个广泛的数学图书馆 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [math-clamp](https://github.com/sindresorhus/math-clamp) - **star:6** 夹一个数字 ![最近一年没有更新][Yellow] 
...
- [Luxon](https://github.com/moment/luxon) - **star:9140** 用于处理日期和时间的库 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [date-fns](https://github.com/date-fns/date-fns) - **star:21760** 现代实用程序 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Moment.js](http://momentjs.com) - 解析、验证、操作和显示日期
- [Day.js](https://github.com/iamkun/dayjs) - **star:26425** 不可变日期库替代Moment.js ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [dateformat](https://github.com/felixge/node-dateformat) - **star:1055** 日期格式
- [tz-format](https://github.com/samverschueren/tz-format) - **star:7** 使用时区设置日期:“2015-11-30T10:40:35+01:00” ![最近一年没有更新][Yellow] 
- [cctz](https://github.com/floatdrop/node-cctz) - **star:54** 用于日期的快速解析、格式化和时区对话 ![最近一年没有更新][Yellow] 
...
- [url-unshort](https://github.com/nodeca/url-unshort) - **star:42** 扩大缩短url ![最近一年没有更新][Yellow] 
- [speakingurl](https://github.com/pid/speakingurl) - **star:1025** 从具有音译的字符串生成段塞 ![最近一年没有更新][Yellow] 
...
- [ajv](https://github.com/epoberezkin/ajv) - **star:7121** 最快的JSON模式验证器支持v5、v6和v7提案 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [PostCSS](https://github.com/postcss/postcss) - **star:22335** CSS解析器/ stringifier ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [JSONStream](https://github.com/dominictarr/JSONStream) - **star:1716** 流JSON解析函数,把 ![最近一年没有更新][Yellow]  ![项目已归档][Archived] 
...
- [nearley](https://github.com/Hardmath123/nearley) - **star:2403** 简单、快速、强大的JavaScript解析 ![star > 2000][Awesome] 
- [binary-extract](https://github.com/juliangruber/binary-extract) - **star:146** 从JSON缓冲区中提取一个值，而不需要解析整个内容 ![最近一年没有更新][Yellow] 
- [Stylecow](https://github.com/stylecow/stylecow) - **star:138** 解析、操作和转换现代CSS，使其与所有浏览器兼容可扩展的插件
- [js-yaml](https://github.com/nodeca/js-yaml) - **star:4389** 非常快的YAML解析器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [xml2js](https://github.com/Leonidas-from-XIV/node-xml2js) - **star:3932** XML到JavaScript对象转换器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Jison](https://github.com/zaach/jison) - **star:3636** 友好的JavaScript解析器生成器它与野牛、Yacc和家族有共同的基因 ![star > 2000][Awesome]  ![最近一年没有更新][Yellow] 
...
- [Chevrotain](https://github.com/SAP/chevrotain) - **star:1297** 非常快，功能丰富的JavaScript解析器构建工具包 ![最近一周有更新][Green] 
...
- [ms](https://github.com/rauchg/ms.js) - **star:2726** 微小的毫秒转换实用程序 ![star > 2000][Awesome] 
- [pretty-error](https://github.com/AriaMinaei/pretty-error) - **star:1312** 错误和更少的混乱
- [read-art](https://github.com/Tjatse/node-readability) - **star:296** 从任何页面中提取可读内容 ![最近一年没有更新][Yellow] 
...
- [MongoDB](https://github.com/mongodb/node-mongodb-native) - **star:8472** MongoDB的司机 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- ODM / ORM
- [Sequelize](https://github.com/sequelize/sequelize) - **star:21410** Multi-dialect ORM支持PostgreSQL, SQLite, MySQL ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Bookshelf](https://github.com/bookshelf/bookshelf) - **star:5824** ORM用于PostgreSQL、MySQL和SQLite3，风格为Backbone.js ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Massive](https://github.com/robconery/massive-js) - **star:2547** PostgreSQL数据访问工具 ![star > 2000][Awesome]  ![最近一年没有更新][Yellow]  ![项目已归档][Archived] 
...
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:728** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![最近一周有更新][Green] 
- Query builder
- [Knex](https://github.com/tgriesser/knex) - **star:11730** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:11139** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:12604** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
...
- [Mongo Seeding](https://github.com/pkosiec/mongo-seeding) - **star:224** 用JavaScript和JSON文件填充MongoDB数据库 ![最近一周有更新][Green] 
...
- [loadtest](https://github.com/alexfernandez/loadtest) - **star:1832** 使用用于自动化的API为web应用程序运行负载测试 ![最近一周有更新][Green] 
- [Sinon.JS](https://github.com/sinonjs/sinon) - **star:7860** 测试间谍，存根和嘲笑 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [navit](https://github.com/nodeca/navit) - **star:45** PhantomJS / SlimerJS包装器，用于简化浏览器测试脚本 ![最近一周有更新][Green] 
- [Nock](https://github.com/pgte/nock) - **star:9280** HTTP模拟和期望 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [intern](https://github.com/theintern/intern) - **star:4196** 代码测试堆栈 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [Nightwatch](https://github.com/nightwatchjs/nightwatch) - **star:10101** 基于Selenium WebDriver的自动化UI测试框架 ![star > 2000][Awesome] 
- [WebdriverIO](https://github.com/webdriverio/webdriverio) - **star:5564** 基于WebDriver协议的自动化测试 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Jest](https://github.com/facebook/jest) - **star:30178** 无痛的JavaScript测试 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [TestCafe](https://github.com/DevExpress/testcafe) - **star:7962** 浏览器自动化测试 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [abstruse](https://github.com/bleenco/abstruse) - **star:573** 持续集成服务器 ![最近一周有更新][Green] 
- [CodeceptJS](https://github.com/Codeception/CodeceptJS) - **star:2713** 端到端测试 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Puppeteer](https://github.com/GoogleChrome/puppeteer) - **star:59645** Headless Chrome ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Playwright](https://github.com/microsoft/playwright) - **star:10749** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [nve](https://github.com/ehmicky/nve) - **star:498** 在Node.js的多个版本上本地运行任何命令。 ![最近一周有更新][Green] 

### 安全
*翻译出错了? 试试 [英文版](readme_en.md#Security) 吧~*

- [upash](https://github.com/simonepri/upash) - **star:460** 统一的API为所有密码哈希算法 ![最近一年没有更新][Yellow] 
- [themis](https://github.com/cossacklabs/themis) - **star:972** 使典型加密方案易于使用的多语言框架:静态数据、经过身份验证的数据交换、传输保护、身份验证等等 ![最近一周有更新][Green] 
...
- [jose-simple](https://github.com/davesag/jose-simple) - **star:28** 使用JOSE (JSON对象签名和加密)标准对数据进行加密和解密。 ![最近一周有更新][Green] 
...
- [babili](https://github.com/babel/babili) - **star:4045** 基于Babel工具链的ES2015+感知缩小器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [UglifyJS2](https://github.com/mishoo/UglifyJS2) - **star:10624** JavaScript缩小镜 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [imagemin](https://github.com/imagemin/imagemin) - **star:3834** 图像缩小镜 ![star > 2000][Awesome] 

### 身份验证
*翻译出错了? 试试 [英文版](readme_en.md#Authentication) 吧~*

- [Passport](https://github.com/jaredhanson/passport) - **star:17127** 简单、低调的身份验证 ![star > 2000][Awesome] 
- [Grant](https://github.com/simov/grant) - **star:2639** 用于Express、Koa和Hapi的OAuth中间件 ![star > 2000][Awesome] 

### 授权
*翻译出错了? 试试 [英文版](readme_en.md#Authorization) 吧~*

- [CASL](https://github.com/stalniy/casl) - **star:1867** UI和API的同构授权 ![最近一周有更新][Green] 
...
- [sqs-consumer](https://github.com/bbc/sqs-consumer) - **star:807** 构建基于Amazon Simple Queue Service (SQS)的应用程序，不使用样板 ![最近一周有更新][Green] 
...
- [PM2](https://github.com/Unitech/pm2) - **star:31959** 先进的流程管理 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [nodemon](https://github.com/remy/nodemon) - **star:20233** 监视应用程序中的更改并自动重启服务器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [Phusion Passenger](https://github.com/phusion/passenger) - **star:4567** 友好的过程管理器，直接集成到Nginx ![star > 2000][Awesome]  ![最近一周有更新][Green] 

### 自动化
*翻译出错了? 试试 [英文版](readme_en.md#Automation) 吧~*

- [robotjs](https://github.com/octalmage/robotjs) - **star:8697** 桌面自动化:控制鼠标、键盘和阅读屏幕 ![star > 2000][Awesome] 

### AST
*翻译出错了? 试试 [英文版](readme_en.md#AST) 吧~*

- [Acorn](https://github.com/ternjs/acorn) - **star:5828** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [DocPad](https://github.com/docpad/docpad) - **star:3006** 静态站点生成器具有强大的动态功能和强大的插件生态系统 ![star > 2000][Awesome] 
- [Phenomic](https://github.com/phenomic/phenomic) - **star:3323** 基于React和Webpack生态系统的现代静态网站生成器 ![star > 2000][Awesome] 
- [docsify](https://github.com/QingWei-Li/docsify) - **star:12846** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Charge](https://github.com/brandonweiss/charge) - **star:276** 使用JSX和MDX的固执己见的零配置静态站点生成器 ![最近一周有更新][Green] 

### 内容管理系统
*翻译出错了? 试试 [英文版](readme_en.md#Content%20management%20systems) 吧~*

- [KeystoneJS](https://github.com/keystonejs/keystone) - **star:1792** CMS和基于Express和MongoDB的web应用平台 ![最近一周有更新][Green] 
- [ApostropheCMS](https://github.com/apostrophecms/apostrophe) - **star:3073** 内容管理系统，强调直观的前端内容编辑和管理建立在Express和MongoDB上 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Strapi](https://github.com/strapi/strapi) - **star:22919** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [nodeBB](https://github.com/NodeBB/NodeBB) - **star:10896** 现代网络论坛平台 ![star > 2000][Awesome]  ![最近一周有更新][Green] 

### 写博客
*翻译出错了? 试试 [英文版](readme_en.md#Blogging) 吧~*

- [Ghost](https://github.com/TryGhost/Ghost) - **star:33052** 简单、强大的发布平台 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Hexo](https://github.com/hexojs/hexo) - **star:29921** 快速，简单和强大的博客框架 ![star > 2000][Awesome]  ![最近一周有更新][Green] 

### 奇怪的
*翻译出错了? 试试 [英文版](readme_en.md#Weird) 吧~*

- [cows](https://github.com/sindresorhus/cows) - **star:339** ASCII奶牛 ![最近一年没有更新][Yellow] 
...
- [cool-ascii-faces](https://github.com/maxogden/cool-ascii-faces) - **star:1715** 得到一些很酷的ascii面 ![最近一年没有更新][Yellow] 
- [cat-ascii-faces](https://github.com/melaniecebula/cat-ascii-faces) - **star:219** “₍˄·͈༝·͈˄₎◞̑̑ෆ⃛(=ↀωↀ=)✧(^･o･^)ﾉ” ![最近一年没有更新][Yellow] 
- [nerds](https://github.com/SkyHacks/nerds) - **star:87** 从《哈利波特》、《星球大战》和《精灵宝可梦》等书呆子题材中获取数据 ![最近一年没有更新][Yellow] 

### 序列化
*翻译出错了? 试试 [英文版](readme_en.md#Serialization) 吧~*

- [snappy](https://github.com/kesla/node-snappy) - **star:420** 用于谷歌的快速压缩库的本机绑定
- [protobuf](https://github.com/dcodeIO/protobuf.js) - **star:6523** 协议缓冲区的实现 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [compactr](https://github.com/compactr/compactr.js) - **star:82** 实现Compactr协议

### 杂项
*翻译出错了? 试试 [英文版](readme_en.md#Miscellaneous) 吧~*

- [execa](https://github.com/sindresorhus/execa) - **star:3043** 更好的“child_process” ![star > 2000][Awesome] 
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:21561** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [Electron](https://github.com/atom/electron) - **star:81489** 使用web技术构建跨平台的桌面应用程序*(你可能会喜欢[awesome-electron](https://github.com/sindresorhus/awesome-electron))* ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [os-locale](https://github.com/sindresorhus/os-locale) - **star:156** 获取系统区域设置 ![最近一周有更新][Green] 
- [ssh2](https://github.com/mscdex/ssh2) - **star:3961** SSH2客户端和服务器模块 ![star > 2000][Awesome] 
- [adit](https://github.com/markelog/adit) - **star:30** SSH隧道简化 ![最近一年没有更新][Yellow] 
...
- [jsdom](https://github.com/tmpvar/jsdom) - **star:13786** JavaScript实现的HTML和DOM ![star > 2000][Awesome]  ![最近一周有更新][Green] 
- [hypernova](https://github.com/airbnb/hypernova) - **star:5485** 服务器端呈现JavaScript视图 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [emittery](https://github.com/sindresorhus/emittery) - **star:1024** 简单而现代的异步事件发射器 ![最近一周有更新][Green] 
- [node-video-lib](https://github.com/gkozlenko/node-video-lib) - **star:233** 纯JavaScript库，用于处理MP4和FLV视频文件，并为HLS流媒体创建MPEG-TS块 ![最近一周有更新][Green] 
- [basic-ftp](https://github.com/patrickjuchli/basic-ftp) – FTP/FTPS client.
- [cashify](https://github.com/xxczaki/cashify) - **star:287** 货币转换。 ![最近一周有更新][Green] 
...
- [Node.js Best Practices](https://github.com/i0natan/nodebestpractices) - **star:42097** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome]  ![最近一周有更新][Green] 
...
- [stream-handbook](https://github.com/substack/stream-handbook) - **star:12952** 如何使用流编写Node.js程序 ![star > 2000][Awesome] 
- [module-best-practices](https://github.com/mattdesl/module-best-practices) - **star:1347** 编写新的npm模块时的一些良好实践 ![最近一年没有更新][Yellow] 
- [The Node Way](http://thenodeway.io) - 对于编写可维护的模块、可伸缩的应用程序和实际上易于阅读的代码，有一整套Node.js最佳实践和指导原则
- [You Don't Know Node.js](https://github.com/azat-co/you-dont-know-node) - **star:1181** 介绍Node.js的核心特性和异步JavaScript ![最近一年没有更新][Yellow] 
- [Portable Node.js guide](https://github.com/ehmicky/portable-node-guide) - **star:1034** 如何编写可移植/跨平台Node.js代码的实用指南 ![最近一周有更新][Green] 
...
- [Art of README](https://github.com/noffle/art-of-readme) - **star:5467** 学习写作高质量读物的艺术 ![star > 2000][Awesome]  ![最近一年没有更新][Yellow] 
...
- [Stream FAQs](https://github.com/stephenplusplus/stream-faqs) - **star:185** 回答关于流的常见问题，包括分页、事件等等 ![最近一年没有更新][Yellow] 
...
- [Microsoft Node.js Guidelines](https://github.com/Microsoft/nodejs-guidelines) - **star:2155** 在微软平台上使用Node.js的技巧和资源 ![star > 2000][Awesome] 
- [Module Requests & Ideas](https://github.com/sindresorhus/module-requests) - **star:476** 请求一个您希望存在的JavaScript模块，或者获取模块的想法 ![最近一年没有更新][Yellow] 
