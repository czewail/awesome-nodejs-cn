...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2020-04-24 07:04:48）**
...
- [ipfs](https://github.com/ipfs/js-ipfs) - **star:4352** 分布式文件系统，用于将所有计算设备与同一文件系统连接起来 ![star > 2000][Awesome] 
...
- [Bitcore](https://github.com/bitpay/bitcore) - **star:3600** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/devongovett/pdfkit) - **star:6090** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:5174** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:6577** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
...
- [js-git](https://github.com/creationix/js-git) - **star:3639** Git的 JavaScript 实现 ![star > 2000][Awesome] 
- [skale](https://github.com/skale-me/skale-engine) - **star:374** 高性能分布式数据处理引擎
- [xlsx](https://github.com/sheetjs/js-xlsx) - **star:20702** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
...
- [np](https://github.com/sindresorhus/np) - **star:5148** 更好的 'npm publish' ![star > 2000][Awesome] 
...
- [Standard](https://github.com/feross/standard) - **star:23590** Javascript 标准风格 - 一种风格规范 ![star > 2000][Awesome] 
- [ESLint](https://github.com/eslint/eslint) - **star:16217** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
...
- [http-server](https://github.com/indexzero/http-server) - **star:9367** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome] 
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:9786** 向外界公开本地主机 ![star > 2000][Awesome] 
...
- [themer](https://github.com/mjswensen/themer) - **star:3287** 为编辑器、终端、墙纸、Slack等生成主题 ![star > 2000][Awesome] 
- [carbon-now-cli](https://github.com/mixn/carbon-now-cli) - **star:4532** 一款生成代码展示图片的终端工具 ![star > 2000][Awesome] 
- [cash-cli](https://github.com/xxczaki/cash-cli) - **star:139** 转换170种货币
- [taskbook](https://github.com/klauscfhq/taskbook) - **star:7541** 命令行栖息地的任务、板子和注释 ![star > 2000][Awesome] 
- [discharge](https://github.com/brandonweiss/discharge) - **star:437** 轻松地将静态站点部署到Amazon S3
- [npkill](https://github.com/voidcosmos/npkill) - **star:3053** 轻松找到并删除旧的和沉重的node_modules文件夹 ![star > 2000][Awesome] 

### 函数式编程
*翻译出错了? 试试 [英文版](readme_en.md#Functional%20programming) 吧~*

- [lodash](https://github.com/lodash/lodash) - **star:44427** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/facebook/immutable-js) - **star:29547** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:18686** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome] 
...
- [Bacon.js](https://github.com/baconjs/bacon.js) - **star:6229** 响应式函数编程 ![star > 2000][Awesome] 
- [RxJS](https://github.com/reactivex/rxjs) - **star:21692** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
...
- [got](https://github.com/sindresorhus/got) - **star:7325** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [gh-got](https://github.com/sindresorhus/gh-got) - **star:150** “got”与github api交互的简单封装
- [axios](https://github.com/mzabriskie/axios) - **star:72324** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
- [wreck](https://github.com/hapijs/wreck) - **star:373** HTTP客户端工具
- [download](https://github.com/kevva/download) - **star:958** 轻松下载和解压文件
- [http-proxy](https://github.com/nodejitsu/node-http-proxy) - **star:11085** HTTP代理 ![star > 2000][Awesome] 
- [superagent](https://github.com/visionmedia/superagent) - **star:15031** HTTP请求库 ![star > 2000][Awesome] 
- [node-fetch](https://github.com/bitinn/node-fetch) - **star:4924** node.js 版的 `window.fetch` ![star > 2000][Awesome] 
...
- [debug](https://github.com/visionmedia/debug) - **star:8667** 微小的调试工具 ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:5347** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:15234** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [consola](https://github.com/nuxt/consola) - **star:2780** 控制台记录器。 ![star > 2000][Awesome] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:14325** 终端字符串样式设置 ![star > 2000][Awesome] 
- [meow](https://github.com/sindresorhus/meow) - **star:2147** CLI应用助手 ![star > 2000][Awesome] 
- [yargs](https://github.com/yargs/yargs) - **star:7568** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome] 
- [ora](https://github.com/sindresorhus/ora) - **star:5904** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:13094** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
- [listr](https://github.com/samverschueren/listr) - **star:2475** 终端任务列表 ![star > 2000][Awesome] 
...
- [blessed](https://github.com/chjj/blessed) - **star:9146** Curses-like 库 ![star > 2000][Awesome] 
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:12346** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [shelljs](https://github.com/shelljs/shelljs) - **star:10938** 可移植的Unix shell命令 ![star > 2000][Awesome] 
...
- [Bit](https://github.com/teambit/bit) - **star:10757** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
- [gradient-string](https://github.com/bokub/gradient-string) - **star:411** 终端输出中漂亮的颜色渐变
- [oclif](https://github.com/oclif/oclif) - **star:4797** 包含解析器、自动文档、测试和插件的CLI框架 ![star > 2000][Awesome] 
...
- [parcel](https://github.com/parcel-bundler/parcel) - **star:35454** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome] 
- [webpack](https://github.com/webpack/webpack) - **star:53867** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
...
- [pkg](https://github.com/zeit/pkg) - **star:15683** 将Node.js项目打包成可执行文件 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:11427** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
- [serialport](https://github.com/voodootikigod/node-serialport) - **star:4370** 访问串行端口进行读写 ![star > 2000][Awesome] 
...
- [handlebars.js](https://github.com/wycats/handlebars.js) - **star:15277** Superset of Mustache 模板的超集，添加了强大的功能，如帮助程序和更高级的块 ![star > 2000][Awesome] 
- [EJS](https://github.com/mde/ejs) - **star:4371** 简单的未绑定模板语言 ![star > 2000][Awesome] 
- [Pug](https://github.com/pugjs/pug) - **star:19155** 高性能模板引擎深受Haml的影响 ![star > 2000][Awesome] 
...
- [Koa](https://github.com/koajs/koa) - **star:28962** Express背后的团队设计的框架，其目标是为web应用程序和api提供一个更小、更富表现力和更健壮的基础 ![star > 2000][Awesome] 
- [Express](https://github.com/expressjs/express) - **star:48257** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
...
- [Next.js](https://github.com/zeit/next.js) - **star:47263** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:26649** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
...
- [Nest](https://github.com/nestjs/nest) - **star:26247** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
- [Zeronode](https://github.com/sfast/zeronode) - **star:106** 可靠和容错的微服务的最小构建块
- [TypeGraphQL](https://github.com/19majkel94/type-graphql) - **star:4224** 基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架 ![star > 2000][Awesome] 
...
- [JSDoc](https://github.com/jsdoc3/jsdoc) - **star:10558** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome] 
