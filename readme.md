...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2024-11-11 08:38:42）**
...
- [webtorrent](https://github.com/webtorrent/webtorrent) - **star:29636** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
- [peerflix](https://github.com/mafintosh/peerflix) - **star:6187** 流式 Torrent 客户端 ![star > 2000][Awesome] 
- [ipfs](https://github.com/ipfs/helia) - **star:952** 分布式文件系统，用于将所有计算设备与同一文件系统连接起来
...
- [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) - **star:5698** 干净、可读比特币库 ![star > 2000][Awesome] 
- [Bitcore](https://github.com/bitpay/bitcore) - **star:4867** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/foliojs/pdfkit) - **star:9895** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:9348** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:10110** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
- [js-git](https://github.com/creationix/js-git) - **star:3832** Git的 JavaScript 实现 ![star > 2000][Awesome] 
- [xlsx](https://github.com/SheetJS/sheetjs) - **star:35123** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
- [isomorphic-git](https://github.com/isomorphic-git/isomorphic-git) - **star:7501** 纯 JavaScript 实现的 Git ![star > 2000][Awesome] 
...
- [ESLint](https://github.com/eslint/eslint) - **star:25092** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
- [David](https://github.com/alanshaw/david) - **star:969** 告诉你包的 npm 依赖项何时过期
- [http-server](https://github.com/http-party/http-server) - **star:13649** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome] 
...
- [fkill](https://github.com/sindresorhus/fkill-cli) - **star:6877** 跨平台的进程杀死工具 ![star > 2000][Awesome] 
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:19133** 向外界公开本地主机 ![star > 2000][Awesome] 
...
- [carbon-now-cli](https://github.com/mixn/carbon-now-cli) - **star:5796** 一款生成代码展示图片的终端工具 ![star > 2000][Awesome] 
- [cash-cli](https://github.com/xxczaki/cash-cli) - **star:233** 转换170种货币
- [taskbook](https://github.com/klaussinani/taskbook) - **star:8978** 命令行栖息地的任务、板子和注释 ![star > 2000][Awesome] 
- [discharge](https://github.com/brandonweiss/discharge) - **star:642** 轻松地将静态站点部署到Amazon S3
- [npkill](https://github.com/voidcosmos/npkill) - **star:8303** 轻松找到并删除旧的和沉重的node_modules文件夹 ![star > 2000][Awesome] 

### 函数式编程
*翻译出错了? 试试 [英文版](readme_en.md#Functional%20programming) 吧~*

- [lodash](https://github.com/lodash/lodash) - **star:59853** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/immutable-js/immutable-js) - **star:32959** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:23814** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome] 
- [Mout](https://github.com/mout/mout) - **star:1292** 实用工具库与其他现有解决方案最大的区别在于，您可以选择只加载您需要的模块/函数，而不需要额外的开销
- [RxJS](https://github.com/reactivex/rxjs) - **star:30783** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1872** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:14290** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [undici](https://github.com/nodejs/undici) - **star:6226** 从头编写的高性能HTTP客户端，没有依赖关系。 ![star > 2000][Awesome] 
...
- [axios](https://github.com/axios/axios) - **star:105740** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
...
- [debug](https://github.com/debug-js/debug) - **star:11141** 微小的调试工具 ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:14299** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:22878** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [chalk](https://github.com/chalk/chalk) - **star:21959** 终端字符串样式设置 ![star > 2000][Awesome] 
- [meow](https://github.com/sindresorhus/meow) - **star:3544** CLI应用助手 ![star > 2000][Awesome] 
- [yargs](https://github.com/yargs/yargs) - **star:11102** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome] 
- [ora](https://github.com/sindresorhus/ora) - **star:9152** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:27140** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
...
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:20265** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [Bit](https://github.com/teambit/bit) - **star:17887** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
...
- [zx](https://github.com/google/zx) - **star:43104** 编写shell脚本JavaScript。 ![star > 2000][Awesome] 

### 构建工具
*翻译出错了? 试试 [英文版](readme_en.md#Build%20tools) 吧~*

- [parcel](https://github.com/parcel-bundler/parcel) - **star:43496** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome] 
- [webpack](https://github.com/webpack/webpack) - **star:64750** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:25364** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
...
- [pkg](https://github.com/vercel/pkg) - **star:24323** 将Node.js项目打包成可执行文件 ![star > 2000][Awesome]  ![项目已归档][Archived] 
- [Vite](https://github.com/vitejs/vite) - **star:68490** 前端构建工具，具有热模块替换和静态资产捆绑。 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:13299** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
...
- [modbus-serial](https://github.com/yaacov/node-modbus-serial) - **star:639** MODBUS-RTU（串行和TCP）的纯JavaScript实现。

### 模板
*翻译出错了? 试试 [英文版](readme_en.md#Templating) 吧~*

- [marko](https://github.com/marko-js/marko) - **star:13403** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome] 
- [nunjucks](https://github.com/mozilla/nunjucks) - **star:8581** 带有继承、异步控制等功能的模板引擎(受jinja2的启发) ![star > 2000][Awesome] 
- [handlebars.js](https://github.com/handlebars-lang/handlebars.js) - **star:18008** Superset of Mustache 模板的超集，添加了强大的功能，如帮助程序和更高级的块 ![star > 2000][Awesome] 
...
- [Fastify](https://github.com/fastify/fastify) - **star:32366** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Next.js](https://github.com/vercel/next.js) - **star:126889** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:54870** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
...
- [Express](https://github.com/expressjs/express) - **star:65629** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
- [Feathers](https://github.com/feathersjs/feathers) - **star:15070** 基于Express精神构建的微服务框架 ![star > 2000][Awesome] 
- [LoopBack](https://github.com/loopbackio/loopback-next) - **star:4957** 用于创建REST api和轻松连接到后端数据源的强大框架 ![star > 2000][Awesome] 
- [Meteor](https://github.com/meteor/meteor) - **star:44411** 一个超简单的、无处不在的数据库、在线数据、纯javascript web框架*(你可能会喜欢[awesome-meteor](https://github.com/Urigo/awesome-meteor))* ![star > 2000][Awesome] 
...
- [AdonisJs](https://github.com/adonisjs/core) - **star:16945** 一个真正的Node.js MVC框架，建立在依赖注入和IoC容器的坚实基础上 ![star > 2000][Awesome] 
- [Moleculer](https://github.com/moleculerjs/moleculer) - **star:6161** 快速强大的微服务框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:67688** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
...
- [Hono](https://github.com/honojs/hono) - **star:20236** 小而快速的web框架。 ![star > 2000][Awesome] 
...
- [JSDoc](https://github.com/jsdoc/jsdoc) - **star:15043** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome] 
- [Docusaurus](https://github.com/facebook/docusaurus) - **star:56634** 文档网站生成器，利用React和Markdown，并附带翻译和版本控制功能。 ![star > 2000][Awesome] 
...
- Observables
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:30783** 反应性编程 ![star > 2000][Awesome] 
...
- [µWebSockets](https://github.com/uNetworking/uWebSockets) - **star:17399** 高度可伸缩的WebSocket服务器和客户端库 ![star > 2000][Awesome] 
- [Socket.io](https://github.com/socketio/socket.io) - **star:61167** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
...
- [MQTT.js](https://github.com/mqttjs/MQTT.js) - **star:8594** 基于MQTT的消息传递协议的客户机，用于TCP/IP之上 ![star > 2000][Awesome] 
...
- [sharp](https://github.com/lovell/sharp) - **star:29224** 用于调整JPEG、PNG、WebP和TIFF图像大小的最快模块 ![star > 2000][Awesome] 
...
- [jimp](https://github.com/oliver-moran/jimp) - **star:14030** 图像处理在纯JavaScript ![star > 2000][Awesome] 
- [qrcode](https://github.com/soldair/node-qrcode) - **star:7527** 二维码和条形码发生器 ![star > 2000][Awesome] 
...
- [i18next](https://github.com/i18next/i18next) - **star:7763** 国际化框架 ![star > 2000][Awesome] 
- [nanoid](https://github.com/ai/nanoid) - **star:24622** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome] 
- [StegCloak](https://github.com/kurolabs/stegcloak) - **star:3310** 把秘密隐藏在琴弦中，在众目睽睽之下。 ![star > 2000][Awesome] 
...
- [mathjs](https://github.com/josdejong/mathjs) - **star:14406** 一个广泛的数学图书馆 ![star > 2000][Awesome] 
...
- [Luxon](https://github.com/moment/luxon) - **star:15411** 用于处理日期和时间的库 ![star > 2000][Awesome] 
- [date-fns](https://github.com/date-fns/date-fns) - **star:34835** 现代实用程序 ![star > 2000][Awesome] 
- [Day.js](https://github.com/iamkun/dayjs) - **star:46962** 不可变日期库替代Moment.js ![star > 2000][Awesome] 
...
- [linkify-it](https://github.com/markdown-it/linkify-it) - **star:666** 链接模式检测器与完整的unicode支持
...
- [yup](https://github.com/jquense/yup) - **star:22878** 对象模式验证。 ![star > 2000][Awesome] 
- [zod](https://github.com/colinhacks/zod) - **star:33917** 带静态类型推断的typescript优先模式验证。 ![star > 2000][Awesome] 

### 解析
*翻译出错了? 试试 [英文版](readme_en.md#Parsing) 吧~*

- [remark](https://github.com/remarkjs/remark) - **star:7683** 插件驱动的降价处理器 ![star > 2000][Awesome] 
- [markdown-it](https://github.com/markdown-it/markdown-it) - **star:18266** Markdown解析器具有100%的公共标记支持、扩展和语法插件 ![star > 2000][Awesome] 
- [parse5](https://github.com/inikulin/parse5) - **star:3677** 快速功能齐全的符合规范的HTML解析器 ![star > 2000][Awesome] 
- [@parcel/css](https://github.com/parcel-bundler/parcel-css) - **star:6470** 一个用Rust编写的CSS解析器、转换器和迷你器。 ![star > 2000][Awesome] 
...
- [xml2js](https://github.com/Leonidas-from-XIV/node-xml2js) - **star:4895** XML到JavaScript对象转换器 ![star > 2000][Awesome] 
- [Jison](https://github.com/zaach/jison) - **star:4355** 友好的JavaScript解析器生成器它与野牛、Yacc和家族有共同的基因 ![star > 2000][Awesome] 
- [google-libphonenumber](https://github.com/ruimarinho/google-libphonenumber) - **star:1400** 解析、格式化、存储和验证电话号码
...
- [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) - **star:2568** 验证和解析XML ![star > 2000][Awesome] 
...
- [ms](https://github.com/vercel/ms) - **star:5154** 微小的毫秒转换实用程序 ![star > 2000][Awesome] 
...
- [yazl](https://github.com/thejoshwolfe/yazl) - **star:339** 邮政编码
...
- [pako](https://github.com/nodeca/pako) - **star:5578** 高速zlib端口到纯js(放气，充气，gzip) ![star > 2000][Awesome] 
...
- Drivers
- [PostgreSQL](https://github.com/brianc/node-postgres) - **star:12318** PostgreSQL客户机纯JavaScript和本地libpq绑定 ![star > 2000][Awesome] 
...
- [MySQL](https://github.com/mysqljs/mysql) - **star:18299** MySQL客户端 ![star > 2000][Awesome] 
...
- ODM / ORM
- [Sequelize](https://github.com/sequelize/sequelize) - **star:29564** Multi-dialect ORM。支持PostgreSQL, SQLite, MySQL等。 ![star > 2000][Awesome] 
- [Bookshelf](https://github.com/bookshelf/bookshelf) - **star:6361** ORM用于PostgreSQL、MySQL和SQLite3，风格为Backbone.js ![star > 2000][Awesome] 
- [Mongoose](https://github.com/Automattic/mongoose) - **star:26957** 优雅的MongoDB对象建模 ![star > 2000][Awesome] 
...
- [slonik](https://github.com/gajus/slonik) - **star:4584** 具有严格类型、详细日志记录和断言的PostgreSQL客户机 ![star > 2000][Awesome] 
- [Objection.js](https://github.com/Vincit/objection.js) - **star:7263** 轻量级ORM构建于SQL查询生成器Knex之上 ![star > 2000][Awesome] 
- [TypeORM](https://github.com/typeorm/typeorm) - **star:34222** ORM用于PostgreSQL、MariaDB、MySQL、SQLite等 ![star > 2000][Awesome] 
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:7797** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Prisma](https://github.com/prisma/prisma) - **star:39650** 现代数据库访问(ORM替代)。在TypeScript中自动生成和类型安全的查询生成器。支持PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) - **star:24355** 支持各种数据库，如PostgreSQL的TypeScript ORM。 ![star > 2000][Awesome] 
- Query builder
- [Knex](https://github.com/knex/knex) - **star:19332** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:13498** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:21525** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
...
- [loadtest](https://github.com/alexfernandez/loadtest) - **star:2581** 使用用于自动化的API为web应用程序运行负载测试 ![star > 2000][Awesome] 
...
- [WebdriverIO](https://github.com/webdriverio/webdriverio) - **star:9066** 基于WebDriver协议的自动化测试 ![star > 2000][Awesome] 
- [Jest](https://github.com/facebook/jest) - **star:44250** 无痛的JavaScript测试 ![star > 2000][Awesome] 
...
- [Puppeteer](https://github.com/puppeteer/puppeteer) - **star:88799** Headless Chrome ![star > 2000][Awesome] 
- [Playwright](https://github.com/microsoft/playwright) - **star:66834** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome] 
- [nve](https://github.com/ehmicky/nve) - **star:692** 在Node.js的多个版本上本地运行任何命令。
- [axe-core](https://github.com/dequelabs/axe-core) - **star:5995** 用于自动化Web UI测试的可访问性引擎。 ![star > 2000][Awesome] 
...
- [themis](https://github.com/cossacklabs/themis) - **star:1869** 使典型加密方案易于使用的多语言框架:静态数据、经过身份验证的数据交换、传输保护、身份验证等等
- [GuardRails](https://github.com/apps/guardrails) - 在拉请求中提供安全反馈的GitHub应用程序
- [rate-limiter-flexible](https://github.com/animir/node-rate-limiter-flexible) - **star:3067** 暴力和DDoS攻击保护 ![star > 2000][Awesome] 
...
- [imagemin](https://github.com/imagemin/imagemin) - **star:5573** 图像缩小镜 ![star > 2000][Awesome] 

### 身份验证
*翻译出错了? 试试 [英文版](readme_en.md#Authentication) 吧~*

- [Passport](https://github.com/jaredhanson/passport) - **star:22954** 简单、低调的身份验证 ![star > 2000][Awesome] 
...
- [CASL](https://github.com/stalniy/casl) - **star:6006** UI和API的同构授权 ![star > 2000][Awesome] 
...
- [Nodemailer](https://github.com/nodemailer/nodemailer) - **star:16715** 处理电子邮件的最快方式 ![star > 2000][Awesome] 
...
- [MJML](https://github.com/mjmlio/mjml) - **star:17069** 标记语言，旨在减少创建响应电子邮件的痛苦 ![star > 2000][Awesome] 

### 工作队列
*翻译出错了? 试试 [英文版](readme_en.md#Job%20queues) 吧~*

- [bull](https://github.com/OptimalBits/bull) - **star:15559** 持久作业和消息队列 ![star > 2000][Awesome] 
...
- [bullmq](https://github.com/taskforcesh/bullmq) - **star:6162** 持久作业和消息队列 ![star > 2000][Awesome] 
...
- [n](https://github.com/tj/n) - **star:18869** Node.js 版本管理 ![star > 2000][Awesome] 
- [nave](https://github.com/isaacs/nave) - **star:1605** Node.js 的虚拟环境
- [nodeenv](https://github.com/ekalinin/nodeenv) - **star:1705** js虚拟环境兼容Python的 virtualenv
- [nvm for Windows](https://github.com/coreybutler/nvm-windows) - **star:37856** Windows 版本管理 ![star > 2000][Awesome] 
- [nodenv](https://github.com/nodenv/nodenv) - **star:2245** 类似于Ruby的rbenv的版本管理器它支持自动版本切换 ![star > 2000][Awesome] 
- [fnm](https://github.com/Schniz/fnm) - **star:18194** 跨平台的Node.js版本管理器内置在Rust中。 ![star > 2000][Awesome] 

### 跨平台的集成
*翻译出错了? 试试 [英文版](readme_en.md#Cross-platform%20integration) 吧~*

- [napi-rs](https://github.com/napi-rs/napi-rs) - **star:6107** 通过Node-API在Rust中构建编译后的Node.js插件的框架。 ![star > 2000][Awesome] 
- [Neon](https://github.com/neon-bindings/neon) - **star:8056** Rust绑定用于编写安全和快速的本地Node.js模块。 ![star > 2000][Awesome] 
- [Edge.js](https://github.com/agracio/edge-js) - **star:704** 在Windows、macOS和Linux上以相同的进程运行。net和Node.js代码。
...
- [nlp.js](https://github.com/axa-group/nlp.js) - **star:6275** 构建机器人，具有实体提取、情感分析、自动语言识别等功能 ![star > 2000][Awesome] 

### 流程管理
*翻译出错了? 试试 [英文版](readme_en.md#Process%20management) 吧~*

- [PM2](https://github.com/Unitech/pm2) - **star:41537** 先进的流程管理 ![star > 2000][Awesome] 
...
- [Phusion Passenger](https://github.com/phusion/passenger) - **star:5002** 友好的过程管理器，直接集成到Nginx ![star > 2000][Awesome] 
...
- [nut.js](https://github.com/nut-tree/nut.js) - **star:2265** 跨平台的本地GUI自动化/测试框架，具有与Jest集成的图像匹配功能。 ![star > 2000][Awesome] 

### AST
*翻译出错了? 试试 [英文版](readme_en.md#AST) 吧~*

- [Acorn](https://github.com/acornjs/acorn) - **star:10596** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome] 
...
- [docsify](https://github.com/docsifyjs/docsify) - **star:27720** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome] 
...
- [KeystoneJS](https://github.com/keystonejs/keystone) - **star:9254** CMS和基于Express和MongoDB的web应用平台 ![star > 2000][Awesome] 
...
- [Strapi](https://github.com/strapi/strapi) - **star:63723** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome] 
...
- [nodeBB](https://github.com/NodeBB/NodeBB) - **star:14216** 现代网络论坛平台 ![star > 2000][Awesome] 

### 写博客
*翻译出错了? 试试 [英文版](readme_en.md#Blogging) 吧~*

- [Ghost](https://github.com/TryGhost/Ghost) - **star:47454** 简单、强大的发布平台 ![star > 2000][Awesome] 
- [Hexo](https://github.com/hexojs/hexo) - **star:39493** 快速，简单和强大的博客框架 ![star > 2000][Awesome] 
...
- [protobuf](https://github.com/protobufjs/protobuf.js) - **star:9917** 协议缓冲区的实现 ![star > 2000][Awesome] 
- [compactr](https://github.com/compactr/compactr.js) - **star:100** 实现Compactr协议

### 杂项
*翻译出错了? 试试 [英文版](readme_en.md#Miscellaneous) 吧~*

- [execa](https://github.com/sindresorhus/execa) - **star:6859** 更好的“child_process” ![star > 2000][Awesome] 
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:28668** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome] 
...
- [ssh2](https://github.com/mscdex/ssh2) - **star:5526** SSH2客户端和服务器模块 ![star > 2000][Awesome] 
- [adit](https://github.com/markelog/adit) - **star:55** SSH隧道简化
- [file-type](https://github.com/sindresorhus/file-type) - **star:3713** 检测缓冲区的文件类型 ![star > 2000][Awesome] 
...
- [node-pre-gyp](https://github.com/mapbox/node-pre-gyp) - **star:1116** 使从二进制文件发布和安装Node.js c++插件变得容易
- [opencv](https://github.com/peterbraden/node-opencv) - **star:4378** 绑定OpenCV事实上的计算机视觉库 ![star > 2000][Awesome] 
- [dotenv](https://github.com/motdotla/dotenv) - **star:19206** 从.env文件中加载环境变量 ![star > 2000][Awesome] 
...
- [jsdom](https://github.com/jsdom/jsdom) - **star:20546** JavaScript实现的HTML和DOM ![star > 2000][Awesome] 
...
- [husky](https://github.com/typicode/husky) - **star:32606** 创建Git钩子脚本。 ![star > 2000][Awesome] 
- [patch-package](https://github.com/ds300/patch-package) - **star:10451** 修复并保留npm依赖。 ![star > 2000][Awesome] 
- [editly](https://github.com/mifi/editly) - **star:4781** 声明式视频编辑API。 ![star > 2000][Awesome] 
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - **star:100481** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome] 
...
- [Amplication](https://github.com/amplication/amplication) - **star:15204** 自动生成功能齐全的应用程序。 ![star > 2000][Awesome] 
