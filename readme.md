...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2020-03-26 17:03:11）**
...
- [TypeGraphQL](https://github.com/19majkel94/type-graphql) - **star:4004**基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架
...
- [TypeORM](https://github.com/typeorm/typeorm) - **star:18123**ORM用于PostgreSQL、MariaDB、MySQL、SQLite等
...
- [Electron](https://github.com/atom/electron) - **star:81489**使用web技术构建跨平台的桌面应用程序*(你可能会喜欢[awesome-electron](https://github.com/sindresorhus/awesome-electron))*
