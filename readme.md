...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2024-11-08 08:37:13）**
...
- [webtorrent](https://github.com/webtorrent/webtorrent) - **star:29621** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
- [peerflix](https://github.com/mafintosh/peerflix) - **star:6186** 流式 Torrent 客户端 ![star > 2000][Awesome] 
- [ipfs](https://github.com/ipfs/helia) - **star:951** 分布式文件系统，用于将所有计算设备与同一文件系统连接起来
...
- [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) - **star:5694** 干净、可读比特币库 ![star > 2000][Awesome] 
- [Bitcore](https://github.com/bitpay/bitcore) - **star:4863** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/foliojs/pdfkit) - **star:9892** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:9335** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [Brain.js](https://github.com/BrainJS/brain.js) - **star:14391** 机器学习框架 ![star > 2000][Awesome] 
- [Pipcook](https://github.com/alibaba/pipcook) - **star:2540** 前端算法框架创建机器学习流水线。 ![star > 2000][Awesome] 
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:10107** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
...
- [isomorphic-git](https://github.com/isomorphic-git/isomorphic-git) - **star:7498** 纯 JavaScript 实现的 Git ![star > 2000][Awesome] 
...
- [XO](https://github.com/xojs/xo) - **star:7698** 使用 Javascript happiness style 进行严格编码 ![star > 2000][Awesome] 
- [ESLint](https://github.com/eslint/eslint) - **star:25086** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
- [David](https://github.com/alanshaw/david) - **star:969** 告诉你包的 npm 依赖项何时过期
- [http-server](https://github.com/http-party/http-server) - **star:13647** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome] 
...
- [jscpd](https://github.com/kucherenko/jscpd) - **star:4707** 源代码的复制/粘贴检测器 ![star > 2000][Awesome] 
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:19118** 向外界公开本地主机 ![star > 2000][Awesome] 
- [svg-term-cli](https://github.com/marionebl/svg-term-cli) - **star:3547** 通过 SVG 共享终端会话 ![star > 2000][Awesome] 
- [gtop](https://github.com/aksakalli/gtop) - **star:9714** 终端系统监控仪表板 ![star > 2000][Awesome] 
...
- [npkill](https://github.com/voidcosmos/npkill) - **star:8302** 轻松找到并删除旧的和沉重的node_modules文件夹 ![star > 2000][Awesome] 

### 函数式编程
*翻译出错了? 试试 [英文版](readme_en.md#Functional%20programming) 吧~*

- [lodash](https://github.com/lodash/lodash) - **star:59845** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
...
- [RxJS](https://github.com/reactivex/rxjs) - **star:30779** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1872** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:14286** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [undici](https://github.com/nodejs/undici) - **star:6222** 从头编写的高性能HTTP客户端，没有依赖关系。 ![star > 2000][Awesome] 
...
- [axios](https://github.com/axios/axios) - **star:105718** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
...
- [debug](https://github.com/debug-js/debug) - **star:11139** 微小的调试工具 ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:14285** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:22867** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [consola](https://github.com/unjs/consola) - **star:6105** 控制台记录器。 ![star > 2000][Awesome] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:21953** 终端字符串样式设置 ![star > 2000][Awesome] 
- [meow](https://github.com/sindresorhus/meow) - **star:3543** CLI应用助手 ![star > 2000][Awesome] 
- [yargs](https://github.com/yargs/yargs) - **star:11097** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:27117** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
...
- [blessed](https://github.com/chjj/blessed) - **star:11314** Curses-like 库 ![star > 2000][Awesome] 
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:20254** 交互式命令行提示符 ![star > 2000][Awesome] 
- [yn](https://github.com/sindresorhus/yn) - **star:266** 解析yes/no 类似的值
- [cli-table3](https://github.com/cli-table/cli-table3) - **star:537** 漂亮的unicode表
...
- [shelljs](https://github.com/shelljs/shelljs) - **star:14266** 可移植的Unix shell命令 ![star > 2000][Awesome] 
...
- [Bit](https://github.com/teambit/bit) - **star:17883** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
- [gradient-string](https://github.com/bokub/gradient-string) - **star:1091** 终端输出中漂亮的颜色渐变
- [oclif](https://github.com/oclif/oclif) - **star:9024** 包含解析器、自动文档、测试和插件的CLI框架 ![star > 2000][Awesome] 
...
- [zx](https://github.com/google/zx) - **star:43091** 编写shell脚本JavaScript。 ![star > 2000][Awesome] 

### 构建工具
*翻译出错了? 试试 [英文版](readme_en.md#Build%20tools) 吧~*

- [parcel](https://github.com/parcel-bundler/parcel) - **star:43489** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome] 
- [webpack](https://github.com/webpack/webpack) - **star:64691** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:25363** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
...
- [pkg](https://github.com/vercel/pkg) - **star:24322** 将Node.js项目打包成可执行文件 ![star > 2000][Awesome]  ![项目已归档][Archived] 
- [Vite](https://github.com/vitejs/vite) - **star:68440** 前端构建工具，具有热模块替换和静态资产捆绑。 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:13298** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
...
- [marko](https://github.com/marko-js/marko) - **star:13399** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome] 
- [nunjucks](https://github.com/mozilla/nunjucks) - **star:8582** 带有继承、异步控制等功能的模板引擎(受jinja2的启发) ![star > 2000][Awesome] 
- [handlebars.js](https://github.com/handlebars-lang/handlebars.js) - **star:18004** Superset of Mustache 模板的超集，添加了强大的功能，如帮助程序和更高级的块 ![star > 2000][Awesome] 
- [EJS](https://github.com/mde/ejs) - **star:7765** 简单的未绑定模板语言 ![star > 2000][Awesome] 
- [Pug](https://github.com/pugjs/pug) - **star:21685** 高性能模板引擎深受Haml的影响 ![star > 2000][Awesome] 

### Web 框架
*翻译出错了? 试试 [英文版](readme_en.md#Web%20frameworks) 吧~*

- [Fastify](https://github.com/fastify/fastify) - **star:32355** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Next.js](https://github.com/vercel/next.js) - **star:126820** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:54827** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
...
- [Koa](https://github.com/koajs/koa) - **star:35209** Express背后的团队设计的框架，其目标是为web应用程序和api提供一个更小、更富表现力和更健壮的基础 ![star > 2000][Awesome] 
- [Express](https://github.com/expressjs/express) - **star:65613** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
...
- [AdonisJs](https://github.com/adonisjs/core) - **star:16936** 一个真正的Node.js MVC框架，建立在依赖注入和IoC容器的坚实基础上 ![star > 2000][Awesome] 
- [Moleculer](https://github.com/moleculerjs/moleculer) - **star:6157** 快速强大的微服务框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:67645** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
...
- [Hono](https://github.com/honojs/hono) - **star:20187** 小而快速的web框架。 ![star > 2000][Awesome] 
...
- [Docusaurus](https://github.com/facebook/docusaurus) - **star:56593** 文档网站生成器，利用React和Markdown，并附带翻译和版本控制功能。 ![star > 2000][Awesome] 
...
- [chokidar](https://github.com/paulmillr/chokidar) - **star:11009** 文件系统监视程序，它稳定来自' fs的事件看”和“fs以及在macOS上使用本地的“fsevents” ![star > 2000][Awesome] 
...
- Observables
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:30779** 反应性编程 ![star > 2000][Awesome] 
...
- [µWebSockets](https://github.com/uNetworking/uWebSockets) - **star:17394** 高度可伸缩的WebSocket服务器和客户端库 ![star > 2000][Awesome] 
- [Socket.io](https://github.com/socketio/socket.io) - **star:61154** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
...
- [sharp](https://github.com/lovell/sharp) - **star:29206** 用于调整JPEG、PNG、WebP和TIFF图像大小的最快模块 ![star > 2000][Awesome] 
...
- [pica](https://github.com/nodeca/pica) - **star:3778** 高品质和快速调整大小(lanczos3)在纯JS替代画布drawImage()，当不允许像素化时 ![star > 2000][Awesome] 
- [jimp](https://github.com/oliver-moran/jimp) - **star:14028** 图像处理在纯JavaScript ![star > 2000][Awesome] 
...
- [i18next](https://github.com/i18next/i18next) - **star:7758** 国际化框架 ![star > 2000][Awesome] 
- [nanoid](https://github.com/ai/nanoid) - **star:24613** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome] 
...
- [Luxon](https://github.com/moment/luxon) - **star:15408** 用于处理日期和时间的库 ![star > 2000][Awesome] 
- [date-fns](https://github.com/date-fns/date-fns) - **star:34821** 现代实用程序 ![star > 2000][Awesome] 
- [Day.js](https://github.com/iamkun/dayjs) - **star:46950** 不可变日期库替代Moment.js ![star > 2000][Awesome] 
...
- [joi](https://github.com/sideway/joi) - **star:20927** 对象模式描述语言和JavaScript对象的验证器 ![star > 2000][Awesome] 
...
- [ajv](https://github.com/ajv-validator/ajv) - **star:13838** 最快的JSON模式验证器支持v5、v6和v7提案 ![star > 2000][Awesome] 
...
- [yup](https://github.com/jquense/yup) - **star:22874** 对象模式验证。 ![star > 2000][Awesome] 
- [zod](https://github.com/colinhacks/zod) - **star:33888** 带静态类型推断的typescript优先模式验证。 ![star > 2000][Awesome] 

### 解析
*翻译出错了? 试试 [英文版](readme_en.md#Parsing) 吧~*

- [remark](https://github.com/remarkjs/remark) - **star:7677** 插件驱动的降价处理器 ![star > 2000][Awesome] 
- [markdown-it](https://github.com/markdown-it/markdown-it) - **star:18246** Markdown解析器具有100%的公共标记支持、扩展和语法插件 ![star > 2000][Awesome] 
- [parse5](https://github.com/inikulin/parse5) - **star:3673** 快速功能齐全的符合规范的HTML解析器 ![star > 2000][Awesome] 
- [@parcel/css](https://github.com/parcel-bundler/parcel-css) - **star:6463** 一个用Rust编写的CSS解析器、转换器和迷你器。 ![star > 2000][Awesome] 
...
- [PEG.js](https://github.com/pegjs/pegjs) - **star:4824** 简单的解析器生成器，生成具有出色错误报告的快速解析器 ![star > 2000][Awesome] 
...
- [js-yaml](https://github.com/nodeca/js-yaml) - **star:6301** 非常快的YAML解析器 ![star > 2000][Awesome] 
...
- [Chevrotain](https://github.com/Chevrotain/chevrotain) - **star:2494** 非常快，功能丰富的JavaScript解析器构建工具包 ![star > 2000][Awesome] 
...
- [ms](https://github.com/vercel/ms) - **star:5152** 微小的毫秒转换实用程序 ![star > 2000][Awesome] 
...
- [yazl](https://github.com/thejoshwolfe/yazl) - **star:337** 邮政编码
- [yauzl](https://github.com/thejoshwolfe/yauzl) - **star:727** 解压缩
...
- Drivers
- [PostgreSQL](https://github.com/brianc/node-postgres) - **star:12313** PostgreSQL客户机纯JavaScript和本地libpq绑定 ![star > 2000][Awesome] 
- [Redis](https://github.com/luin/ioredis) - **star:14378** 复述,客户机 ![star > 2000][Awesome] 
- [LevelUP](https://github.com/Level/levelup) - **star:4086** LevelDB ![star > 2000][Awesome] 
- [MySQL](https://github.com/mysqljs/mysql) - **star:18296** MySQL客户端 ![star > 2000][Awesome] 
...
- [Mongoose](https://github.com/Automattic/mongoose) - **star:26947** 优雅的MongoDB对象建模 ![star > 2000][Awesome] 
...
- [slonik](https://github.com/gajus/slonik) - **star:4583** 具有严格类型、详细日志记录和断言的PostgreSQL客户机 ![star > 2000][Awesome] 
- [Objection.js](https://github.com/Vincit/objection.js) - **star:7262** 轻量级ORM构建于SQL查询生成器Knex之上 ![star > 2000][Awesome] 
- [TypeORM](https://github.com/typeorm/typeorm) - **star:34208** ORM用于PostgreSQL、MariaDB、MySQL、SQLite等 ![star > 2000][Awesome] 
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:7786** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Prisma](https://github.com/prisma/prisma) - **star:39621** 现代数据库访问(ORM替代)。在TypeScript中自动生成和类型安全的查询生成器。支持PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) - **star:24301** 支持各种数据库，如PostgreSQL的TypeScript ORM。 ![star > 2000][Awesome] 
- Query builder
- [Knex](https://github.com/knex/knex) - **star:19329** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:13498** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:21516** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
...
- [WebdriverIO](https://github.com/webdriverio/webdriverio) - **star:9054** 基于WebDriver协议的自动化测试 ![star > 2000][Awesome] 
- [Jest](https://github.com/facebook/jest) - **star:44243** 无痛的JavaScript测试 ![star > 2000][Awesome] 
...
- [Puppeteer](https://github.com/puppeteer/puppeteer) - **star:88704** Headless Chrome ![star > 2000][Awesome] 
- [Playwright](https://github.com/microsoft/playwright) - **star:66782** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome] 
- [nve](https://github.com/ehmicky/nve) - **star:693** 在Node.js的多个版本上本地运行任何命令。
- [axe-core](https://github.com/dequelabs/axe-core) - **star:5992** 用于自动化Web UI测试的可访问性引擎。 ![star > 2000][Awesome] 
- [testcontainers-node](https://github.com/testcontainers/testcontainers-node) - **star:1915** 提供通用数据库、Selenium web浏览器或任何可以在Docker容器中运行的东西的轻量级、一次性实例。
...
- [UglifyJS2](https://github.com/mishoo/UglifyJS) - **star:13160** JavaScript缩小镜 ![star > 2000][Awesome] 
...
- [Passport](https://github.com/jaredhanson/passport) - **star:22944** 简单、低调的身份验证 ![star > 2000][Awesome] 
...
- [CASL](https://github.com/stalniy/casl) - **star:6000** UI和API的同构授权 ![star > 2000][Awesome] 
...
- [Nodemailer](https://github.com/nodemailer/nodemailer) - **star:16708** 处理电子邮件的最快方式 ![star > 2000][Awesome] 
...
- [bull](https://github.com/OptimalBits/bull) - **star:15552** 持久作业和消息队列 ![star > 2000][Awesome] 
...
- [sqs-consumer](https://github.com/bbc/sqs-consumer) - **star:1754** 构建基于Amazon Simple Queue Service (SQS)的应用程序，不使用样板
- [better-queue](https://github.com/diamondio/better-queue) - **star:511** 当您不能使用Redis时，可以使用简单而高效的作业队列
- [bullmq](https://github.com/taskforcesh/bullmq) - **star:6153** 持久作业和消息队列 ![star > 2000][Awesome] 
- [bree](https://github.com/breejs/bree) - **star:3062** 具有工作线程、cron、日期和人工语法支持的作业任务调度器。 ![star > 2000][Awesome] 
...
- [nvm for Windows](https://github.com/coreybutler/nvm-windows) - **star:37807** Windows 版本管理 ![star > 2000][Awesome] 
- [nodenv](https://github.com/nodenv/nodenv) - **star:2243** 类似于Ruby的rbenv的版本管理器它支持自动版本切换 ![star > 2000][Awesome] 
- [fnm](https://github.com/Schniz/fnm) - **star:18160** 跨平台的Node.js版本管理器内置在Rust中。 ![star > 2000][Awesome] 

### 跨平台的集成
*翻译出错了? 试试 [英文版](readme_en.md#Cross-platform%20integration) 吧~*

- [napi-rs](https://github.com/napi-rs/napi-rs) - **star:6101** 通过Node-API在Rust中构建编译后的Node.js插件的框架。 ![star > 2000][Awesome] 
- [Neon](https://github.com/neon-bindings/neon) - **star:8054** Rust绑定用于编写安全和快速的本地Node.js模块。 ![star > 2000][Awesome] 
- [Edge.js](https://github.com/agracio/edge-js) - **star:700** 在Windows、macOS和Linux上以相同的进程运行。net和Node.js代码。
...
- [natural](https://github.com/NaturalNode/natural) - **star:10618** 自然语言工具 ![star > 2000][Awesome] 
- [nlp.js](https://github.com/axa-group/nlp.js) - **star:6272** 构建机器人，具有实体提取、情感分析、自动语言识别等功能 ![star > 2000][Awesome] 

### 流程管理
*翻译出错了? 试试 [英文版](readme_en.md#Process%20management) 吧~*

- [PM2](https://github.com/Unitech/pm2) - **star:41530** 先进的流程管理 ![star > 2000][Awesome] 
...
- [node-windows](https://github.com/coreybutler/node-windows) - **star:2825** 将脚本作为本机Windows服务运行，并记录到事件查看器 ![star > 2000][Awesome] 
- [supervisor](https://github.com/petruisfan/node-supervisor) - **star:3756** 当脚本崩溃或' *时重新启动脚本js文件的更改 ![star > 2000][Awesome] 
- [Phusion Passenger](https://github.com/phusion/passenger) - **star:5000** 友好的过程管理器，直接集成到Nginx ![star > 2000][Awesome] 

### 自动化
*翻译出错了? 试试 [英文版](readme_en.md#Automation) 吧~*

- [robotjs](https://github.com/octalmage/robotjs) - **star:12376** 桌面自动化:控制鼠标、键盘和阅读屏幕 ![star > 2000][Awesome] 
- [nut.js](https://github.com/nut-tree/nut.js) - **star:2260** 跨平台的本地GUI自动化/测试框架，具有与Jest集成的图像匹配功能。 ![star > 2000][Awesome] 

### AST
*翻译出错了? 试试 [英文版](readme_en.md#AST) 吧~*

- [Acorn](https://github.com/acornjs/acorn) - **star:10582** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome] 
...
- [docsify](https://github.com/docsifyjs/docsify) - **star:27695** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome] 
...
- [KeystoneJS](https://github.com/keystonejs/keystone) - **star:9250** CMS和基于Express和MongoDB的web应用平台 ![star > 2000][Awesome] 
...
- [Strapi](https://github.com/strapi/strapi) - **star:63685** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome] 
- [Factor](https://github.com/FactorJS/factor) - **star:1415** Vue.js仪表板框架和无头CMS。
- [AdminBro](https://github.com/SoftwareBrothers/adminjs) - **star:8240** 所有资源的CRUD自动生成管理面板。 ![star > 2000][Awesome] 
- [Graphweaver](https://github.com/exogee-technology/graphweaver) - **star:487** CMS和无头GraphQL API。

### 论坛
*翻译出错了? 试试 [英文版](readme_en.md#Forum) 吧~*

- [nodeBB](https://github.com/NodeBB/NodeBB) - **star:14211** 现代网络论坛平台 ![star > 2000][Awesome] 

### 写博客
*翻译出错了? 试试 [英文版](readme_en.md#Blogging) 吧~*

- [Ghost](https://github.com/TryGhost/Ghost) - **star:47422** 简单、强大的发布平台 ![star > 2000][Awesome] 
- [Hexo](https://github.com/hexojs/hexo) - **star:39481** 快速，简单和强大的博客框架 ![star > 2000][Awesome] 
...
- [protobuf](https://github.com/protobufjs/protobuf.js) - **star:9912** 协议缓冲区的实现 ![star > 2000][Awesome] 
...
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:28656** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome] 
...
- [ssh2](https://github.com/mscdex/ssh2) - **star:5524** SSH2客户端和服务器模块 ![star > 2000][Awesome] 
- [adit](https://github.com/markelog/adit) - **star:55** SSH隧道简化
- [file-type](https://github.com/sindresorhus/file-type) - **star:3712** 检测缓冲区的文件类型 ![star > 2000][Awesome] 
...
- [semver](https://github.com/npm/node-semver) - **star:5095** 语义版本解析器 ![star > 2000][Awesome] 
...
- [jsdom](https://github.com/jsdom/jsdom) - **star:20540** JavaScript实现的HTML和DOM ![star > 2000][Awesome] 
...
- [node-video-lib](https://github.com/gkozlenko/node-video-lib) - **star:358** 纯JavaScript库，用于处理MP4和FLV视频文件，并为HLS流媒体创建MPEG-TS块
...
- [husky](https://github.com/typicode/husky) - **star:32599** 创建Git钩子脚本。 ![star > 2000][Awesome] 
- [patch-package](https://github.com/ds300/patch-package) - **star:10449** 修复并保留npm依赖。 ![star > 2000][Awesome] 
- [editly](https://github.com/mifi/editly) - **star:4780** 声明式视频编辑API。 ![star > 2000][Awesome] 
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - **star:100429** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome] 
...
- [Amplication](https://github.com/amplication/amplication) - **star:15202** 自动生成功能齐全的应用程序。 ![star > 2000][Awesome] 
...
- [awesome-npm](https://github.com/sindresorhus/awesome-npm) - **star:4493** 使用npm的资源和技巧 ![star > 2000][Awesome] 
