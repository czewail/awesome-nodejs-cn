...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2020-08-17 08:06:24）**
...
- [webtorrent](https://github.com/feross/webtorrent) - **star:22419** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
- [peerflix](https://github.com/mafintosh/peerflix) - **star:5464** 流式 Torrent 客户端 ![star > 2000][Awesome] 
- [dat](https://github.com/datproject/dat-node) - **star:500** 数据集的实时复制和版本控制
- [ipfs](https://github.com/ipfs/js-ipfs) - **star:4642** 分布式文件系统，用于将所有计算设备与同一文件系统连接起来 ![star > 2000][Awesome] 
...
- [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) - **star:3910** 干净、可读比特币库 ![star > 2000][Awesome] 
- [Bitcore](https://github.com/bitpay/bitcore) - **star:3702** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/devongovett/pdfkit) - **star:6381** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:5454** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
- [webcat](https://github.com/mafintosh/webcat) - **star:407** 使用 WebRTC 跨 web 的 p2p 管道，它使用 GitHub 私有/公共密钥进行身份验证
- [NodeOS](https://github.com/NodeOS/NodeOS) - **star:6243** 第一个由 npm 驱动的操作系统 ![star > 2000][Awesome] 
- [YodaOS](https://github.com/yodaos-project/yodaos) - **star:1029** 人工智能操作系统
- [Brain.js](https://github.com/BrainJS/brain.js) - **star:11227** 机器学习框架 ![star > 2000][Awesome] 
