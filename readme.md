...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2024-11-14 08:37:37）**
...
- [webtorrent](https://github.com/webtorrent/webtorrent) - **star:29648** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
...
- [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) - **star:5701** 干净、可读比特币库 ![star > 2000][Awesome] 
- [Bitcore](https://github.com/bitpay/bitcore) - **star:4869** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/foliojs/pdfkit) - **star:9905** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:9357** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:10117** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
- [js-git](https://github.com/creationix/js-git) - **star:3834** Git的 JavaScript 实现 ![star > 2000][Awesome] 
- [xlsx](https://github.com/SheetJS/sheetjs) - **star:35134** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
- [isomorphic-git](https://github.com/isomorphic-git/isomorphic-git) - **star:7503** 纯 JavaScript 实现的 Git ![star > 2000][Awesome] 
...
- [public-ip](https://github.com/sindresorhus/public-ip) - **star:1025** 获取你的公共IP地址
...
- [http-server](https://github.com/http-party/http-server) - **star:13656** 简单的零配置 http 服务器命令行工具 ![star > 2000][Awesome] 
- [Live Server](https://github.com/tapio/live-server) - **star:4436** 具有热重载功能的 HTTP-server ![star > 2000][Awesome] 
...
- [jscpd](https://github.com/kucherenko/jscpd) - **star:4713** 源代码的复制/粘贴检测器 ![star > 2000][Awesome] 
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:19145** 向外界公开本地主机 ![star > 2000][Awesome] 
- [svg-term-cli](https://github.com/marionebl/svg-term-cli) - **star:3551** 通过 SVG 共享终端会话 ![star > 2000][Awesome] 
- [gtop](https://github.com/aksakalli/gtop) - **star:9720** 终端系统监控仪表板 ![star > 2000][Awesome] 
...
- [lodash](https://github.com/lodash/lodash) - **star:59863** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/immutable-js/immutable-js) - **star:32949** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:23817** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome] 
- [Mout](https://github.com/mout/mout) - **star:1292** 实用工具库与其他现有解决方案最大的区别在于，您可以选择只加载您需要的模块/函数，而不需要额外的开销
- [RxJS](https://github.com/reactivex/rxjs) - **star:30798** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1874** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:14297** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
- [undici](https://github.com/nodejs/undici) - **star:6234** 从头编写的高性能HTTP客户端，没有依赖关系。 ![star > 2000][Awesome] 
- [ky-universal](https://github.com/sindresorhus/ky-universal) - **star:671** 基于Fetch的通用HTTP客户端。
- [node-fetch](https://github.com/node-fetch/node-fetch) - **star:8781** node.js 版的 `window.fetch` ![star > 2000][Awesome] 
- [axios](https://github.com/axios/axios) - **star:105767** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:14313** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:22893** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [consola](https://github.com/unjs/consola) - **star:6113** 控制台记录器。 ![star > 2000][Awesome] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:21968** 终端字符串样式设置 ![star > 2000][Awesome] 
- [meow](https://github.com/sindresorhus/meow) - **star:3544** CLI应用助手 ![star > 2000][Awesome] 
- [yargs](https://github.com/yargs/yargs) - **star:11104** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome] 
- [ora](https://github.com/sindresorhus/ora) - **star:9157** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:27174** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
- [listr2](https://github.com/listr2/listr2) - **star:524** 终端任务列表
- [conf](https://github.com/sindresorhus/conf) - **star:1233** 简单的配置处理应用程序或模块
- [ansi-escapes](https://github.com/sindresorhus/ansi-escapes) - **star:495** 用于操作终端的ANSI转义码
...
- [blessed](https://github.com/chjj/blessed) - **star:11322** Curses-like 库 ![star > 2000][Awesome] 
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:20275** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [cfonts](https://github.com/dominikwilkowski/cfonts) - **star:1600** 性感的ASCII字体控制台
...
- [cross-env](https://github.com/kentcdodds/cross-env) - **star:6333** 设置跨平台的环境变量 ![star > 2000][Awesome]  ![项目已归档][Archived] 
...
- [Bit](https://github.com/teambit/bit) - **star:17889** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
...
- [zx](https://github.com/google/zx) - **star:43113** 编写shell脚本JavaScript。 ![star > 2000][Awesome] 

### 构建工具
*翻译出错了? 试试 [英文版](readme_en.md#Build%20tools) 吧~*

- [parcel](https://github.com/parcel-bundler/parcel) - **star:43499** 速度极快，零配置web应用程序打包工具 ![star > 2000][Awesome] 
- [webpack](https://github.com/webpack/webpack) - **star:64779** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:25371** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
...
- [Vite](https://github.com/vitejs/vite) - **star:68540** 前端构建工具，具有热模块替换和静态资产捆绑。 ![star > 2000][Awesome] 
...
- [serialport](https://github.com/serialport/node-serialport) - **star:5821** 访问串行端口进行读写 ![star > 2000][Awesome] 
...
- [nunjucks](https://github.com/mozilla/nunjucks) - **star:8584** 带有继承、异步控制等功能的模板引擎(受jinja2的启发) ![star > 2000][Awesome] 
- [handlebars.js](https://github.com/handlebars-lang/handlebars.js) - **star:18015** Superset of Mustache 模板的超集，添加了强大的功能，如帮助程序和更高级的块 ![star > 2000][Awesome] 
...
- [Fastify](https://github.com/fastify/fastify) - **star:32392** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Next.js](https://github.com/vercel/next.js) - **star:126961** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:54915** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
- [Hapi](https://github.com/hapijs/hapi) - **star:14629** 用于构建应用程序和服务的框架 ![star > 2000][Awesome] 
- [Micro](https://github.com/vercel/micro) - **star:10583** 带有异步方法的最小化微服务框架 ![star > 2000][Awesome] 
- [Koa](https://github.com/koajs/koa) - **star:35219** Express背后的团队设计的框架，其目标是为web应用程序和api提供一个更小、更富表现力和更健壮的基础 ![star > 2000][Awesome] 
- [Express](https://github.com/expressjs/express) - **star:65661** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
- [Feathers](https://github.com/feathersjs/feathers) - **star:15075** 基于Express精神构建的微服务框架 ![star > 2000][Awesome] 
- [LoopBack](https://github.com/loopbackio/loopback-next) - **star:4958** 用于创建REST api和轻松连接到后端数据源的强大框架 ![star > 2000][Awesome] 
- [Meteor](https://github.com/meteor/meteor) - **star:44416** 一个超简单的、无处不在的数据库、在线数据、纯javascript web框架*(你可能会喜欢[awesome-meteor](https://github.com/Urigo/awesome-meteor))* ![star > 2000][Awesome] 
...
- [AdonisJs](https://github.com/adonisjs/core) - **star:16957** 一个真正的Node.js MVC框架，建立在依赖注入和IoC容器的坚实基础上 ![star > 2000][Awesome] 
- [Moleculer](https://github.com/moleculerjs/moleculer) - **star:6163** 快速强大的微服务框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:67741** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
- [TypeGraphQL](https://github.com/MichalLytek/type-graphql) - **star:8037** 基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架 ![star > 2000][Awesome] 
...
- [Hono](https://github.com/honojs/hono) - **star:20307** 小而快速的web框架。 ![star > 2000][Awesome] 
...
- [JSDoc](https://github.com/jsdoc/jsdoc) - **star:15049** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome] 
- [Docusaurus](https://github.com/facebook/docusaurus) - **star:56687** 文档网站生成器，利用React和Markdown，并附带翻译和版本控制功能。 ![star > 2000][Awesome] 
...
- [chokidar](https://github.com/paulmillr/chokidar) - **star:11019** 文件系统监视程序，它稳定来自' fs的事件看”和“fs以及在macOS上使用本地的“fsevents” ![star > 2000][Awesome] 
...
- Observables
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:30798** 反应性编程 ![star > 2000][Awesome] 
...
- [µWebSockets](https://github.com/uNetworking/uWebSockets) - **star:17412** 高度可伸缩的WebSocket服务器和客户端库 ![star > 2000][Awesome] 
- [Socket.io](https://github.com/socketio/socket.io) - **star:61192** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
...
- [MQTT.js](https://github.com/mqttjs/MQTT.js) - **star:8598** 基于MQTT的消息传递协议的客户机，用于TCP/IP之上 ![star > 2000][Awesome] 
- [rpc-websockets](https://github.com/elpheria/rpc-websockets) - **star:592** 通过WebSockets实现JSON-RPC 2.0
- [Aedes](https://github.com/moscajs/aedes) - **star:1796** 可以在任何流服务器上运行的Barebone MQTT服务器

### 图像
*翻译出错了? 试试 [英文版](readme_en.md#Image) 吧~*

- [sharp](https://github.com/lovell/sharp) - **star:29249** 用于调整JPEG、PNG、WebP和TIFF图像大小的最快模块 ![star > 2000][Awesome] 
...
- [jimp](https://github.com/oliver-moran/jimp) - **star:14036** 图像处理在纯JavaScript ![star > 2000][Awesome] 
- [qrcode](https://github.com/soldair/node-qrcode) - **star:7530** 二维码和条形码发生器 ![star > 2000][Awesome] 
...
- [i18next](https://github.com/i18next/i18next) - **star:7768** 国际化框架 ![star > 2000][Awesome] 
- [nanoid](https://github.com/ai/nanoid) - **star:24647** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome] 
...
- [mathjs](https://github.com/josdejong/mathjs) - **star:14409** 一个广泛的数学图书馆 ![star > 2000][Awesome] 
...
- [date-fns](https://github.com/date-fns/date-fns) - **star:34857** 现代实用程序 ![star > 2000][Awesome] 
- [Day.js](https://github.com/iamkun/dayjs) - **star:46986** 不可变日期库替代Moment.js ![star > 2000][Awesome] 
...
- [joi](https://github.com/sideway/joi) - **star:20931** 对象模式描述语言和JavaScript对象的验证器 ![star > 2000][Awesome] 
...
- [ajv](https://github.com/ajv-validator/ajv) - **star:13846** 最快的JSON模式验证器支持v5、v6和v7提案 ![star > 2000][Awesome] 
- [Superstruct](https://github.com/ianstormtaylor/superstruct) - **star:7021** 在JavaScript(和TypeScript)中验证数据的简单而可组合的方法。 ![star > 2000][Awesome] 
- [yup](https://github.com/jquense/yup) - **star:22887** 对象模式验证。 ![star > 2000][Awesome] 
- [zod](https://github.com/colinhacks/zod) - **star:33970** 带静态类型推断的typescript优先模式验证。 ![star > 2000][Awesome] 

### 解析
*翻译出错了? 试试 [英文版](readme_en.md#Parsing) 吧~*

- [remark](https://github.com/remarkjs/remark) - **star:7689** 插件驱动的降价处理器 ![star > 2000][Awesome] 
- [markdown-it](https://github.com/markdown-it/markdown-it) - **star:18297** Markdown解析器具有100%的公共标记支持、扩展和语法插件 ![star > 2000][Awesome] 
- [parse5](https://github.com/inikulin/parse5) - **star:3676** 快速功能齐全的符合规范的HTML解析器 ![star > 2000][Awesome] 
- [@parcel/css](https://github.com/parcel-bundler/parcel-css) - **star:6482** 一个用Rust编写的CSS解析器、转换器和迷你器。 ![star > 2000][Awesome] 
...
- [PEG.js](https://github.com/pegjs/pegjs) - **star:4826** 简单的解析器生成器，生成具有出色错误报告的快速解析器 ![star > 2000][Awesome] 
- [x-ray](https://github.com/matthewmueller/x-ray) - **star:5878** 网页抓取工具 ![star > 2000][Awesome] 
- [nearley](https://github.com/kach/nearley) - **star:3605** 简单、快速、强大的JavaScript解析 ![star > 2000][Awesome] 
...
- [xml2js](https://github.com/Leonidas-from-XIV/node-xml2js) - **star:4897** XML到JavaScript对象转换器 ![star > 2000][Awesome] 
- [Jison](https://github.com/zaach/jison) - **star:4355** 友好的JavaScript解析器生成器它与野牛、Yacc和家族有共同的基因 ![star > 2000][Awesome] 
- [google-libphonenumber](https://github.com/ruimarinho/google-libphonenumber) - **star:1403** 解析、格式化、存储和验证电话号码
...
- [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) - **star:2576** 验证和解析XML ![star > 2000][Awesome] 
...
- [ms](https://github.com/vercel/ms) - **star:5157** 微小的毫秒转换实用程序 ![star > 2000][Awesome] 
...
- [Archiver](https://github.com/archiverjs/node-archiver) - **star:2819** 流接口的存档生成，支持ZIP和TAR ![star > 2000][Awesome] 
- [pako](https://github.com/nodeca/pako) - **star:5584** 高速zlib端口到纯js(放气，充气，gzip) ![star > 2000][Awesome] 
...
- Drivers
- [PostgreSQL](https://github.com/brianc/node-postgres) - **star:12326** PostgreSQL客户机纯JavaScript和本地libpq绑定 ![star > 2000][Awesome] 
- [Redis](https://github.com/luin/ioredis) - **star:14393** 复述,客户机 ![star > 2000][Awesome] 
- [LevelUP](https://github.com/Level/levelup) - **star:4087** LevelDB ![star > 2000][Awesome] 
- [MySQL](https://github.com/mysqljs/mysql) - **star:18303** MySQL客户端 ![star > 2000][Awesome] 
...
- [TypeORM](https://github.com/typeorm/typeorm) - **star:34237** ORM用于PostgreSQL、MariaDB、MySQL、SQLite等 ![star > 2000][Awesome] 
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:7805** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Prisma](https://github.com/prisma/prisma) - **star:39692** 现代数据库访问(ORM替代)。在TypeScript中自动生成和类型安全的查询生成器。支持PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) - **star:24441** 支持各种数据库，如PostgreSQL的TypeScript ORM。 ![star > 2000][Awesome] 
- Query builder
- [Knex](https://github.com/knex/knex) - **star:19342** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:13501** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:21535** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
- [Keyv](https://github.com/jaredwray/keyv) - **star:2621** 简单的键值存储，支持多个后端 ![star > 2000][Awesome] 
...
- [pg-mem](https://github.com/oguimbal/pg-mem) - **star:2006** 测试的内存PostgreSQL实例。 ![star > 2000][Awesome] 

### 测试
*翻译出错了? 试试 [英文版](readme_en.md#Testing) 吧~*

- [AVA](https://github.com/avajs/ava) - **star:20736** 未来的测试运行器 ![star > 2000][Awesome] 
- [Mocha](https://github.com/mochajs/mocha) - **star:22603** 功能丰富的测试框架，使异步测试简单而有趣 ![star > 2000][Awesome] 
...
- [Nock](https://github.com/nock/nock) - **star:12739** HTTP模拟和期望 ![star > 2000][Awesome] 
...
- [Jest](https://github.com/facebook/jest) - **star:44271** 无痛的JavaScript测试 ![star > 2000][Awesome] 
...
- [CodeceptJS](https://github.com/codeceptjs/CodeceptJS) - **star:4113** 端到端测试 ![star > 2000][Awesome] 
- [Puppeteer](https://github.com/puppeteer/puppeteer) - **star:88829** Headless Chrome ![star > 2000][Awesome] 
- [Playwright](https://github.com/microsoft/playwright) - **star:66925** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome] 
- [nve](https://github.com/ehmicky/nve) - **star:693** 在Node.js的多个版本上本地运行任何命令。
- [axe-core](https://github.com/dequelabs/axe-core) - **star:6004** 用于自动化Web UI测试的可访问性引擎。 ![star > 2000][Awesome] 
- [testcontainers-node](https://github.com/testcontainers/testcontainers-node) - **star:1919** 提供通用数据库、Selenium web浏览器或任何可以在Docker容器中运行的东西的轻量级、一次性实例。

### 安全
*翻译出错了? 试试 [英文版](readme_en.md#Security) 吧~*

- [upash](https://github.com/simonepri/upash) - **star:540** 统一的API为所有密码哈希算法
- [themis](https://github.com/cossacklabs/themis) - **star:1873** 使典型加密方案易于使用的多语言框架:静态数据、经过身份验证的数据交换、传输保护、身份验证等等
...
- [UglifyJS2](https://github.com/mishoo/UglifyJS) - **star:13163** JavaScript缩小镜 ![star > 2000][Awesome] 
...
- [imagemin](https://github.com/imagemin/imagemin) - **star:5575** 图像缩小镜 ![star > 2000][Awesome] 

### 身份验证
*翻译出错了? 试试 [英文版](readme_en.md#Authentication) 吧~*

- [Passport](https://github.com/jaredhanson/passport) - **star:22958** 简单、低调的身份验证 ![star > 2000][Awesome] 
...
- [CASL](https://github.com/stalniy/casl) - **star:6017** UI和API的同构授权 ![star > 2000][Awesome] 
- [node-casbin](https://github.com/casbin/node-casbin) - **star:2609** 支持ACL、RBAC和ABAC等访问控制模型的授权库 ![star > 2000][Awesome] 

### 邮件
*翻译出错了? 试试 [英文版](readme_en.md#Email) 吧~*

- [Nodemailer](https://github.com/nodemailer/nodemailer) - **star:16719** 处理电子邮件的最快方式 ![star > 2000][Awesome] 
...
- [MJML](https://github.com/mjmlio/mjml) - **star:17079** 标记语言，旨在减少创建响应电子邮件的痛苦 ![star > 2000][Awesome] 

### 工作队列
*翻译出错了? 试试 [英文版](readme_en.md#Job%20queues) 吧~*

- [bull](https://github.com/OptimalBits/bull) - **star:15565** 持久作业和消息队列 ![star > 2000][Awesome] 
- [agenda](https://github.com/agenda/agenda) - **star:9400** MongoDB-backed工作调度 ![star > 2000][Awesome] 
- [idoit](https://github.com/nodeca/idoit) - **star:76** 具有高级作业控制的redis支持的作业队列引擎
...
- [bee-queue](https://github.com/bee-queue/bee-queue) - **star:3824** 高性能redis支持的作业队列 ![star > 2000][Awesome] 
- [RedisSMQ](https://github.com/weyoss/redis-smq) - **star:591** 简单的高性能Redis消息队列与实时监控
...
- [bullmq](https://github.com/taskforcesh/bullmq) - **star:6171** 持久作业和消息队列 ![star > 2000][Awesome] 
...
- [n](https://github.com/tj/n) - **star:18875** Node.js 版本管理 ![star > 2000][Awesome] 
...
- [nvm for Windows](https://github.com/coreybutler/nvm-windows) - **star:37923** Windows 版本管理 ![star > 2000][Awesome] 
- [nodenv](https://github.com/nodenv/nodenv) - **star:2247** 类似于Ruby的rbenv的版本管理器它支持自动版本切换 ![star > 2000][Awesome] 
- [fnm](https://github.com/Schniz/fnm) - **star:18239** 跨平台的Node.js版本管理器内置在Rust中。 ![star > 2000][Awesome] 

### 跨平台的集成
*翻译出错了? 试试 [英文版](readme_en.md#Cross-platform%20integration) 吧~*

- [napi-rs](https://github.com/napi-rs/napi-rs) - **star:6126** 通过Node-API在Rust中构建编译后的Node.js插件的框架。 ![star > 2000][Awesome] 
- [Neon](https://github.com/neon-bindings/neon) - **star:8059** Rust绑定用于编写安全和快速的本地Node.js模块。 ![star > 2000][Awesome] 
- [Edge.js](https://github.com/agracio/edge-js) - **star:710** 在Windows、macOS和Linux上以相同的进程运行。net和Node.js代码。
- [DotNetJS](https://github.com/Elringus/DotNetJS) - **star:668** 使用。net互操作性层在Node.js中使用。net库。
...
- [nlp.js](https://github.com/axa-group/nlp.js) - **star:6280** 构建机器人，具有实体提取、情感分析、自动语言识别等功能 ![star > 2000][Awesome] 

### 流程管理
*翻译出错了? 试试 [英文版](readme_en.md#Process%20management) 吧~*

- [PM2](https://github.com/Unitech/pm2) - **star:41558** 先进的流程管理 ![star > 2000][Awesome] 
- [nodemon](https://github.com/remy/nodemon) - **star:26321** 监视应用程序中的更改并自动重启服务器 ![star > 2000][Awesome] 
...
- [robotjs](https://github.com/octalmage/robotjs) - **star:12381** 桌面自动化:控制鼠标、键盘和阅读屏幕 ![star > 2000][Awesome] 
- [nut.js](https://github.com/nut-tree/nut.js) - **star:2269** 跨平台的本地GUI自动化/测试框架，具有与Jest集成的图像匹配功能。 ![star > 2000][Awesome] 

### AST
*翻译出错了? 试试 [英文版](readme_en.md#AST) 吧~*

- [Acorn](https://github.com/acornjs/acorn) - **star:10602** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome] 
...
- [docsify](https://github.com/docsifyjs/docsify) - **star:27753** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome] 
...
- [KeystoneJS](https://github.com/keystonejs/keystone) - **star:9256** CMS和基于Express和MongoDB的web应用平台 ![star > 2000][Awesome] 
...
- [Strapi](https://github.com/strapi/strapi) - **star:63765** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome] 
...
- [nodeBB](https://github.com/NodeBB/NodeBB) - **star:14222** 现代网络论坛平台 ![star > 2000][Awesome] 

### 写博客
*翻译出错了? 试试 [英文版](readme_en.md#Blogging) 吧~*

- [Ghost](https://github.com/TryGhost/Ghost) - **star:47493** 简单、强大的发布平台 ![star > 2000][Awesome] 
- [Hexo](https://github.com/hexojs/hexo) - **star:39516** 快速，简单和强大的博客框架 ![star > 2000][Awesome] 
...
- [protobuf](https://github.com/protobufjs/protobuf.js) - **star:9927** 协议缓冲区的实现 ![star > 2000][Awesome] 
- [compactr](https://github.com/compactr/compactr.js) - **star:101** 实现Compactr协议

### 杂项
*翻译出错了? 试试 [英文版](readme_en.md#Miscellaneous) 吧~*

- [execa](https://github.com/sindresorhus/execa) - **star:6868** 更好的“child_process” ![star > 2000][Awesome] 
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:28687** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome] 
...
- [ssh2](https://github.com/mscdex/ssh2) - **star:5529** SSH2客户端和服务器模块 ![star > 2000][Awesome] 
- [adit](https://github.com/markelog/adit) - **star:55** SSH隧道简化
- [file-type](https://github.com/sindresorhus/file-type) - **star:3719** 检测缓冲区的文件类型 ![star > 2000][Awesome] 
...
- [dotenv](https://github.com/motdotla/dotenv) - **star:19213** 从.env文件中加载环境变量 ![star > 2000][Awesome] 
...
- [jsdom](https://github.com/jsdom/jsdom) - **star:20554** JavaScript实现的HTML和DOM ![star > 2000][Awesome] 
...
- [husky](https://github.com/typicode/husky) - **star:32622** 创建Git钩子脚本。 ![star > 2000][Awesome] 
- [patch-package](https://github.com/ds300/patch-package) - **star:10457** 修复并保留npm依赖。 ![star > 2000][Awesome] 
- [editly](https://github.com/mifi/editly) - **star:4789** 声明式视频编辑API。 ![star > 2000][Awesome] 
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - **star:100571** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome] 
...
- [Amplication](https://github.com/amplication/amplication) - **star:15212** 自动生成功能齐全的应用程序。 ![star > 2000][Awesome] 
...
- [awesome-npm](https://github.com/sindresorhus/awesome-npm) - **star:4496** 使用npm的资源和技巧 ![star > 2000][Awesome] 
