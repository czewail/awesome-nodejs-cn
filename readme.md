...
**此项目是 [awesome-nodejs](https://raw.githubusercontent.com/sindresorhus/awesome-nodejs/master/readme.md) 中文版，每天定时同步（上次同步时间：2024-06-19 08:31:29）**
...
- [webtorrent](https://github.com/webtorrent/webtorrent) - **star:29164** 可在 Node.js 和浏览器使用的流式 Torrent 客户端 ![star > 2000][Awesome] 
...
- [Bitcore](https://github.com/bitpay/bitcore) - **star:4792** 纯净、强大的比特币库 ![star > 2000][Awesome] 
- [PDFKit](https://github.com/foliojs/pdfkit) - **star:9609** PDF 生成库 ![star > 2000][Awesome] 
- [turf](https://github.com/Turfjs/turf) - **star:8941** 模块化地理空间处理和分析引擎 ![star > 2000][Awesome] 
...
- [Cytoscape.js](https://github.com/cytoscape/cytoscape.js) - **star:9875** 图论(又称网络)建模与分析 ![star > 2000][Awesome] 
- [js-git](https://github.com/creationix/js-git) - **star:3830** Git的 JavaScript 实现 ![star > 2000][Awesome] 
- [xlsx](https://github.com/SheetJS/sheetjs) - **star:34679** 纯 js 实现的 Excel 电子表格读写器 ![star > 2000][Awesome] 
- [isomorphic-git](https://github.com/isomorphic-git/isomorphic-git) - **star:7339** 纯 JavaScript 实现的 Git ![star > 2000][Awesome] 

### 命令行程序
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20apps) 吧~*

- [np](https://github.com/sindresorhus/np) - **star:7508** 更好的 'npm publish' ![star > 2000][Awesome] 
...
- [XO](https://github.com/xojs/xo) - **star:7580** 使用 Javascript happiness style 进行严格编码 ![star > 2000][Awesome] 
- [ESLint](https://github.com/eslint/eslint) - **star:24509** JavaScript 的可插入 linting 实用程序 ![star > 2000][Awesome] 
...
- [jscpd](https://github.com/kucherenko/jscpd) - **star:4592** 源代码的复制/粘贴检测器 ![star > 2000][Awesome] 
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - **star:18434** 向外界公开本地主机 ![star > 2000][Awesome] 
...
- [themer](https://github.com/themerdev/themer) - **star:5424** 为编辑器、终端、墙纸、Slack等生成主题 ![star > 2000][Awesome] 
- [carbon-now-cli](https://github.com/mixn/carbon-now-cli) - **star:5714** 一款生成代码展示图片的终端工具 ![star > 2000][Awesome] 
...
- [lodash](https://github.com/lodash/lodash) - **star:59148** 提供一致性、自定义、性能和附加功能的实用程序库一个更好更快的Underscore.js ![star > 2000][Awesome] 
- [immutable](https://github.com/immutable-js/immutable-js) - **star:32886** 不可变数据集合 ![star > 2000][Awesome] 
- [Ramda](https://github.com/ramda/ramda) - **star:23635** 实用工具库，侧重于灵活的功能组合，通过自动套用和反转参数顺序启用避免变异数据 ![star > 2000][Awesome] 
- [Mout](https://github.com/mout/mout) - **star:1290** 实用工具库与其他现有解决方案最大的区别在于，您可以选择只加载您需要的模块/函数，而不需要额外的开销
- [RxJS](https://github.com/reactivex/rxjs) - **star:30368** 用于转换、组合和查询各种数据的响应式函数编程库 ![star > 2000][Awesome] 
- [Kefir.js](https://github.com/kefirjs/kefir) - **star:1868** 响应式，专注于高性能和低内存使用

### HTTP
*翻译出错了? 试试 [英文版](readme_en.md#HTTP) 吧~*

- [got](https://github.com/sindresorhus/got) - **star:14027** 更好的内置“http”模块接口 ![star > 2000][Awesome] 
...
- [node-fetch](https://github.com/node-fetch/node-fetch) - **star:8691** node.js 版的 `window.fetch` ![star > 2000][Awesome] 
- [axios](https://github.com/axios/axios) - **star:104447** 基于 Promise 的HTTP客户端(也适用于浏览器) ![star > 2000][Awesome] 
- [superagent](https://github.com/visionmedia/superagent) - **star:16553** HTTP请求库 ![star > 2000][Awesome] 
...
- [pino](https://github.com/pinojs/pino) - **star:13510** 非常快的日志工具，灵感来自Bunyan ![star > 2000][Awesome] 
- [winston](https://github.com/winstonjs/winston) - **star:22254** 多通道异步日志库 ![star > 2000][Awesome] 
...
- [consola](https://github.com/unjs/consola) - **star:5765** 控制台记录器。 ![star > 2000][Awesome] 

### 命令行实用工具
*翻译出错了? 试试 [英文版](readme_en.md#Command-line%20utilities) 吧~*

- [chalk](https://github.com/chalk/chalk) - **star:21563** 终端字符串样式设置 ![star > 2000][Awesome] 
- [meow](https://github.com/sindresorhus/meow) - **star:3513** CLI应用助手 ![star > 2000][Awesome] 
- [yargs](https://github.com/yargs/yargs) - **star:10980** 自动生成优雅用户界面的命令行解析器 ![star > 2000][Awesome] 
- [ora](https://github.com/sindresorhus/ora) - **star:8962** 优雅的终端 spinner ![star > 2000][Awesome] 
...
- [Ink](https://github.com/vadimdemedes/ink) - **star:26087** 对交互式命令行应用程序作出反应 ![star > 2000][Awesome] 
- [listr2](https://github.com/listr2/listr2) - **star:474** 终端任务列表
...
- [blessed](https://github.com/chjj/blessed) - **star:11185** Curses-like 库 ![star > 2000][Awesome] 
- [Inquirer.js](https://github.com/SBoudrias/Inquirer.js) - **star:19557** 交互式命令行提示符 ![star > 2000][Awesome] 
...
- [Bit](https://github.com/teambit/bit) - **star:17673** 跨存储库创建、维护、查找和使用小模块和组件 ![star > 2000][Awesome] 
...
- [zx](https://github.com/google/zx) - **star:42177** 编写shell脚本JavaScript。 ![star > 2000][Awesome] 
...
- [webpack](https://github.com/webpack/webpack) - **star:64302** 为浏览器打包模块和资源 ![star > 2000][Awesome] 
- [rollup](https://github.com/rollup/rollup) - **star:24956** 下一代ES2015模块打包工具 ![star > 2000][Awesome] 
- [gulp](https://github.com/gulpjs/gulp) - **star:32944** 流式和快速构建系统，更喜欢代码而不是配置 ![star > 2000][Awesome] 
...
- [pkg](https://github.com/vercel/pkg) - **star:24228** 将Node.js项目打包成可执行文件 ![star > 2000][Awesome]  ![项目已归档][Archived] 
- [Vite](https://github.com/vitejs/vite) - **star:65656** 前端构建工具，具有热模块替换和静态资产捆绑。 ![star > 2000][Awesome] 

### 硬件
*翻译出错了? 试试 [英文版](readme_en.md#Hardware) 吧~*

- [johnny-five](https://github.com/rwaldron/johnny-five) - **star:13232** 基于Firmata的Arduino框架 ![star > 2000][Awesome] 
...
- [marko](https://github.com/marko-js/marko) - **star:13226** 基于html的模板引擎，它将模板编译到CommonJS模块，并支持流、异步呈现和自定义标记 ![star > 2000][Awesome] 
...
- [EJS](https://github.com/mde/ejs) - **star:7628** 简单的未绑定模板语言 ![star > 2000][Awesome] 
- [Pug](https://github.com/pugjs/pug) - **star:21564** 高性能模板引擎深受Haml的影响 ![star > 2000][Awesome] 

### Web 框架
*翻译出错了? 试试 [英文版](readme_en.md#Web%20frameworks) 吧~*

- [Fastify](https://github.com/fastify/fastify) - **star:31098** 高速、地开销的 Web 框架 ![star > 2000][Awesome] 
- [Next.js](https://github.com/vercel/next.js) - **star:122316** 服务器渲染的通用JavaScript web应用程序的最小化框架 ![star > 2000][Awesome] 
- [Nuxt.js](https://github.com/nuxt/nuxt.js) - **star:52821** 服务器渲染的Vue.js应用程序的最小化框架 ![star > 2000][Awesome] 
...
- [Express](https://github.com/expressjs/express) - **star:64182** Web应用程序框架，为构建单页、多页和混合Web应用程序提供了一组健壮的特性 ![star > 2000][Awesome] 
- [Feathers](https://github.com/feathersjs/feathers) - **star:14959** 基于Express精神构建的微服务框架 ![star > 2000][Awesome] 
- [LoopBack](https://github.com/loopbackio/loopback-next) - **star:4875** 用于创建REST api和轻松连接到后端数据源的强大框架 ![star > 2000][Awesome] 
...
- [AdonisJs](https://github.com/adonisjs/core) - **star:16091** 一个真正的Node.js MVC框架，建立在依赖注入和IoC容器的坚实基础上 ![star > 2000][Awesome] 
- [Moleculer](https://github.com/moleculerjs/moleculer) - **star:6061** 快速强大的微服务框架 ![star > 2000][Awesome] 
- [Nest](https://github.com/nestjs/nest) - **star:65272** 用于构建高效且可伸缩的服务器端应用程序, 受 Angular 启发 ![star > 2000][Awesome] 
- [TypeGraphQL](https://github.com/MichalLytek/type-graphql) - **star:7970** 基于 TypeScript 使用类和装饰器创建 GraphQL api的现代框架 ![star > 2000][Awesome] 
...
- [Ts.ED](https://github.com/tsedio/tsed) - **star:2768** 直观的TypeScript框架，用于在Express.js或Koa.js之上构建服务器端应用。 ![star > 2000][Awesome] 
- [Hono](https://github.com/honojs/hono) - **star:16547** 小而快速的web框架。 ![star > 2000][Awesome] 

### 文档
*翻译出错了? 试试 [英文版](readme_en.md#Documentation) 吧~*

- [documentation.js](https://github.com/documentationjs/documentation) - **star:5771** 支持ES2015+和 flow 注释的 API 文档生成器 ![star > 2000][Awesome] 
- [Docco](https://github.com/jashkenas/docco) - **star:3543** 文档生成器，它生成HTML文档，显示与代码混合的注释 ![star > 2000][Awesome] 
- [JSDoc](https://github.com/jsdoc/jsdoc) - **star:14855** 类似JavaDoc或PHPDoc的API文档生成器 ![star > 2000][Awesome] 
- [Docusaurus](https://github.com/facebook/docusaurus) - **star:53803** 文档网站生成器，利用React和Markdown，并附带翻译和版本控制功能。 ![star > 2000][Awesome] 
...
- [chokidar](https://github.com/paulmillr/chokidar) - **star:10661** 文件系统监视程序，它稳定来自' fs的事件看”和“fs以及在macOS上使用本地的“fsevents” ![star > 2000][Awesome] 
...
- [fs-extra](https://github.com/jprichardson/node-fs-extra) - **star:9373** ' fs '模块的额外方法 ![star > 2000][Awesome] 
...
- Observables
- [RxJS](https://github.com/ReactiveX/RxJS) - **star:30368** 反应性编程 ![star > 2000][Awesome] 
...
- [µWebSockets](https://github.com/uNetworking/uWebSockets) - **star:16957** 高度可伸缩的WebSocket服务器和客户端库 ![star > 2000][Awesome] 
- [Socket.io](https://github.com/socketio/socket.io) - **star:60445** 支持实时双向基于事件的通信 ![star > 2000][Awesome] 
...
- [sharp](https://github.com/lovell/sharp) - **star:28282** 用于调整JPEG、PNG、WebP和TIFF图像大小的最快模块 ![star > 2000][Awesome] 
- [image-type](https://github.com/sindresorhus/image-type) - **star:366** 检测图像的类型。
- [image-dimensions](https://github.com/sindresorhus/image-dimensions) - **star:417** 获取图像的尺寸。
...
- [pica](https://github.com/nodeca/pica) - **star:3676** 高品质和快速调整大小(lanczos3)在纯JS替代画布drawImage()，当不允许像素化时 ![star > 2000][Awesome] 
- [jimp](https://github.com/oliver-moran/jimp) - **star:13577** 图像处理在纯JavaScript ![star > 2000][Awesome] 
- [qrcode](https://github.com/soldair/node-qrcode) - **star:7245** 二维码和条形码发生器 ![star > 2000][Awesome] 
...
- [nanoid](https://github.com/ai/nanoid) - **star:23769** 迷你，安全，url友好，唯一的字符串ID生成器 ![star > 2000][Awesome] 
...
- [mathjs](https://github.com/josdejong/mathjs) - **star:14165** 一个广泛的数学图书馆 ![star > 2000][Awesome] 
...
- [Luxon](https://github.com/moment/luxon) - **star:15004** 用于处理日期和时间的库 ![star > 2000][Awesome] 
- [date-fns](https://github.com/date-fns/date-fns) - **star:33981** 现代实用程序 ![star > 2000][Awesome] 
- [Day.js](https://github.com/iamkun/dayjs) - **star:46123** 不可变日期库替代Moment.js ![star > 2000][Awesome] 
...
- [joi](https://github.com/sideway/joi) - **star:20701** 对象模式描述语言和JavaScript对象的验证器 ![star > 2000][Awesome] 
...
- [ajv](https://github.com/ajv-validator/ajv) - **star:13505** 最快的JSON模式验证器支持v5、v6和v7提案 ![star > 2000][Awesome] 
...
- [yup](https://github.com/jquense/yup) - **star:22422** 对象模式验证。 ![star > 2000][Awesome] 
- [zod](https://github.com/colinhacks/zod) - **star:31363** 带静态类型推断的typescript优先模式验证。 ![star > 2000][Awesome] 

### 解析
*翻译出错了? 试试 [英文版](readme_en.md#Parsing) 吧~*

- [remark](https://github.com/remarkjs/remark) - **star:7339** 插件驱动的降价处理器 ![star > 2000][Awesome] 
- [markdown-it](https://github.com/markdown-it/markdown-it) - **star:17474** Markdown解析器具有100%的公共标记支持、扩展和语法插件 ![star > 2000][Awesome] 
...
- [google-libphonenumber](https://github.com/ruimarinho/google-libphonenumber) - **star:1361** 解析、格式化、存储和验证电话号码
...
- [fast-xml-parser](https://github.com/NaturalIntelligence/fast-xml-parser) - **star:2411** 验证和解析XML ![star > 2000][Awesome] 
...
- [ms](https://github.com/vercel/ms) - **star:5016** 微小的毫秒转换实用程序 ![star > 2000][Awesome] 
...
- Drivers
- [PostgreSQL](https://github.com/brianc/node-postgres) - **star:12011** PostgreSQL客户机纯JavaScript和本地libpq绑定 ![star > 2000][Awesome] 
- [Redis](https://github.com/luin/ioredis) - **star:14022** 复述,客户机 ![star > 2000][Awesome] 
- [LevelUP](https://github.com/Level/levelup) - **star:4075** LevelDB ![star > 2000][Awesome] 
- [MySQL](https://github.com/mysqljs/mysql) - **star:18204** MySQL客户端 ![star > 2000][Awesome] 
...
- ODM / ORM
- [Sequelize](https://github.com/sequelize/sequelize) - **star:29200** Multi-dialect ORM。支持PostgreSQL, SQLite, MySQL等。 ![star > 2000][Awesome] 
- [Bookshelf](https://github.com/bookshelf/bookshelf) - **star:6339** ORM用于PostgreSQL、MySQL和SQLite3，风格为Backbone.js ![star > 2000][Awesome] 
- [Mongoose](https://github.com/Automattic/mongoose) - **star:26739** 优雅的MongoDB对象建模 ![star > 2000][Awesome] 
...
- [TypeORM](https://github.com/typeorm/typeorm) - **star:33616** ORM用于PostgreSQL、MariaDB、MySQL、SQLite等 ![star > 2000][Awesome] 
- [MikroORM](https://github.com/mikro-orm/mikro-orm) - **star:7314** 基于数据映射器、工作单元和标识映射模式的TypeScript ORM。支持MongoDB, PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- [Prisma](https://github.com/prisma/prisma) - **star:37879** 现代数据库访问(ORM替代)。在TypeScript中自动生成和类型安全的查询生成器。支持PostgreSQL, MySQL和SQLite。 ![star > 2000][Awesome] 
- Query builder
- [Knex](https://github.com/knex/knex) - **star:18921** 用于PostgreSQL、MySQL和SQLite3的查询生成器，设计为灵活、可移植且使用有趣 ![star > 2000][Awesome] 
- Other
- [NeDB](https://github.com/louischatriot/nedb) - **star:13453** 用JavaScript编写的嵌入式持久数据库 ![star > 2000][Awesome] 
- [Lowdb](https://github.com/typicode/lowdb) - **star:21081** Lodash支持的小型JavaScript数据库 ![star > 2000][Awesome] 
...
- [Mocha](https://github.com/mochajs/mocha) - **star:22500** 功能丰富的测试框架，使异步测试简单而有趣 ![star > 2000][Awesome] 
- [nyc](https://github.com/istanbuljs/nyc) - **star:5540** 代码覆盖工具建立在伊斯坦布尔，与子进程一起工作 ![star > 2000][Awesome] 
- [tap](https://github.com/tapjs/node-tap) - **star:2323** 开发测试框架 ![star > 2000][Awesome] 
...
- [Sinon.JS](https://github.com/sinonjs/sinon) - **star:9585** 测试间谍，存根和嘲笑 ![star > 2000][Awesome] 
...
- [Jest](https://github.com/facebook/jest) - **star:43772** 无痛的JavaScript测试 ![star > 2000][Awesome] 
...
- [Puppeteer](https://github.com/puppeteer/puppeteer) - **star:87457** Headless Chrome ![star > 2000][Awesome] 
- [Playwright](https://github.com/microsoft/playwright) - **star:63340** Headless Chromium，WebKit，和 Firefox 使用单一的 API。 ![star > 2000][Awesome] 
...
- [testcontainers-node](https://github.com/testcontainers/testcontainers-node) - **star:1761** 提供通用数据库、Selenium web浏览器或任何可以在Docker容器中运行的东西的轻量级、一次性实例。
...
- [rate-limiter-flexible](https://github.com/animir/node-rate-limiter-flexible) - **star:2937** 暴力和DDoS攻击保护 ![star > 2000][Awesome] 
...
- [babel-minify](https://github.com/babel/minify) - **star:4386** 基于Babel工具链的ES2015+感知缩小器 ![star > 2000][Awesome] 
...
- [Passport](https://github.com/jaredhanson/passport) - **star:22592** 简单、低调的身份验证 ![star > 2000][Awesome] 
...
- [CASL](https://github.com/stalniy/casl) - **star:5706** UI和API的同构授权 ![star > 2000][Awesome] 
- [node-casbin](https://github.com/casbin/node-casbin) - **star:2514** 支持ACL、RBAC和ABAC等访问控制模型的授权库 ![star > 2000][Awesome] 

### 邮件
*翻译出错了? 试试 [英文版](readme_en.md#Email) 吧~*

- [Nodemailer](https://github.com/nodemailer/nodemailer) - **star:16444** 处理电子邮件的最快方式 ![star > 2000][Awesome] 
...
- [MJML](https://github.com/mjmlio/mjml) - **star:16622** 标记语言，旨在减少创建响应电子邮件的痛苦 ![star > 2000][Awesome] 

### 工作队列
*翻译出错了? 试试 [英文版](readme_en.md#Job%20queues) 吧~*

- [bull](https://github.com/OptimalBits/bull) - **star:15206** 持久作业和消息队列 ![star > 2000][Awesome] 
- [agenda](https://github.com/agenda/agenda) - **star:9297** MongoDB-backed工作调度 ![star > 2000][Awesome] 
- [idoit](https://github.com/nodeca/idoit) - **star:73** 具有高级作业控制的redis支持的作业队列引擎
- [node-resque](https://github.com/actionhero/node-resque) - **star:1342** Redis-backed工作队列
...
- [bullmq](https://github.com/taskforcesh/bullmq) - **star:5533** 持久作业和消息队列 ![star > 2000][Awesome] 

### Node.js 管理
*翻译出错了? 试试 [英文版](readme_en.md#Node.js%20management) 吧~*

- [n](https://github.com/tj/n) - **star:18620** Node.js 版本管理 ![star > 2000][Awesome] 
...
- [nvm for Windows](https://github.com/coreybutler/nvm-windows) - **star:35592** Windows 版本管理 ![star > 2000][Awesome] 
- [nodenv](https://github.com/nodenv/nodenv) - **star:2188** 类似于Ruby的rbenv的版本管理器它支持自动版本切换 ![star > 2000][Awesome] 
- [fnm](https://github.com/Schniz/fnm) - **star:16186** 跨平台的Node.js版本管理器内置在Rust中。 ![star > 2000][Awesome] 
...
- [Neon](https://github.com/neon-bindings/neon) - **star:7833** Rust绑定用于编写安全和快速的本地Node.js模块。 ![star > 2000][Awesome] 
...
- [nlp.js](https://github.com/axa-group/nlp.js) - **star:6135** 构建机器人，具有实体提取、情感分析、自动语言识别等功能 ![star > 2000][Awesome] 

### 流程管理
*翻译出错了? 试试 [英文版](readme_en.md#Process%20management) 吧~*

- [PM2](https://github.com/Unitech/pm2) - **star:40942** 先进的流程管理 ![star > 2000][Awesome] 
- [nodemon](https://github.com/remy/nodemon) - **star:26085** 监视应用程序中的更改并自动重启服务器 ![star > 2000][Awesome] 
...
- [robotjs](https://github.com/octalmage/robotjs) - **star:12180** 桌面自动化:控制鼠标、键盘和阅读屏幕 ![star > 2000][Awesome] 
- [nut.js](https://github.com/nut-tree/nut.js) - **star:2119** 跨平台的本地GUI自动化/测试框架，具有与Jest集成的图像匹配功能。 ![star > 2000][Awesome] 

### AST
*翻译出错了? 试试 [英文版](readme_en.md#AST) 吧~*

- [Acorn](https://github.com/acornjs/acorn) - **star:10310** 小巧、快速的JavaScript解析器 ![star > 2000][Awesome] 
...
- [docsify](https://github.com/docsifyjs/docsify) - **star:26949** 标记文件网站生成器，没有静态构建的HTML文件 ![star > 2000][Awesome] 
...
- [KeystoneJS](https://github.com/keystonejs/keystone) - **star:8952** CMS和基于Express和MongoDB的web应用平台 ![star > 2000][Awesome] 
- [ApostropheCMS](https://github.com/apostrophecms/apostrophe) - **star:4291** 内容管理系统，强调直观的前端内容编辑和管理建立在Express和MongoDB上 ![star > 2000][Awesome] 
- [Strapi](https://github.com/strapi/strapi) - **star:61320** 内容管理框架(headless-CMS)来构建强大的api ![star > 2000][Awesome] 
- [Factor](https://github.com/FactorJS/factor) - **star:1385** Vue.js仪表板框架和无头CMS。
- [AdminBro](https://github.com/SoftwareBrothers/adminjs) - **star:8024** 所有资源的CRUD自动生成管理面板。 ![star > 2000][Awesome] 
- [Graphweaver](https://github.com/exogee-technology/graphweaver) - **star:450** CMS和无头GraphQL API。

### 论坛
*翻译出错了? 试试 [英文版](readme_en.md#Forum) 吧~*

- [nodeBB](https://github.com/NodeBB/NodeBB) - **star:13988** 现代网络论坛平台 ![star > 2000][Awesome] 

### 写博客
*翻译出错了? 试试 [英文版](readme_en.md#Blogging) 吧~*

- [Ghost](https://github.com/TryGhost/Ghost) - **star:46117** 简单、强大的发布平台 ![star > 2000][Awesome] 
- [Hexo](https://github.com/hexojs/hexo) - **star:38759** 快速，简单和强大的博客框架 ![star > 2000][Awesome] 
...
- [protobuf](https://github.com/protobufjs/protobuf.js) - **star:9706** 协议缓冲区的实现 ![star > 2000][Awesome] 
- [compactr](https://github.com/compactr/compactr.js) - **star:101** 实现Compactr协议

### 杂项
*翻译出错了? 试试 [英文版](readme_en.md#Miscellaneous) 吧~*

- [execa](https://github.com/sindresorhus/execa) - **star:6589** 更好的“child_process” ![star > 2000][Awesome] 
- [cheerio](https://github.com/cheeriojs/cheerio) - **star:27980** 快速、灵活、精益地实现了专门为服务器设计的核心jQuery ![star > 2000][Awesome] 
...
- [file-type](https://github.com/sindresorhus/file-type) - **star:3504** 检测缓冲区的文件类型 ![star > 2000][Awesome] 
...
- [dotenv](https://github.com/motdotla/dotenv) - **star:18659** 从.env文件中加载环境变量 ![star > 2000][Awesome] 
- [semver](https://github.com/npm/node-semver) - **star:4997** 语义版本解析器 ![star > 2000][Awesome] 
...
- [jsdom](https://github.com/jsdom/jsdom) - **star:20132** JavaScript实现的HTML和DOM ![star > 2000][Awesome] 
...
- [husky](https://github.com/typicode/husky) - **star:31857** 创建Git钩子脚本。 ![star > 2000][Awesome] 
- [patch-package](https://github.com/ds300/patch-package) - **star:10097** 修复并保留npm依赖。 ![star > 2000][Awesome] 
...
- [Node.js Best Practices](https://github.com/goldbergyoni/nodebestpractices) - **star:97025** 对Node.js最佳实践的顶级内容进行总结和整理，可使用多种语言 ![star > 2000][Awesome] 
...
- [Amplication](https://github.com/amplication/amplication) - **star:13771** 自动生成功能齐全的应用程序。 ![star > 2000][Awesome] 
...
- [awesome-npm](https://github.com/sindresorhus/awesome-npm) - **star:4422** 使用npm的资源和技巧 ![star > 2000][Awesome] 
